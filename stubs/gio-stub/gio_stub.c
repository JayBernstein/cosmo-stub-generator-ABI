...
void initialize_gio(void) {
    char *candidates_glib2[] = { "libgio-2.so", "libgio-2.0-0.dll" };
    ...
    stub_funcs.ptr_g_action_get_type = try_find_sym(glib2, "g_action_get_type");
    stub_funcs.ptr_g_action_get_name = try_find_sym(glib2, "g_action_get_name");
    stub_funcs.ptr_g_action_get_parameter_type = try_find_sym(glib2, "g_action_get_parameter_type");
    stub_funcs.ptr_g_action_get_state_type = try_find_sym(glib2, "g_action_get_state_type");
    stub_funcs.ptr_g_action_get_state_hint = try_find_sym(glib2, "g_action_get_state_hint");
    stub_funcs.ptr_g_action_get_enabled = try_find_sym(glib2, "g_action_get_enabled");
    stub_funcs.ptr_g_action_get_state = try_find_sym(glib2, "g_action_get_state");
    stub_funcs.ptr_g_action_change_state = try_find_sym(glib2, "g_action_change_state");
    stub_funcs.ptr_g_action_activate = try_find_sym(glib2, "g_action_activate");
    stub_funcs.ptr_g_action_name_is_valid = try_find_sym(glib2, "g_action_name_is_valid");
    stub_funcs.ptr_g_action_parse_detailed_name = try_find_sym(glib2, "g_action_parse_detailed_name");
    stub_funcs.ptr_g_action_print_detailed_name = try_find_sym(glib2, "g_action_print_detailed_name");
    stub_funcs.ptr_g_action_group_get_type = try_find_sym(glib2, "g_action_group_get_type");
    stub_funcs.ptr_g_action_group_has_action = try_find_sym(glib2, "g_action_group_has_action");
    stub_funcs.ptr_g_action_group_list_actions = try_find_sym(glib2, "g_action_group_list_actions");
    stub_funcs.ptr_g_action_group_get_action_parameter_type = try_find_sym(glib2, "g_action_group_get_action_parameter_type");
    stub_funcs.ptr_g_action_group_get_action_state_type = try_find_sym(glib2, "g_action_group_get_action_state_type");
    stub_funcs.ptr_g_action_group_get_action_state_hint = try_find_sym(glib2, "g_action_group_get_action_state_hint");
    stub_funcs.ptr_g_action_group_get_action_enabled = try_find_sym(glib2, "g_action_group_get_action_enabled");
    stub_funcs.ptr_g_action_group_get_action_state = try_find_sym(glib2, "g_action_group_get_action_state");
    stub_funcs.ptr_g_action_group_change_action_state = try_find_sym(glib2, "g_action_group_change_action_state");
    stub_funcs.ptr_g_action_group_activate_action = try_find_sym(glib2, "g_action_group_activate_action");
    stub_funcs.ptr_g_action_group_action_added = try_find_sym(glib2, "g_action_group_action_added");
    stub_funcs.ptr_g_action_group_action_removed = try_find_sym(glib2, "g_action_group_action_removed");
    stub_funcs.ptr_g_action_group_action_enabled_changed = try_find_sym(glib2, "g_action_group_action_enabled_changed");
    stub_funcs.ptr_g_action_group_action_state_changed = try_find_sym(glib2, "g_action_group_action_state_changed");
    stub_funcs.ptr_g_action_group_query_action = try_find_sym(glib2, "g_action_group_query_action");
    stub_funcs.ptr_g_dbus_connection_export_action_group = try_find_sym(glib2, "g_dbus_connection_export_action_group");
    stub_funcs.ptr_g_dbus_connection_unexport_action_group = try_find_sym(glib2, "g_dbus_connection_unexport_action_group");
    stub_funcs.ptr_g_action_map_get_type = try_find_sym(glib2, "g_action_map_get_type");
    stub_funcs.ptr_g_action_map_lookup_action = try_find_sym(glib2, "g_action_map_lookup_action");
    stub_funcs.ptr_g_action_map_add_action = try_find_sym(glib2, "g_action_map_add_action");
    stub_funcs.ptr_g_action_map_remove_action = try_find_sym(glib2, "g_action_map_remove_action");
    stub_funcs.ptr_g_action_map_add_action_entries = try_find_sym(glib2, "g_action_map_add_action_entries");
    stub_funcs.ptr_g_action_map_remove_action_entries = try_find_sym(glib2, "g_action_map_remove_action_entries");
    stub_funcs.ptr_g_app_info_get_type = try_find_sym(glib2, "g_app_info_get_type");
    stub_funcs.ptr_g_app_info_create_from_commandline = try_find_sym(glib2, "g_app_info_create_from_commandline");
    stub_funcs.ptr_g_app_info_dup = try_find_sym(glib2, "g_app_info_dup");
    stub_funcs.ptr_g_app_info_equal = try_find_sym(glib2, "g_app_info_equal");
    stub_funcs.ptr_g_app_info_get_id = try_find_sym(glib2, "g_app_info_get_id");
    stub_funcs.ptr_g_app_info_get_name = try_find_sym(glib2, "g_app_info_get_name");
    stub_funcs.ptr_g_app_info_get_display_name = try_find_sym(glib2, "g_app_info_get_display_name");
    stub_funcs.ptr_g_app_info_get_description = try_find_sym(glib2, "g_app_info_get_description");
    stub_funcs.ptr_g_app_info_get_executable = try_find_sym(glib2, "g_app_info_get_executable");
    stub_funcs.ptr_g_app_info_get_commandline = try_find_sym(glib2, "g_app_info_get_commandline");
    stub_funcs.ptr_g_app_info_get_icon = try_find_sym(glib2, "g_app_info_get_icon");
    stub_funcs.ptr_g_app_info_launch = try_find_sym(glib2, "g_app_info_launch");
    stub_funcs.ptr_g_app_info_supports_uris = try_find_sym(glib2, "g_app_info_supports_uris");
    stub_funcs.ptr_g_app_info_supports_files = try_find_sym(glib2, "g_app_info_supports_files");
    stub_funcs.ptr_g_app_info_launch_uris = try_find_sym(glib2, "g_app_info_launch_uris");
    stub_funcs.ptr_g_app_info_launch_uris_async = try_find_sym(glib2, "g_app_info_launch_uris_async");
    stub_funcs.ptr_g_app_info_launch_uris_finish = try_find_sym(glib2, "g_app_info_launch_uris_finish");
    stub_funcs.ptr_g_app_info_should_show = try_find_sym(glib2, "g_app_info_should_show");
    stub_funcs.ptr_g_app_info_set_as_default_for_type = try_find_sym(glib2, "g_app_info_set_as_default_for_type");
    stub_funcs.ptr_g_app_info_set_as_default_for_extension = try_find_sym(glib2, "g_app_info_set_as_default_for_extension");
    stub_funcs.ptr_g_app_info_add_supports_type = try_find_sym(glib2, "g_app_info_add_supports_type");
    stub_funcs.ptr_g_app_info_can_remove_supports_type = try_find_sym(glib2, "g_app_info_can_remove_supports_type");
    stub_funcs.ptr_g_app_info_remove_supports_type = try_find_sym(glib2, "g_app_info_remove_supports_type");
    stub_funcs.ptr_g_app_info_get_supported_types = try_find_sym(glib2, "g_app_info_get_supported_types");
    stub_funcs.ptr_g_app_info_can_delete = try_find_sym(glib2, "g_app_info_can_delete");
    stub_funcs.ptr_g_app_info_delete = try_find_sym(glib2, "g_app_info_delete");
    stub_funcs.ptr_g_app_info_set_as_last_used_for_type = try_find_sym(glib2, "g_app_info_set_as_last_used_for_type");
    stub_funcs.ptr_g_app_info_get_all = try_find_sym(glib2, "g_app_info_get_all");
    stub_funcs.ptr_g_app_info_get_all_for_type = try_find_sym(glib2, "g_app_info_get_all_for_type");
    stub_funcs.ptr_g_app_info_get_recommended_for_type = try_find_sym(glib2, "g_app_info_get_recommended_for_type");
    stub_funcs.ptr_g_app_info_get_fallback_for_type = try_find_sym(glib2, "g_app_info_get_fallback_for_type");
    stub_funcs.ptr_g_app_info_reset_type_associations = try_find_sym(glib2, "g_app_info_reset_type_associations");
    stub_funcs.ptr_g_app_info_get_default_for_type = try_find_sym(glib2, "g_app_info_get_default_for_type");
    stub_funcs.ptr_g_app_info_get_default_for_type_async = try_find_sym(glib2, "g_app_info_get_default_for_type_async");
    stub_funcs.ptr_g_app_info_get_default_for_type_finish = try_find_sym(glib2, "g_app_info_get_default_for_type_finish");
    stub_funcs.ptr_g_app_info_get_default_for_uri_scheme = try_find_sym(glib2, "g_app_info_get_default_for_uri_scheme");
    stub_funcs.ptr_g_app_info_get_default_for_uri_scheme_async = try_find_sym(glib2, "g_app_info_get_default_for_uri_scheme_async");
    stub_funcs.ptr_g_app_info_get_default_for_uri_scheme_finish = try_find_sym(glib2, "g_app_info_get_default_for_uri_scheme_finish");
    stub_funcs.ptr_g_app_info_launch_default_for_uri = try_find_sym(glib2, "g_app_info_launch_default_for_uri");
    stub_funcs.ptr_g_app_info_launch_default_for_uri_async = try_find_sym(glib2, "g_app_info_launch_default_for_uri_async");
    stub_funcs.ptr_g_app_info_launch_default_for_uri_finish = try_find_sym(glib2, "g_app_info_launch_default_for_uri_finish");
    stub_funcs.ptr_g_app_launch_context_get_type = try_find_sym(glib2, "g_app_launch_context_get_type");
    stub_funcs.ptr_g_app_launch_context_new = try_find_sym(glib2, "g_app_launch_context_new");
    stub_funcs.ptr_g_app_launch_context_setenv = try_find_sym(glib2, "g_app_launch_context_setenv");
    stub_funcs.ptr_g_app_launch_context_unsetenv = try_find_sym(glib2, "g_app_launch_context_unsetenv");
    stub_funcs.ptr_g_app_launch_context_get_environment = try_find_sym(glib2, "g_app_launch_context_get_environment");
    stub_funcs.ptr_g_app_launch_context_get_display = try_find_sym(glib2, "g_app_launch_context_get_display");
    stub_funcs.ptr_g_app_launch_context_get_startup_notify_id = try_find_sym(glib2, "g_app_launch_context_get_startup_notify_id");
    stub_funcs.ptr_g_app_launch_context_launch_failed = try_find_sym(glib2, "g_app_launch_context_launch_failed");
    stub_funcs.ptr_g_app_info_monitor_get_type = try_find_sym(glib2, "g_app_info_monitor_get_type");
    stub_funcs.ptr_g_app_info_monitor_get = try_find_sym(glib2, "g_app_info_monitor_get");
    stub_funcs.ptr_g_application_get_type = try_find_sym(glib2, "g_application_get_type");
    stub_funcs.ptr_g_application_id_is_valid = try_find_sym(glib2, "g_application_id_is_valid");
    stub_funcs.ptr_g_application_new = try_find_sym(glib2, "g_application_new");
    stub_funcs.ptr_g_application_get_application_id = try_find_sym(glib2, "g_application_get_application_id");
    stub_funcs.ptr_g_application_set_application_id = try_find_sym(glib2, "g_application_set_application_id");
    stub_funcs.ptr_g_application_get_version = try_find_sym(glib2, "g_application_get_version");
    stub_funcs.ptr_g_application_set_version = try_find_sym(glib2, "g_application_set_version");
    stub_funcs.ptr_g_application_get_dbus_connection = try_find_sym(glib2, "g_application_get_dbus_connection");
    stub_funcs.ptr_g_application_get_dbus_object_path = try_find_sym(glib2, "g_application_get_dbus_object_path");
    stub_funcs.ptr_g_application_get_inactivity_timeout = try_find_sym(glib2, "g_application_get_inactivity_timeout");
    stub_funcs.ptr_g_application_set_inactivity_timeout = try_find_sym(glib2, "g_application_set_inactivity_timeout");
    stub_funcs.ptr_g_application_get_flags = try_find_sym(glib2, "g_application_get_flags");
    stub_funcs.ptr_g_application_set_flags = try_find_sym(glib2, "g_application_set_flags");
    stub_funcs.ptr_g_application_get_resource_base_path = try_find_sym(glib2, "g_application_get_resource_base_path");
    stub_funcs.ptr_g_application_set_resource_base_path = try_find_sym(glib2, "g_application_set_resource_base_path");
    stub_funcs.ptr_g_application_set_action_group = try_find_sym(glib2, "g_application_set_action_group");
    stub_funcs.ptr_g_application_add_main_option_entries = try_find_sym(glib2, "g_application_add_main_option_entries");
    stub_funcs.ptr_g_application_add_main_option = try_find_sym(glib2, "g_application_add_main_option");
    stub_funcs.ptr_g_application_add_option_group = try_find_sym(glib2, "g_application_add_option_group");
    stub_funcs.ptr_g_application_set_option_context_parameter_string = try_find_sym(glib2, "g_application_set_option_context_parameter_string");
    stub_funcs.ptr_g_application_set_option_context_summary = try_find_sym(glib2, "g_application_set_option_context_summary");
    stub_funcs.ptr_g_application_set_option_context_description = try_find_sym(glib2, "g_application_set_option_context_description");
    stub_funcs.ptr_g_application_get_is_registered = try_find_sym(glib2, "g_application_get_is_registered");
    stub_funcs.ptr_g_application_get_is_remote = try_find_sym(glib2, "g_application_get_is_remote");
    stub_funcs.ptr_g_application_register = try_find_sym(glib2, "g_application_register");
    stub_funcs.ptr_g_application_hold = try_find_sym(glib2, "g_application_hold");
    stub_funcs.ptr_g_application_release = try_find_sym(glib2, "g_application_release");
    stub_funcs.ptr_g_application_activate = try_find_sym(glib2, "g_application_activate");
    stub_funcs.ptr_g_application_open = try_find_sym(glib2, "g_application_open");
    stub_funcs.ptr_g_application_run = try_find_sym(glib2, "g_application_run");
    stub_funcs.ptr_g_application_quit = try_find_sym(glib2, "g_application_quit");
    stub_funcs.ptr_g_application_get_default = try_find_sym(glib2, "g_application_get_default");
    stub_funcs.ptr_g_application_set_default = try_find_sym(glib2, "g_application_set_default");
    stub_funcs.ptr_g_application_mark_busy = try_find_sym(glib2, "g_application_mark_busy");
    stub_funcs.ptr_g_application_unmark_busy = try_find_sym(glib2, "g_application_unmark_busy");
    stub_funcs.ptr_g_application_get_is_busy = try_find_sym(glib2, "g_application_get_is_busy");
    stub_funcs.ptr_g_application_send_notification = try_find_sym(glib2, "g_application_send_notification");
    stub_funcs.ptr_g_application_withdraw_notification = try_find_sym(glib2, "g_application_withdraw_notification");
    stub_funcs.ptr_g_application_bind_busy_property = try_find_sym(glib2, "g_application_bind_busy_property");
    stub_funcs.ptr_g_application_unbind_busy_property = try_find_sym(glib2, "g_application_unbind_busy_property");
    stub_funcs.ptr_g_application_command_line_get_type = try_find_sym(glib2, "g_application_command_line_get_type");
    stub_funcs.ptr_g_application_command_line_get_arguments = try_find_sym(glib2, "g_application_command_line_get_arguments");
    stub_funcs.ptr_g_application_command_line_get_options_dict = try_find_sym(glib2, "g_application_command_line_get_options_dict");
    stub_funcs.ptr_g_application_command_line_get_stdin = try_find_sym(glib2, "g_application_command_line_get_stdin");
    stub_funcs.ptr_g_application_command_line_get_environ = try_find_sym(glib2, "g_application_command_line_get_environ");
    stub_funcs.ptr_g_application_command_line_getenv = try_find_sym(glib2, "g_application_command_line_getenv");
    stub_funcs.ptr_g_application_command_line_get_cwd = try_find_sym(glib2, "g_application_command_line_get_cwd");
    stub_funcs.ptr_g_application_command_line_get_is_remote = try_find_sym(glib2, "g_application_command_line_get_is_remote");
    stub_funcs.ptr_g_application_command_line_print_literal = try_find_sym(glib2, "g_application_command_line_print_literal");
    stub_funcs.ptr_g_application_command_line_printerr_literal = try_find_sym(glib2, "g_application_command_line_printerr_literal");
    stub_funcs.ptr_g_application_command_line_get_exit_status = try_find_sym(glib2, "g_application_command_line_get_exit_status");
    stub_funcs.ptr_g_application_command_line_set_exit_status = try_find_sym(glib2, "g_application_command_line_set_exit_status");
    stub_funcs.ptr_g_application_command_line_get_platform_data = try_find_sym(glib2, "g_application_command_line_get_platform_data");
    stub_funcs.ptr_g_application_command_line_create_file_for_arg = try_find_sym(glib2, "g_application_command_line_create_file_for_arg");
    stub_funcs.ptr_g_application_command_line_done = try_find_sym(glib2, "g_application_command_line_done");
    stub_funcs.ptr_g_initable_get_type = try_find_sym(glib2, "g_initable_get_type");
    stub_funcs.ptr_g_initable_init = try_find_sym(glib2, "g_initable_init");
    stub_funcs.ptr_g_initable_new = try_find_sym(glib2, "g_initable_new");
    stub_funcs.ptr_g_initable_newv = try_find_sym(glib2, "g_initable_newv");
    stub_funcs.ptr_g_initable_new_valist = try_find_sym(glib2, "g_initable_new_valist");
    stub_funcs.ptr_g_async_initable_get_type = try_find_sym(glib2, "g_async_initable_get_type");
    stub_funcs.ptr_g_async_initable_init_async = try_find_sym(glib2, "g_async_initable_init_async");
    stub_funcs.ptr_g_async_initable_init_finish = try_find_sym(glib2, "g_async_initable_init_finish");
    stub_funcs.ptr_g_async_initable_newv_async = try_find_sym(glib2, "g_async_initable_newv_async");
    stub_funcs.ptr_g_async_initable_new_valist_async = try_find_sym(glib2, "g_async_initable_new_valist_async");
    stub_funcs.ptr_g_async_initable_new_finish = try_find_sym(glib2, "g_async_initable_new_finish");
    stub_funcs.ptr_g_async_result_get_type = try_find_sym(glib2, "g_async_result_get_type");
    stub_funcs.ptr_g_async_result_get_user_data = try_find_sym(glib2, "g_async_result_get_user_data");
    stub_funcs.ptr_g_async_result_get_source_object = try_find_sym(glib2, "g_async_result_get_source_object");
    stub_funcs.ptr_g_async_result_legacy_propagate_error = try_find_sym(glib2, "g_async_result_legacy_propagate_error");
    stub_funcs.ptr_g_async_result_is_tagged = try_find_sym(glib2, "g_async_result_is_tagged");
    stub_funcs.ptr_g_input_stream_get_type = try_find_sym(glib2, "g_input_stream_get_type");
    stub_funcs.ptr_g_input_stream_read = try_find_sym(glib2, "g_input_stream_read");
    stub_funcs.ptr_g_input_stream_read_all = try_find_sym(glib2, "g_input_stream_read_all");
    stub_funcs.ptr_g_input_stream_read_bytes = try_find_sym(glib2, "g_input_stream_read_bytes");
    stub_funcs.ptr_g_input_stream_skip = try_find_sym(glib2, "g_input_stream_skip");
    stub_funcs.ptr_g_input_stream_close = try_find_sym(glib2, "g_input_stream_close");
    stub_funcs.ptr_g_input_stream_read_async = try_find_sym(glib2, "g_input_stream_read_async");
    stub_funcs.ptr_g_input_stream_read_finish = try_find_sym(glib2, "g_input_stream_read_finish");
    stub_funcs.ptr_g_input_stream_read_all_async = try_find_sym(glib2, "g_input_stream_read_all_async");
    stub_funcs.ptr_g_input_stream_read_all_finish = try_find_sym(glib2, "g_input_stream_read_all_finish");
    stub_funcs.ptr_g_input_stream_read_bytes_async = try_find_sym(glib2, "g_input_stream_read_bytes_async");
    stub_funcs.ptr_g_input_stream_read_bytes_finish = try_find_sym(glib2, "g_input_stream_read_bytes_finish");
    stub_funcs.ptr_g_input_stream_skip_async = try_find_sym(glib2, "g_input_stream_skip_async");
    stub_funcs.ptr_g_input_stream_skip_finish = try_find_sym(glib2, "g_input_stream_skip_finish");
    stub_funcs.ptr_g_input_stream_close_async = try_find_sym(glib2, "g_input_stream_close_async");
    stub_funcs.ptr_g_input_stream_close_finish = try_find_sym(glib2, "g_input_stream_close_finish");
    stub_funcs.ptr_g_input_stream_is_closed = try_find_sym(glib2, "g_input_stream_is_closed");
    stub_funcs.ptr_g_input_stream_has_pending = try_find_sym(glib2, "g_input_stream_has_pending");
    stub_funcs.ptr_g_input_stream_set_pending = try_find_sym(glib2, "g_input_stream_set_pending");
    stub_funcs.ptr_g_input_stream_clear_pending = try_find_sym(glib2, "g_input_stream_clear_pending");
    stub_funcs.ptr_g_filter_input_stream_get_type = try_find_sym(glib2, "g_filter_input_stream_get_type");
    stub_funcs.ptr_g_filter_input_stream_get_base_stream = try_find_sym(glib2, "g_filter_input_stream_get_base_stream");
    stub_funcs.ptr_g_filter_input_stream_get_close_base_stream = try_find_sym(glib2, "g_filter_input_stream_get_close_base_stream");
    stub_funcs.ptr_g_filter_input_stream_set_close_base_stream = try_find_sym(glib2, "g_filter_input_stream_set_close_base_stream");
    stub_funcs.ptr_g_buffered_input_stream_get_type = try_find_sym(glib2, "g_buffered_input_stream_get_type");
    stub_funcs.ptr_g_buffered_input_stream_new = try_find_sym(glib2, "g_buffered_input_stream_new");
    stub_funcs.ptr_g_buffered_input_stream_new_sized = try_find_sym(glib2, "g_buffered_input_stream_new_sized");
    stub_funcs.ptr_g_buffered_input_stream_get_buffer_size = try_find_sym(glib2, "g_buffered_input_stream_get_buffer_size");
    stub_funcs.ptr_g_buffered_input_stream_set_buffer_size = try_find_sym(glib2, "g_buffered_input_stream_set_buffer_size");
    stub_funcs.ptr_g_buffered_input_stream_get_available = try_find_sym(glib2, "g_buffered_input_stream_get_available");
    stub_funcs.ptr_g_buffered_input_stream_peek = try_find_sym(glib2, "g_buffered_input_stream_peek");
    stub_funcs.ptr_g_buffered_input_stream_peek_buffer = try_find_sym(glib2, "g_buffered_input_stream_peek_buffer");
    stub_funcs.ptr_g_buffered_input_stream_fill = try_find_sym(glib2, "g_buffered_input_stream_fill");
    stub_funcs.ptr_g_buffered_input_stream_fill_async = try_find_sym(glib2, "g_buffered_input_stream_fill_async");
    stub_funcs.ptr_g_buffered_input_stream_fill_finish = try_find_sym(glib2, "g_buffered_input_stream_fill_finish");
    stub_funcs.ptr_g_buffered_input_stream_read_byte = try_find_sym(glib2, "g_buffered_input_stream_read_byte");
    stub_funcs.ptr_g_output_stream_get_type = try_find_sym(glib2, "g_output_stream_get_type");
    stub_funcs.ptr_g_output_stream_write = try_find_sym(glib2, "g_output_stream_write");
    stub_funcs.ptr_g_output_stream_write_all = try_find_sym(glib2, "g_output_stream_write_all");
    stub_funcs.ptr_g_output_stream_writev = try_find_sym(glib2, "g_output_stream_writev");
    stub_funcs.ptr_g_output_stream_writev_all = try_find_sym(glib2, "g_output_stream_writev_all");
    stub_funcs.ptr_g_output_stream_printf = try_find_sym(glib2, "g_output_stream_printf");
    stub_funcs.ptr_g_output_stream_vprintf = try_find_sym(glib2, "g_output_stream_vprintf");
    stub_funcs.ptr_g_output_stream_write_bytes = try_find_sym(glib2, "g_output_stream_write_bytes");
    stub_funcs.ptr_g_output_stream_splice = try_find_sym(glib2, "g_output_stream_splice");
    stub_funcs.ptr_g_output_stream_flush = try_find_sym(glib2, "g_output_stream_flush");
    stub_funcs.ptr_g_output_stream_close = try_find_sym(glib2, "g_output_stream_close");
    stub_funcs.ptr_g_output_stream_write_async = try_find_sym(glib2, "g_output_stream_write_async");
    stub_funcs.ptr_g_output_stream_write_finish = try_find_sym(glib2, "g_output_stream_write_finish");
    stub_funcs.ptr_g_output_stream_write_all_async = try_find_sym(glib2, "g_output_stream_write_all_async");
    stub_funcs.ptr_g_output_stream_write_all_finish = try_find_sym(glib2, "g_output_stream_write_all_finish");
    stub_funcs.ptr_g_output_stream_writev_async = try_find_sym(glib2, "g_output_stream_writev_async");
    stub_funcs.ptr_g_output_stream_writev_finish = try_find_sym(glib2, "g_output_stream_writev_finish");
    stub_funcs.ptr_g_output_stream_writev_all_async = try_find_sym(glib2, "g_output_stream_writev_all_async");
    stub_funcs.ptr_g_output_stream_writev_all_finish = try_find_sym(glib2, "g_output_stream_writev_all_finish");
    stub_funcs.ptr_g_output_stream_write_bytes_async = try_find_sym(glib2, "g_output_stream_write_bytes_async");
    stub_funcs.ptr_g_output_stream_write_bytes_finish = try_find_sym(glib2, "g_output_stream_write_bytes_finish");
    stub_funcs.ptr_g_output_stream_splice_async = try_find_sym(glib2, "g_output_stream_splice_async");
    stub_funcs.ptr_g_output_stream_splice_finish = try_find_sym(glib2, "g_output_stream_splice_finish");
    stub_funcs.ptr_g_output_stream_flush_async = try_find_sym(glib2, "g_output_stream_flush_async");
    stub_funcs.ptr_g_output_stream_flush_finish = try_find_sym(glib2, "g_output_stream_flush_finish");
    stub_funcs.ptr_g_output_stream_close_async = try_find_sym(glib2, "g_output_stream_close_async");
    stub_funcs.ptr_g_output_stream_close_finish = try_find_sym(glib2, "g_output_stream_close_finish");
    stub_funcs.ptr_g_output_stream_is_closed = try_find_sym(glib2, "g_output_stream_is_closed");
    stub_funcs.ptr_g_output_stream_is_closing = try_find_sym(glib2, "g_output_stream_is_closing");
    stub_funcs.ptr_g_output_stream_has_pending = try_find_sym(glib2, "g_output_stream_has_pending");
    stub_funcs.ptr_g_output_stream_set_pending = try_find_sym(glib2, "g_output_stream_set_pending");
    stub_funcs.ptr_g_output_stream_clear_pending = try_find_sym(glib2, "g_output_stream_clear_pending");
    stub_funcs.ptr_g_filter_output_stream_get_type = try_find_sym(glib2, "g_filter_output_stream_get_type");
    stub_funcs.ptr_g_filter_output_stream_get_base_stream = try_find_sym(glib2, "g_filter_output_stream_get_base_stream");
    stub_funcs.ptr_g_filter_output_stream_get_close_base_stream = try_find_sym(glib2, "g_filter_output_stream_get_close_base_stream");
    stub_funcs.ptr_g_filter_output_stream_set_close_base_stream = try_find_sym(glib2, "g_filter_output_stream_set_close_base_stream");
    stub_funcs.ptr_g_buffered_output_stream_get_type = try_find_sym(glib2, "g_buffered_output_stream_get_type");
    stub_funcs.ptr_g_buffered_output_stream_new = try_find_sym(glib2, "g_buffered_output_stream_new");
    stub_funcs.ptr_g_buffered_output_stream_new_sized = try_find_sym(glib2, "g_buffered_output_stream_new_sized");
    stub_funcs.ptr_g_buffered_output_stream_get_buffer_size = try_find_sym(glib2, "g_buffered_output_stream_get_buffer_size");
    stub_funcs.ptr_g_buffered_output_stream_set_buffer_size = try_find_sym(glib2, "g_buffered_output_stream_set_buffer_size");
    stub_funcs.ptr_g_buffered_output_stream_get_auto_grow = try_find_sym(glib2, "g_buffered_output_stream_get_auto_grow");
    stub_funcs.ptr_g_buffered_output_stream_set_auto_grow = try_find_sym(glib2, "g_buffered_output_stream_set_auto_grow");
    stub_funcs.ptr_g_bytes_icon_get_type = try_find_sym(glib2, "g_bytes_icon_get_type");
    stub_funcs.ptr_g_bytes_icon_new = try_find_sym(glib2, "g_bytes_icon_new");
    stub_funcs.ptr_g_bytes_icon_get_bytes = try_find_sym(glib2, "g_bytes_icon_get_bytes");
    stub_funcs.ptr_g_cancellable_get_type = try_find_sym(glib2, "g_cancellable_get_type");
    stub_funcs.ptr_g_cancellable_new = try_find_sym(glib2, "g_cancellable_new");
    stub_funcs.ptr_g_cancellable_is_cancelled = try_find_sym(glib2, "g_cancellable_is_cancelled");
    stub_funcs.ptr_g_cancellable_set_error_if_cancelled = try_find_sym(glib2, "g_cancellable_set_error_if_cancelled");
    stub_funcs.ptr_g_cancellable_get_fd = try_find_sym(glib2, "g_cancellable_get_fd");
    stub_funcs.ptr_g_cancellable_make_pollfd = try_find_sym(glib2, "g_cancellable_make_pollfd");
    stub_funcs.ptr_g_cancellable_release_fd = try_find_sym(glib2, "g_cancellable_release_fd");
    stub_funcs.ptr_g_cancellable_source_new = try_find_sym(glib2, "g_cancellable_source_new");
    stub_funcs.ptr_g_cancellable_get_current = try_find_sym(glib2, "g_cancellable_get_current");
    stub_funcs.ptr_g_cancellable_push_current = try_find_sym(glib2, "g_cancellable_push_current");
    stub_funcs.ptr_g_cancellable_pop_current = try_find_sym(glib2, "g_cancellable_pop_current");
    stub_funcs.ptr_g_cancellable_reset = try_find_sym(glib2, "g_cancellable_reset");
    stub_funcs.ptr_g_cancellable_connect = try_find_sym(glib2, "g_cancellable_connect");
    stub_funcs.ptr_g_cancellable_disconnect = try_find_sym(glib2, "g_cancellable_disconnect");
    stub_funcs.ptr_g_cancellable_cancel = try_find_sym(glib2, "g_cancellable_cancel");
    stub_funcs.ptr_g_converter_get_type = try_find_sym(glib2, "g_converter_get_type");
    stub_funcs.ptr_g_converter_convert = try_find_sym(glib2, "g_converter_convert");
    stub_funcs.ptr_g_converter_reset = try_find_sym(glib2, "g_converter_reset");
    stub_funcs.ptr_g_converter_convert_bytes = try_find_sym(glib2, "g_converter_convert_bytes");
    stub_funcs.ptr_g_charset_converter_get_type = try_find_sym(glib2, "g_charset_converter_get_type");
    stub_funcs.ptr_g_charset_converter_new = try_find_sym(glib2, "g_charset_converter_new");
    stub_funcs.ptr_g_charset_converter_set_use_fallback = try_find_sym(glib2, "g_charset_converter_set_use_fallback");
    stub_funcs.ptr_g_charset_converter_get_use_fallback = try_find_sym(glib2, "g_charset_converter_get_use_fallback");
    stub_funcs.ptr_g_charset_converter_get_num_fallbacks = try_find_sym(glib2, "g_charset_converter_get_num_fallbacks");
    stub_funcs.ptr_g_content_type_equals = try_find_sym(glib2, "g_content_type_equals");
    stub_funcs.ptr_g_content_type_is_a = try_find_sym(glib2, "g_content_type_is_a");
    stub_funcs.ptr_g_content_type_is_mime_type = try_find_sym(glib2, "g_content_type_is_mime_type");
    stub_funcs.ptr_g_content_type_is_unknown = try_find_sym(glib2, "g_content_type_is_unknown");
    stub_funcs.ptr_g_content_type_get_description = try_find_sym(glib2, "g_content_type_get_description");
    stub_funcs.ptr_g_content_type_get_mime_type = try_find_sym(glib2, "g_content_type_get_mime_type");
    stub_funcs.ptr_g_content_type_get_icon = try_find_sym(glib2, "g_content_type_get_icon");
    stub_funcs.ptr_g_content_type_get_symbolic_icon = try_find_sym(glib2, "g_content_type_get_symbolic_icon");
    stub_funcs.ptr_g_content_type_get_generic_icon_name = try_find_sym(glib2, "g_content_type_get_generic_icon_name");
    stub_funcs.ptr_g_content_type_can_be_executable = try_find_sym(glib2, "g_content_type_can_be_executable");
    stub_funcs.ptr_g_content_type_from_mime_type = try_find_sym(glib2, "g_content_type_from_mime_type");
    stub_funcs.ptr_g_content_type_guess = try_find_sym(glib2, "g_content_type_guess");
    stub_funcs.ptr_g_content_type_guess_for_tree = try_find_sym(glib2, "g_content_type_guess_for_tree");
    stub_funcs.ptr_g_content_types_get_registered = try_find_sym(glib2, "g_content_types_get_registered");
    stub_funcs.ptr_g_content_type_get_mime_dirs = try_find_sym(glib2, "g_content_type_get_mime_dirs");
    stub_funcs.ptr_g_content_type_set_mime_dirs = try_find_sym(glib2, "g_content_type_set_mime_dirs");
    stub_funcs.ptr_g_converter_input_stream_get_type = try_find_sym(glib2, "g_converter_input_stream_get_type");
    stub_funcs.ptr_g_converter_input_stream_new = try_find_sym(glib2, "g_converter_input_stream_new");
    stub_funcs.ptr_g_converter_input_stream_get_converter = try_find_sym(glib2, "g_converter_input_stream_get_converter");
    stub_funcs.ptr_g_converter_output_stream_get_type = try_find_sym(glib2, "g_converter_output_stream_get_type");
    stub_funcs.ptr_g_converter_output_stream_new = try_find_sym(glib2, "g_converter_output_stream_new");
    stub_funcs.ptr_g_converter_output_stream_get_converter = try_find_sym(glib2, "g_converter_output_stream_get_converter");
    stub_funcs.ptr_g_credentials_get_type = try_find_sym(glib2, "g_credentials_get_type");
    stub_funcs.ptr_g_credentials_new = try_find_sym(glib2, "g_credentials_new");
    stub_funcs.ptr_g_credentials_to_string = try_find_sym(glib2, "g_credentials_to_string");
    stub_funcs.ptr_g_credentials_get_native = try_find_sym(glib2, "g_credentials_get_native");
    stub_funcs.ptr_g_credentials_set_native = try_find_sym(glib2, "g_credentials_set_native");
    stub_funcs.ptr_g_credentials_is_same_user = try_find_sym(glib2, "g_credentials_is_same_user");
    stub_funcs.ptr_g_credentials_get_unix_pid = try_find_sym(glib2, "g_credentials_get_unix_pid");
    stub_funcs.ptr_g_credentials_get_unix_user = try_find_sym(glib2, "g_credentials_get_unix_user");
    stub_funcs.ptr_g_credentials_set_unix_user = try_find_sym(glib2, "g_credentials_set_unix_user");
    stub_funcs.ptr_g_datagram_based_get_type = try_find_sym(glib2, "g_datagram_based_get_type");
    stub_funcs.ptr_g_datagram_based_receive_messages = try_find_sym(glib2, "g_datagram_based_receive_messages");
    stub_funcs.ptr_g_datagram_based_send_messages = try_find_sym(glib2, "g_datagram_based_send_messages");
    stub_funcs.ptr_g_datagram_based_create_source = try_find_sym(glib2, "g_datagram_based_create_source");
    stub_funcs.ptr_g_datagram_based_condition_check = try_find_sym(glib2, "g_datagram_based_condition_check");
    stub_funcs.ptr_g_datagram_based_condition_wait = try_find_sym(glib2, "g_datagram_based_condition_wait");
    stub_funcs.ptr_g_data_input_stream_get_type = try_find_sym(glib2, "g_data_input_stream_get_type");
    stub_funcs.ptr_g_data_input_stream_new = try_find_sym(glib2, "g_data_input_stream_new");
    stub_funcs.ptr_g_data_input_stream_set_byte_order = try_find_sym(glib2, "g_data_input_stream_set_byte_order");
    stub_funcs.ptr_g_data_input_stream_get_byte_order = try_find_sym(glib2, "g_data_input_stream_get_byte_order");
    stub_funcs.ptr_g_data_input_stream_set_newline_type = try_find_sym(glib2, "g_data_input_stream_set_newline_type");
    stub_funcs.ptr_g_data_input_stream_get_newline_type = try_find_sym(glib2, "g_data_input_stream_get_newline_type");
    stub_funcs.ptr_g_data_input_stream_read_byte = try_find_sym(glib2, "g_data_input_stream_read_byte");
    stub_funcs.ptr_g_data_input_stream_read_int16 = try_find_sym(glib2, "g_data_input_stream_read_int16");
    stub_funcs.ptr_g_data_input_stream_read_uint16 = try_find_sym(glib2, "g_data_input_stream_read_uint16");
    stub_funcs.ptr_g_data_input_stream_read_int32 = try_find_sym(glib2, "g_data_input_stream_read_int32");
    stub_funcs.ptr_g_data_input_stream_read_uint32 = try_find_sym(glib2, "g_data_input_stream_read_uint32");
    stub_funcs.ptr_g_data_input_stream_read_int64 = try_find_sym(glib2, "g_data_input_stream_read_int64");
    stub_funcs.ptr_g_data_input_stream_read_uint64 = try_find_sym(glib2, "g_data_input_stream_read_uint64");
    stub_funcs.ptr_g_data_input_stream_read_line = try_find_sym(glib2, "g_data_input_stream_read_line");
    stub_funcs.ptr_g_data_input_stream_read_line_utf8 = try_find_sym(glib2, "g_data_input_stream_read_line_utf8");
    stub_funcs.ptr_g_data_input_stream_read_line_async = try_find_sym(glib2, "g_data_input_stream_read_line_async");
    stub_funcs.ptr_g_data_input_stream_read_line_finish = try_find_sym(glib2, "g_data_input_stream_read_line_finish");
    stub_funcs.ptr_g_data_input_stream_read_line_finish_utf8 = try_find_sym(glib2, "g_data_input_stream_read_line_finish_utf8");
    stub_funcs.ptr_g_data_input_stream_read_until = try_find_sym(glib2, "g_data_input_stream_read_until");
    stub_funcs.ptr_g_data_input_stream_read_until_async = try_find_sym(glib2, "g_data_input_stream_read_until_async");
    stub_funcs.ptr_g_data_input_stream_read_until_finish = try_find_sym(glib2, "g_data_input_stream_read_until_finish");
    stub_funcs.ptr_g_data_input_stream_read_upto = try_find_sym(glib2, "g_data_input_stream_read_upto");
    stub_funcs.ptr_g_data_input_stream_read_upto_async = try_find_sym(glib2, "g_data_input_stream_read_upto_async");
    stub_funcs.ptr_g_data_input_stream_read_upto_finish = try_find_sym(glib2, "g_data_input_stream_read_upto_finish");
    stub_funcs.ptr_g_data_output_stream_get_type = try_find_sym(glib2, "g_data_output_stream_get_type");
    stub_funcs.ptr_g_data_output_stream_new = try_find_sym(glib2, "g_data_output_stream_new");
    stub_funcs.ptr_g_data_output_stream_set_byte_order = try_find_sym(glib2, "g_data_output_stream_set_byte_order");
    stub_funcs.ptr_g_data_output_stream_get_byte_order = try_find_sym(glib2, "g_data_output_stream_get_byte_order");
    stub_funcs.ptr_g_data_output_stream_put_byte = try_find_sym(glib2, "g_data_output_stream_put_byte");
    stub_funcs.ptr_g_data_output_stream_put_int16 = try_find_sym(glib2, "g_data_output_stream_put_int16");
    stub_funcs.ptr_g_data_output_stream_put_uint16 = try_find_sym(glib2, "g_data_output_stream_put_uint16");
    stub_funcs.ptr_g_data_output_stream_put_int32 = try_find_sym(glib2, "g_data_output_stream_put_int32");
    stub_funcs.ptr_g_data_output_stream_put_uint32 = try_find_sym(glib2, "g_data_output_stream_put_uint32");
    stub_funcs.ptr_g_data_output_stream_put_int64 = try_find_sym(glib2, "g_data_output_stream_put_int64");
    stub_funcs.ptr_g_data_output_stream_put_uint64 = try_find_sym(glib2, "g_data_output_stream_put_uint64");
    stub_funcs.ptr_g_data_output_stream_put_string = try_find_sym(glib2, "g_data_output_stream_put_string");
    stub_funcs.ptr_g_dbus_action_group_get_type = try_find_sym(glib2, "g_dbus_action_group_get_type");
    stub_funcs.ptr_g_dbus_action_group_get = try_find_sym(glib2, "g_dbus_action_group_get");
    stub_funcs.ptr_g_dbus_address_escape_value = try_find_sym(glib2, "g_dbus_address_escape_value");
    stub_funcs.ptr_g_dbus_is_address = try_find_sym(glib2, "g_dbus_is_address");
    stub_funcs.ptr_g_dbus_is_supported_address = try_find_sym(glib2, "g_dbus_is_supported_address");
    stub_funcs.ptr_g_dbus_address_get_stream = try_find_sym(glib2, "g_dbus_address_get_stream");
    stub_funcs.ptr_g_dbus_address_get_stream_finish = try_find_sym(glib2, "g_dbus_address_get_stream_finish");
    stub_funcs.ptr_g_dbus_address_get_stream_sync = try_find_sym(glib2, "g_dbus_address_get_stream_sync");
    stub_funcs.ptr_g_dbus_address_get_for_bus_sync = try_find_sym(glib2, "g_dbus_address_get_for_bus_sync");
    stub_funcs.ptr_g_dbus_auth_observer_get_type = try_find_sym(glib2, "g_dbus_auth_observer_get_type");
    stub_funcs.ptr_g_dbus_auth_observer_new = try_find_sym(glib2, "g_dbus_auth_observer_new");
    stub_funcs.ptr_g_dbus_auth_observer_authorize_authenticated_peer = try_find_sym(glib2, "g_dbus_auth_observer_authorize_authenticated_peer");
    stub_funcs.ptr_g_dbus_auth_observer_allow_mechanism = try_find_sym(glib2, "g_dbus_auth_observer_allow_mechanism");
    stub_funcs.ptr_g_dbus_connection_get_type = try_find_sym(glib2, "g_dbus_connection_get_type");
    stub_funcs.ptr_g_bus_get = try_find_sym(glib2, "g_bus_get");
    stub_funcs.ptr_g_bus_get_finish = try_find_sym(glib2, "g_bus_get_finish");
    stub_funcs.ptr_g_bus_get_sync = try_find_sym(glib2, "g_bus_get_sync");
    stub_funcs.ptr_g_dbus_connection_new = try_find_sym(glib2, "g_dbus_connection_new");
    stub_funcs.ptr_g_dbus_connection_new_finish = try_find_sym(glib2, "g_dbus_connection_new_finish");
    stub_funcs.ptr_g_dbus_connection_new_sync = try_find_sym(glib2, "g_dbus_connection_new_sync");
    stub_funcs.ptr_g_dbus_connection_new_for_address = try_find_sym(glib2, "g_dbus_connection_new_for_address");
    stub_funcs.ptr_g_dbus_connection_new_for_address_finish = try_find_sym(glib2, "g_dbus_connection_new_for_address_finish");
    stub_funcs.ptr_g_dbus_connection_new_for_address_sync = try_find_sym(glib2, "g_dbus_connection_new_for_address_sync");
    stub_funcs.ptr_g_dbus_connection_start_message_processing = try_find_sym(glib2, "g_dbus_connection_start_message_processing");
    stub_funcs.ptr_g_dbus_connection_is_closed = try_find_sym(glib2, "g_dbus_connection_is_closed");
    stub_funcs.ptr_g_dbus_connection_get_stream = try_find_sym(glib2, "g_dbus_connection_get_stream");
    stub_funcs.ptr_g_dbus_connection_get_guid = try_find_sym(glib2, "g_dbus_connection_get_guid");
    stub_funcs.ptr_g_dbus_connection_get_unique_name = try_find_sym(glib2, "g_dbus_connection_get_unique_name");
    stub_funcs.ptr_g_dbus_connection_get_peer_credentials = try_find_sym(glib2, "g_dbus_connection_get_peer_credentials");
    stub_funcs.ptr_g_dbus_connection_get_last_serial = try_find_sym(glib2, "g_dbus_connection_get_last_serial");
    stub_funcs.ptr_g_dbus_connection_get_exit_on_close = try_find_sym(glib2, "g_dbus_connection_get_exit_on_close");
    stub_funcs.ptr_g_dbus_connection_set_exit_on_close = try_find_sym(glib2, "g_dbus_connection_set_exit_on_close");
    stub_funcs.ptr_g_dbus_connection_get_capabilities = try_find_sym(glib2, "g_dbus_connection_get_capabilities");
    stub_funcs.ptr_g_dbus_connection_get_flags = try_find_sym(glib2, "g_dbus_connection_get_flags");
    stub_funcs.ptr_g_dbus_connection_close = try_find_sym(glib2, "g_dbus_connection_close");
    stub_funcs.ptr_g_dbus_connection_close_finish = try_find_sym(glib2, "g_dbus_connection_close_finish");
    stub_funcs.ptr_g_dbus_connection_close_sync = try_find_sym(glib2, "g_dbus_connection_close_sync");
    stub_funcs.ptr_g_dbus_connection_flush = try_find_sym(glib2, "g_dbus_connection_flush");
    stub_funcs.ptr_g_dbus_connection_flush_finish = try_find_sym(glib2, "g_dbus_connection_flush_finish");
    stub_funcs.ptr_g_dbus_connection_flush_sync = try_find_sym(glib2, "g_dbus_connection_flush_sync");
    stub_funcs.ptr_g_dbus_connection_send_message = try_find_sym(glib2, "g_dbus_connection_send_message");
    stub_funcs.ptr_g_dbus_connection_send_message_with_reply = try_find_sym(glib2, "g_dbus_connection_send_message_with_reply");
    stub_funcs.ptr_g_dbus_connection_send_message_with_reply_finish = try_find_sym(glib2, "g_dbus_connection_send_message_with_reply_finish");
    stub_funcs.ptr_g_dbus_connection_send_message_with_reply_sync = try_find_sym(glib2, "g_dbus_connection_send_message_with_reply_sync");
    stub_funcs.ptr_g_dbus_connection_emit_signal = try_find_sym(glib2, "g_dbus_connection_emit_signal");
    stub_funcs.ptr_g_dbus_connection_call = try_find_sym(glib2, "g_dbus_connection_call");
    stub_funcs.ptr_g_dbus_connection_call_finish = try_find_sym(glib2, "g_dbus_connection_call_finish");
    stub_funcs.ptr_g_dbus_connection_call_sync = try_find_sym(glib2, "g_dbus_connection_call_sync");
    stub_funcs.ptr_g_dbus_connection_call_with_unix_fd_list = try_find_sym(glib2, "g_dbus_connection_call_with_unix_fd_list");
    stub_funcs.ptr_g_dbus_connection_call_with_unix_fd_list_finish = try_find_sym(glib2, "g_dbus_connection_call_with_unix_fd_list_finish");
    stub_funcs.ptr_g_dbus_connection_call_with_unix_fd_list_sync = try_find_sym(glib2, "g_dbus_connection_call_with_unix_fd_list_sync");
    stub_funcs.ptr_g_dbus_connection_register_object = try_find_sym(glib2, "g_dbus_connection_register_object");
    stub_funcs.ptr_g_dbus_connection_register_object_with_closures = try_find_sym(glib2, "g_dbus_connection_register_object_with_closures");
    stub_funcs.ptr_g_dbus_connection_unregister_object = try_find_sym(glib2, "g_dbus_connection_unregister_object");
    stub_funcs.ptr_g_dbus_connection_register_subtree = try_find_sym(glib2, "g_dbus_connection_register_subtree");
    stub_funcs.ptr_g_dbus_connection_unregister_subtree = try_find_sym(glib2, "g_dbus_connection_unregister_subtree");
    stub_funcs.ptr_g_dbus_connection_signal_subscribe = try_find_sym(glib2, "g_dbus_connection_signal_subscribe");
    stub_funcs.ptr_g_dbus_connection_signal_unsubscribe = try_find_sym(glib2, "g_dbus_connection_signal_unsubscribe");
    stub_funcs.ptr_g_dbus_connection_add_filter = try_find_sym(glib2, "g_dbus_connection_add_filter");
    stub_funcs.ptr_g_dbus_connection_remove_filter = try_find_sym(glib2, "g_dbus_connection_remove_filter");
    stub_funcs.ptr_g_dbus_error_quark = try_find_sym(glib2, "g_dbus_error_quark");
    stub_funcs.ptr_g_dbus_error_is_remote_error = try_find_sym(glib2, "g_dbus_error_is_remote_error");
    stub_funcs.ptr_g_dbus_error_get_remote_error = try_find_sym(glib2, "g_dbus_error_get_remote_error");
    stub_funcs.ptr_g_dbus_error_strip_remote_error = try_find_sym(glib2, "g_dbus_error_strip_remote_error");
    stub_funcs.ptr_g_dbus_error_register_error = try_find_sym(glib2, "g_dbus_error_register_error");
    stub_funcs.ptr_g_dbus_error_unregister_error = try_find_sym(glib2, "g_dbus_error_unregister_error");
    stub_funcs.ptr_g_dbus_error_register_error_domain = try_find_sym(glib2, "g_dbus_error_register_error_domain");
    stub_funcs.ptr_g_dbus_error_new_for_dbus_error = try_find_sym(glib2, "g_dbus_error_new_for_dbus_error");
    stub_funcs.ptr_g_dbus_error_set_dbus_error = try_find_sym(glib2, "g_dbus_error_set_dbus_error");
    stub_funcs.ptr_g_dbus_error_set_dbus_error_valist = try_find_sym(glib2, "g_dbus_error_set_dbus_error_valist");
    stub_funcs.ptr_g_dbus_error_encode_gerror = try_find_sym(glib2, "g_dbus_error_encode_gerror");
    stub_funcs.ptr_g_dbus_interface_get_type = try_find_sym(glib2, "g_dbus_interface_get_type");
    stub_funcs.ptr_g_dbus_interface_get_info = try_find_sym(glib2, "g_dbus_interface_get_info");
    stub_funcs.ptr_g_dbus_interface_get_object = try_find_sym(glib2, "g_dbus_interface_get_object");
    stub_funcs.ptr_g_dbus_interface_set_object = try_find_sym(glib2, "g_dbus_interface_set_object");
    stub_funcs.ptr_g_dbus_interface_dup_object = try_find_sym(glib2, "g_dbus_interface_dup_object");
    stub_funcs.ptr_g_dbus_interface_skeleton_get_type = try_find_sym(glib2, "g_dbus_interface_skeleton_get_type");
    stub_funcs.ptr_g_dbus_interface_skeleton_get_flags = try_find_sym(glib2, "g_dbus_interface_skeleton_get_flags");
    stub_funcs.ptr_g_dbus_interface_skeleton_set_flags = try_find_sym(glib2, "g_dbus_interface_skeleton_set_flags");
    stub_funcs.ptr_g_dbus_interface_skeleton_get_info = try_find_sym(glib2, "g_dbus_interface_skeleton_get_info");
    stub_funcs.ptr_g_dbus_interface_skeleton_get_vtable = try_find_sym(glib2, "g_dbus_interface_skeleton_get_vtable");
    stub_funcs.ptr_g_dbus_interface_skeleton_get_properties = try_find_sym(glib2, "g_dbus_interface_skeleton_get_properties");
    stub_funcs.ptr_g_dbus_interface_skeleton_flush = try_find_sym(glib2, "g_dbus_interface_skeleton_flush");
    stub_funcs.ptr_g_dbus_interface_skeleton_export = try_find_sym(glib2, "g_dbus_interface_skeleton_export");
    stub_funcs.ptr_g_dbus_interface_skeleton_unexport = try_find_sym(glib2, "g_dbus_interface_skeleton_unexport");
    stub_funcs.ptr_g_dbus_interface_skeleton_unexport_from_connection = try_find_sym(glib2, "g_dbus_interface_skeleton_unexport_from_connection");
    stub_funcs.ptr_g_dbus_interface_skeleton_get_connection = try_find_sym(glib2, "g_dbus_interface_skeleton_get_connection");
    stub_funcs.ptr_g_dbus_interface_skeleton_get_connections = try_find_sym(glib2, "g_dbus_interface_skeleton_get_connections");
    stub_funcs.ptr_g_dbus_interface_skeleton_has_connection = try_find_sym(glib2, "g_dbus_interface_skeleton_has_connection");
    stub_funcs.ptr_g_dbus_interface_skeleton_get_object_path = try_find_sym(glib2, "g_dbus_interface_skeleton_get_object_path");
    stub_funcs.ptr_g_dbus_annotation_info_lookup = try_find_sym(glib2, "g_dbus_annotation_info_lookup");
    stub_funcs.ptr_g_dbus_interface_info_lookup_method = try_find_sym(glib2, "g_dbus_interface_info_lookup_method");
    stub_funcs.ptr_g_dbus_interface_info_lookup_signal = try_find_sym(glib2, "g_dbus_interface_info_lookup_signal");
    stub_funcs.ptr_g_dbus_interface_info_lookup_property = try_find_sym(glib2, "g_dbus_interface_info_lookup_property");
    stub_funcs.ptr_g_dbus_interface_info_cache_build = try_find_sym(glib2, "g_dbus_interface_info_cache_build");
    stub_funcs.ptr_g_dbus_interface_info_cache_release = try_find_sym(glib2, "g_dbus_interface_info_cache_release");
    stub_funcs.ptr_g_dbus_interface_info_generate_xml = try_find_sym(glib2, "g_dbus_interface_info_generate_xml");
    stub_funcs.ptr_g_dbus_node_info_new_for_xml = try_find_sym(glib2, "g_dbus_node_info_new_for_xml");
    stub_funcs.ptr_g_dbus_node_info_lookup_interface = try_find_sym(glib2, "g_dbus_node_info_lookup_interface");
    stub_funcs.ptr_g_dbus_node_info_generate_xml = try_find_sym(glib2, "g_dbus_node_info_generate_xml");
    stub_funcs.ptr_g_dbus_node_info_ref = try_find_sym(glib2, "g_dbus_node_info_ref");
    stub_funcs.ptr_g_dbus_interface_info_ref = try_find_sym(glib2, "g_dbus_interface_info_ref");
    stub_funcs.ptr_g_dbus_method_info_ref = try_find_sym(glib2, "g_dbus_method_info_ref");
    stub_funcs.ptr_g_dbus_signal_info_ref = try_find_sym(glib2, "g_dbus_signal_info_ref");
    stub_funcs.ptr_g_dbus_property_info_ref = try_find_sym(glib2, "g_dbus_property_info_ref");
    stub_funcs.ptr_g_dbus_arg_info_ref = try_find_sym(glib2, "g_dbus_arg_info_ref");
    stub_funcs.ptr_g_dbus_annotation_info_ref = try_find_sym(glib2, "g_dbus_annotation_info_ref");
    stub_funcs.ptr_g_dbus_node_info_unref = try_find_sym(glib2, "g_dbus_node_info_unref");
    stub_funcs.ptr_g_dbus_interface_info_unref = try_find_sym(glib2, "g_dbus_interface_info_unref");
    stub_funcs.ptr_g_dbus_method_info_unref = try_find_sym(glib2, "g_dbus_method_info_unref");
    stub_funcs.ptr_g_dbus_signal_info_unref = try_find_sym(glib2, "g_dbus_signal_info_unref");
    stub_funcs.ptr_g_dbus_property_info_unref = try_find_sym(glib2, "g_dbus_property_info_unref");
    stub_funcs.ptr_g_dbus_arg_info_unref = try_find_sym(glib2, "g_dbus_arg_info_unref");
    stub_funcs.ptr_g_dbus_annotation_info_unref = try_find_sym(glib2, "g_dbus_annotation_info_unref");
    stub_funcs.ptr_g_dbus_node_info_get_type = try_find_sym(glib2, "g_dbus_node_info_get_type");
    stub_funcs.ptr_g_dbus_interface_info_get_type = try_find_sym(glib2, "g_dbus_interface_info_get_type");
    stub_funcs.ptr_g_dbus_method_info_get_type = try_find_sym(glib2, "g_dbus_method_info_get_type");
    stub_funcs.ptr_g_dbus_signal_info_get_type = try_find_sym(glib2, "g_dbus_signal_info_get_type");
    stub_funcs.ptr_g_dbus_property_info_get_type = try_find_sym(glib2, "g_dbus_property_info_get_type");
    stub_funcs.ptr_g_dbus_arg_info_get_type = try_find_sym(glib2, "g_dbus_arg_info_get_type");
    stub_funcs.ptr_g_dbus_annotation_info_get_type = try_find_sym(glib2, "g_dbus_annotation_info_get_type");
    stub_funcs.ptr_g_dbus_menu_model_get_type = try_find_sym(glib2, "g_dbus_menu_model_get_type");
    stub_funcs.ptr_g_dbus_menu_model_get = try_find_sym(glib2, "g_dbus_menu_model_get");
    stub_funcs.ptr_g_dbus_message_get_type = try_find_sym(glib2, "g_dbus_message_get_type");
    stub_funcs.ptr_g_dbus_message_new = try_find_sym(glib2, "g_dbus_message_new");
    stub_funcs.ptr_g_dbus_message_new_signal = try_find_sym(glib2, "g_dbus_message_new_signal");
    stub_funcs.ptr_g_dbus_message_new_method_call = try_find_sym(glib2, "g_dbus_message_new_method_call");
    stub_funcs.ptr_g_dbus_message_new_method_reply = try_find_sym(glib2, "g_dbus_message_new_method_reply");
    stub_funcs.ptr_g_dbus_message_new_method_error = try_find_sym(glib2, "g_dbus_message_new_method_error");
    stub_funcs.ptr_g_dbus_message_new_method_error_valist = try_find_sym(glib2, "g_dbus_message_new_method_error_valist");
    stub_funcs.ptr_g_dbus_message_new_method_error_literal = try_find_sym(glib2, "g_dbus_message_new_method_error_literal");
    stub_funcs.ptr_g_dbus_message_print = try_find_sym(glib2, "g_dbus_message_print");
    stub_funcs.ptr_g_dbus_message_get_locked = try_find_sym(glib2, "g_dbus_message_get_locked");
    stub_funcs.ptr_g_dbus_message_lock = try_find_sym(glib2, "g_dbus_message_lock");
    stub_funcs.ptr_g_dbus_message_copy = try_find_sym(glib2, "g_dbus_message_copy");
    stub_funcs.ptr_g_dbus_message_get_byte_order = try_find_sym(glib2, "g_dbus_message_get_byte_order");
    stub_funcs.ptr_g_dbus_message_set_byte_order = try_find_sym(glib2, "g_dbus_message_set_byte_order");
    stub_funcs.ptr_g_dbus_message_get_message_type = try_find_sym(glib2, "g_dbus_message_get_message_type");
    stub_funcs.ptr_g_dbus_message_set_message_type = try_find_sym(glib2, "g_dbus_message_set_message_type");
    stub_funcs.ptr_g_dbus_message_get_flags = try_find_sym(glib2, "g_dbus_message_get_flags");
    stub_funcs.ptr_g_dbus_message_set_flags = try_find_sym(glib2, "g_dbus_message_set_flags");
    stub_funcs.ptr_g_dbus_message_get_serial = try_find_sym(glib2, "g_dbus_message_get_serial");
    stub_funcs.ptr_g_dbus_message_set_serial = try_find_sym(glib2, "g_dbus_message_set_serial");
    stub_funcs.ptr_g_dbus_message_get_header = try_find_sym(glib2, "g_dbus_message_get_header");
    stub_funcs.ptr_g_dbus_message_set_header = try_find_sym(glib2, "g_dbus_message_set_header");
    stub_funcs.ptr_g_dbus_message_get_header_fields = try_find_sym(glib2, "g_dbus_message_get_header_fields");
    stub_funcs.ptr_g_dbus_message_get_body = try_find_sym(glib2, "g_dbus_message_get_body");
    stub_funcs.ptr_g_dbus_message_set_body = try_find_sym(glib2, "g_dbus_message_set_body");
    stub_funcs.ptr_g_dbus_message_get_unix_fd_list = try_find_sym(glib2, "g_dbus_message_get_unix_fd_list");
    stub_funcs.ptr_g_dbus_message_set_unix_fd_list = try_find_sym(glib2, "g_dbus_message_set_unix_fd_list");
    stub_funcs.ptr_g_dbus_message_get_reply_serial = try_find_sym(glib2, "g_dbus_message_get_reply_serial");
    stub_funcs.ptr_g_dbus_message_set_reply_serial = try_find_sym(glib2, "g_dbus_message_set_reply_serial");
    stub_funcs.ptr_g_dbus_message_get_interface = try_find_sym(glib2, "g_dbus_message_get_interface");
    stub_funcs.ptr_g_dbus_message_set_interface = try_find_sym(glib2, "g_dbus_message_set_interface");
    stub_funcs.ptr_g_dbus_message_get_member = try_find_sym(glib2, "g_dbus_message_get_member");
    stub_funcs.ptr_g_dbus_message_set_member = try_find_sym(glib2, "g_dbus_message_set_member");
    stub_funcs.ptr_g_dbus_message_get_path = try_find_sym(glib2, "g_dbus_message_get_path");
    stub_funcs.ptr_g_dbus_message_set_path = try_find_sym(glib2, "g_dbus_message_set_path");
    stub_funcs.ptr_g_dbus_message_get_sender = try_find_sym(glib2, "g_dbus_message_get_sender");
    stub_funcs.ptr_g_dbus_message_set_sender = try_find_sym(glib2, "g_dbus_message_set_sender");
    stub_funcs.ptr_g_dbus_message_get_destination = try_find_sym(glib2, "g_dbus_message_get_destination");
    stub_funcs.ptr_g_dbus_message_set_destination = try_find_sym(glib2, "g_dbus_message_set_destination");
    stub_funcs.ptr_g_dbus_message_get_error_name = try_find_sym(glib2, "g_dbus_message_get_error_name");
    stub_funcs.ptr_g_dbus_message_set_error_name = try_find_sym(glib2, "g_dbus_message_set_error_name");
    stub_funcs.ptr_g_dbus_message_get_signature = try_find_sym(glib2, "g_dbus_message_get_signature");
    stub_funcs.ptr_g_dbus_message_set_signature = try_find_sym(glib2, "g_dbus_message_set_signature");
    stub_funcs.ptr_g_dbus_message_get_num_unix_fds = try_find_sym(glib2, "g_dbus_message_get_num_unix_fds");
    stub_funcs.ptr_g_dbus_message_set_num_unix_fds = try_find_sym(glib2, "g_dbus_message_set_num_unix_fds");
    stub_funcs.ptr_g_dbus_message_get_arg0 = try_find_sym(glib2, "g_dbus_message_get_arg0");
    stub_funcs.ptr_g_dbus_message_get_arg0_path = try_find_sym(glib2, "g_dbus_message_get_arg0_path");
    stub_funcs.ptr_g_dbus_message_new_from_blob = try_find_sym(glib2, "g_dbus_message_new_from_blob");
    stub_funcs.ptr_g_dbus_message_bytes_needed = try_find_sym(glib2, "g_dbus_message_bytes_needed");
    stub_funcs.ptr_g_dbus_message_to_blob = try_find_sym(glib2, "g_dbus_message_to_blob");
    stub_funcs.ptr_g_dbus_message_to_gerror = try_find_sym(glib2, "g_dbus_message_to_gerror");
    stub_funcs.ptr_g_dbus_method_invocation_get_type = try_find_sym(glib2, "g_dbus_method_invocation_get_type");
    stub_funcs.ptr_g_dbus_method_invocation_get_sender = try_find_sym(glib2, "g_dbus_method_invocation_get_sender");
    stub_funcs.ptr_g_dbus_method_invocation_get_object_path = try_find_sym(glib2, "g_dbus_method_invocation_get_object_path");
    stub_funcs.ptr_g_dbus_method_invocation_get_interface_name = try_find_sym(glib2, "g_dbus_method_invocation_get_interface_name");
    stub_funcs.ptr_g_dbus_method_invocation_get_method_name = try_find_sym(glib2, "g_dbus_method_invocation_get_method_name");
    stub_funcs.ptr_g_dbus_method_invocation_get_method_info = try_find_sym(glib2, "g_dbus_method_invocation_get_method_info");
    stub_funcs.ptr_g_dbus_method_invocation_get_property_info = try_find_sym(glib2, "g_dbus_method_invocation_get_property_info");
    stub_funcs.ptr_g_dbus_method_invocation_get_connection = try_find_sym(glib2, "g_dbus_method_invocation_get_connection");
    stub_funcs.ptr_g_dbus_method_invocation_get_message = try_find_sym(glib2, "g_dbus_method_invocation_get_message");
    stub_funcs.ptr_g_dbus_method_invocation_get_parameters = try_find_sym(glib2, "g_dbus_method_invocation_get_parameters");
    stub_funcs.ptr_g_dbus_method_invocation_get_user_data = try_find_sym(glib2, "g_dbus_method_invocation_get_user_data");
    stub_funcs.ptr_g_dbus_method_invocation_return_value = try_find_sym(glib2, "g_dbus_method_invocation_return_value");
    stub_funcs.ptr_g_dbus_method_invocation_return_value_with_unix_fd_list = try_find_sym(glib2, "g_dbus_method_invocation_return_value_with_unix_fd_list");
    stub_funcs.ptr_g_dbus_method_invocation_return_error = try_find_sym(glib2, "g_dbus_method_invocation_return_error");
    stub_funcs.ptr_g_dbus_method_invocation_return_error_valist = try_find_sym(glib2, "g_dbus_method_invocation_return_error_valist");
    stub_funcs.ptr_g_dbus_method_invocation_return_error_literal = try_find_sym(glib2, "g_dbus_method_invocation_return_error_literal");
    stub_funcs.ptr_g_dbus_method_invocation_return_gerror = try_find_sym(glib2, "g_dbus_method_invocation_return_gerror");
    stub_funcs.ptr_g_dbus_method_invocation_take_error = try_find_sym(glib2, "g_dbus_method_invocation_take_error");
    stub_funcs.ptr_g_dbus_method_invocation_return_dbus_error = try_find_sym(glib2, "g_dbus_method_invocation_return_dbus_error");
    stub_funcs.ptr_g_bus_own_name = try_find_sym(glib2, "g_bus_own_name");
    stub_funcs.ptr_g_bus_own_name_on_connection = try_find_sym(glib2, "g_bus_own_name_on_connection");
    stub_funcs.ptr_g_bus_own_name_with_closures = try_find_sym(glib2, "g_bus_own_name_with_closures");
    stub_funcs.ptr_g_bus_own_name_on_connection_with_closures = try_find_sym(glib2, "g_bus_own_name_on_connection_with_closures");
    stub_funcs.ptr_g_bus_unown_name = try_find_sym(glib2, "g_bus_unown_name");
    stub_funcs.ptr_g_bus_watch_name = try_find_sym(glib2, "g_bus_watch_name");
    stub_funcs.ptr_g_bus_watch_name_on_connection = try_find_sym(glib2, "g_bus_watch_name_on_connection");
    stub_funcs.ptr_g_bus_watch_name_with_closures = try_find_sym(glib2, "g_bus_watch_name_with_closures");
    stub_funcs.ptr_g_bus_watch_name_on_connection_with_closures = try_find_sym(glib2, "g_bus_watch_name_on_connection_with_closures");
    stub_funcs.ptr_g_bus_unwatch_name = try_find_sym(glib2, "g_bus_unwatch_name");
    stub_funcs.ptr_g_dbus_object_get_type = try_find_sym(glib2, "g_dbus_object_get_type");
    stub_funcs.ptr_g_dbus_object_get_object_path = try_find_sym(glib2, "g_dbus_object_get_object_path");
    stub_funcs.ptr_g_dbus_object_get_interfaces = try_find_sym(glib2, "g_dbus_object_get_interfaces");
    stub_funcs.ptr_g_dbus_object_get_interface = try_find_sym(glib2, "g_dbus_object_get_interface");
    stub_funcs.ptr_g_dbus_object_manager_get_type = try_find_sym(glib2, "g_dbus_object_manager_get_type");
    stub_funcs.ptr_g_dbus_object_manager_get_object_path = try_find_sym(glib2, "g_dbus_object_manager_get_object_path");
    stub_funcs.ptr_g_dbus_object_manager_get_objects = try_find_sym(glib2, "g_dbus_object_manager_get_objects");
    stub_funcs.ptr_g_dbus_object_manager_get_object = try_find_sym(glib2, "g_dbus_object_manager_get_object");
    stub_funcs.ptr_g_dbus_object_manager_get_interface = try_find_sym(glib2, "g_dbus_object_manager_get_interface");
    stub_funcs.ptr_g_dbus_object_manager_client_get_type = try_find_sym(glib2, "g_dbus_object_manager_client_get_type");
    stub_funcs.ptr_g_dbus_object_manager_client_new = try_find_sym(glib2, "g_dbus_object_manager_client_new");
    stub_funcs.ptr_g_dbus_object_manager_client_new_finish = try_find_sym(glib2, "g_dbus_object_manager_client_new_finish");
    stub_funcs.ptr_g_dbus_object_manager_client_new_sync = try_find_sym(glib2, "g_dbus_object_manager_client_new_sync");
    stub_funcs.ptr_g_dbus_object_manager_client_new_for_bus = try_find_sym(glib2, "g_dbus_object_manager_client_new_for_bus");
    stub_funcs.ptr_g_dbus_object_manager_client_new_for_bus_finish = try_find_sym(glib2, "g_dbus_object_manager_client_new_for_bus_finish");
    stub_funcs.ptr_g_dbus_object_manager_client_new_for_bus_sync = try_find_sym(glib2, "g_dbus_object_manager_client_new_for_bus_sync");
    stub_funcs.ptr_g_dbus_object_manager_client_get_connection = try_find_sym(glib2, "g_dbus_object_manager_client_get_connection");
    stub_funcs.ptr_g_dbus_object_manager_client_get_flags = try_find_sym(glib2, "g_dbus_object_manager_client_get_flags");
    stub_funcs.ptr_g_dbus_object_manager_client_get_name = try_find_sym(glib2, "g_dbus_object_manager_client_get_name");
    stub_funcs.ptr_g_dbus_object_manager_client_get_name_owner = try_find_sym(glib2, "g_dbus_object_manager_client_get_name_owner");
    stub_funcs.ptr_g_dbus_object_manager_server_get_type = try_find_sym(glib2, "g_dbus_object_manager_server_get_type");
    stub_funcs.ptr_g_dbus_object_manager_server_new = try_find_sym(glib2, "g_dbus_object_manager_server_new");
    stub_funcs.ptr_g_dbus_object_manager_server_get_connection = try_find_sym(glib2, "g_dbus_object_manager_server_get_connection");
    stub_funcs.ptr_g_dbus_object_manager_server_set_connection = try_find_sym(glib2, "g_dbus_object_manager_server_set_connection");
    stub_funcs.ptr_g_dbus_object_manager_server_export = try_find_sym(glib2, "g_dbus_object_manager_server_export");
    stub_funcs.ptr_g_dbus_object_manager_server_export_uniquely = try_find_sym(glib2, "g_dbus_object_manager_server_export_uniquely");
    stub_funcs.ptr_g_dbus_object_manager_server_is_exported = try_find_sym(glib2, "g_dbus_object_manager_server_is_exported");
    stub_funcs.ptr_g_dbus_object_manager_server_unexport = try_find_sym(glib2, "g_dbus_object_manager_server_unexport");
    stub_funcs.ptr_g_dbus_object_proxy_get_type = try_find_sym(glib2, "g_dbus_object_proxy_get_type");
    stub_funcs.ptr_g_dbus_object_proxy_new = try_find_sym(glib2, "g_dbus_object_proxy_new");
    stub_funcs.ptr_g_dbus_object_proxy_get_connection = try_find_sym(glib2, "g_dbus_object_proxy_get_connection");
    stub_funcs.ptr_g_dbus_object_skeleton_get_type = try_find_sym(glib2, "g_dbus_object_skeleton_get_type");
    stub_funcs.ptr_g_dbus_object_skeleton_new = try_find_sym(glib2, "g_dbus_object_skeleton_new");
    stub_funcs.ptr_g_dbus_object_skeleton_flush = try_find_sym(glib2, "g_dbus_object_skeleton_flush");
    stub_funcs.ptr_g_dbus_object_skeleton_add_interface = try_find_sym(glib2, "g_dbus_object_skeleton_add_interface");
    stub_funcs.ptr_g_dbus_object_skeleton_remove_interface = try_find_sym(glib2, "g_dbus_object_skeleton_remove_interface");
    stub_funcs.ptr_g_dbus_object_skeleton_remove_interface_by_name = try_find_sym(glib2, "g_dbus_object_skeleton_remove_interface_by_name");
    stub_funcs.ptr_g_dbus_object_skeleton_set_object_path = try_find_sym(glib2, "g_dbus_object_skeleton_set_object_path");
    stub_funcs.ptr_g_dbus_proxy_get_type = try_find_sym(glib2, "g_dbus_proxy_get_type");
    stub_funcs.ptr_g_dbus_proxy_new = try_find_sym(glib2, "g_dbus_proxy_new");
    stub_funcs.ptr_g_dbus_proxy_new_finish = try_find_sym(glib2, "g_dbus_proxy_new_finish");
    stub_funcs.ptr_g_dbus_proxy_new_sync = try_find_sym(glib2, "g_dbus_proxy_new_sync");
    stub_funcs.ptr_g_dbus_proxy_new_for_bus = try_find_sym(glib2, "g_dbus_proxy_new_for_bus");
    stub_funcs.ptr_g_dbus_proxy_new_for_bus_finish = try_find_sym(glib2, "g_dbus_proxy_new_for_bus_finish");
    stub_funcs.ptr_g_dbus_proxy_new_for_bus_sync = try_find_sym(glib2, "g_dbus_proxy_new_for_bus_sync");
    stub_funcs.ptr_g_dbus_proxy_get_connection = try_find_sym(glib2, "g_dbus_proxy_get_connection");
    stub_funcs.ptr_g_dbus_proxy_get_flags = try_find_sym(glib2, "g_dbus_proxy_get_flags");
    stub_funcs.ptr_g_dbus_proxy_get_name = try_find_sym(glib2, "g_dbus_proxy_get_name");
    stub_funcs.ptr_g_dbus_proxy_get_name_owner = try_find_sym(glib2, "g_dbus_proxy_get_name_owner");
    stub_funcs.ptr_g_dbus_proxy_get_object_path = try_find_sym(glib2, "g_dbus_proxy_get_object_path");
    stub_funcs.ptr_g_dbus_proxy_get_interface_name = try_find_sym(glib2, "g_dbus_proxy_get_interface_name");
    stub_funcs.ptr_g_dbus_proxy_get_default_timeout = try_find_sym(glib2, "g_dbus_proxy_get_default_timeout");
    stub_funcs.ptr_g_dbus_proxy_set_default_timeout = try_find_sym(glib2, "g_dbus_proxy_set_default_timeout");
    stub_funcs.ptr_g_dbus_proxy_get_interface_info = try_find_sym(glib2, "g_dbus_proxy_get_interface_info");
    stub_funcs.ptr_g_dbus_proxy_set_interface_info = try_find_sym(glib2, "g_dbus_proxy_set_interface_info");
    stub_funcs.ptr_g_dbus_proxy_get_cached_property = try_find_sym(glib2, "g_dbus_proxy_get_cached_property");
    stub_funcs.ptr_g_dbus_proxy_set_cached_property = try_find_sym(glib2, "g_dbus_proxy_set_cached_property");
    stub_funcs.ptr_g_dbus_proxy_get_cached_property_names = try_find_sym(glib2, "g_dbus_proxy_get_cached_property_names");
    stub_funcs.ptr_g_dbus_proxy_call = try_find_sym(glib2, "g_dbus_proxy_call");
    stub_funcs.ptr_g_dbus_proxy_call_finish = try_find_sym(glib2, "g_dbus_proxy_call_finish");
    stub_funcs.ptr_g_dbus_proxy_call_sync = try_find_sym(glib2, "g_dbus_proxy_call_sync");
    stub_funcs.ptr_g_dbus_proxy_call_with_unix_fd_list = try_find_sym(glib2, "g_dbus_proxy_call_with_unix_fd_list");
    stub_funcs.ptr_g_dbus_proxy_call_with_unix_fd_list_finish = try_find_sym(glib2, "g_dbus_proxy_call_with_unix_fd_list_finish");
    stub_funcs.ptr_g_dbus_proxy_call_with_unix_fd_list_sync = try_find_sym(glib2, "g_dbus_proxy_call_with_unix_fd_list_sync");
    stub_funcs.ptr_g_dbus_server_get_type = try_find_sym(glib2, "g_dbus_server_get_type");
    stub_funcs.ptr_g_dbus_server_new_sync = try_find_sym(glib2, "g_dbus_server_new_sync");
    stub_funcs.ptr_g_dbus_server_get_client_address = try_find_sym(glib2, "g_dbus_server_get_client_address");
    stub_funcs.ptr_g_dbus_server_get_guid = try_find_sym(glib2, "g_dbus_server_get_guid");
    stub_funcs.ptr_g_dbus_server_get_flags = try_find_sym(glib2, "g_dbus_server_get_flags");
    stub_funcs.ptr_g_dbus_server_start = try_find_sym(glib2, "g_dbus_server_start");
    stub_funcs.ptr_g_dbus_server_stop = try_find_sym(glib2, "g_dbus_server_stop");
    stub_funcs.ptr_g_dbus_server_is_active = try_find_sym(glib2, "g_dbus_server_is_active");
    stub_funcs.ptr_g_dbus_is_guid = try_find_sym(glib2, "g_dbus_is_guid");
    stub_funcs.ptr_g_dbus_generate_guid = try_find_sym(glib2, "g_dbus_generate_guid");
    stub_funcs.ptr_g_dbus_is_name = try_find_sym(glib2, "g_dbus_is_name");
    stub_funcs.ptr_g_dbus_is_unique_name = try_find_sym(glib2, "g_dbus_is_unique_name");
    stub_funcs.ptr_g_dbus_is_member_name = try_find_sym(glib2, "g_dbus_is_member_name");
    stub_funcs.ptr_g_dbus_is_interface_name = try_find_sym(glib2, "g_dbus_is_interface_name");
    stub_funcs.ptr_g_dbus_is_error_name = try_find_sym(glib2, "g_dbus_is_error_name");
    stub_funcs.ptr_g_dbus_gvariant_to_gvalue = try_find_sym(glib2, "g_dbus_gvariant_to_gvalue");
    stub_funcs.ptr_g_dbus_gvalue_to_gvariant = try_find_sym(glib2, "g_dbus_gvalue_to_gvariant");
    stub_funcs.ptr_g_dbus_escape_object_path_bytestring = try_find_sym(glib2, "g_dbus_escape_object_path_bytestring");
    stub_funcs.ptr_g_dbus_escape_object_path = try_find_sym(glib2, "g_dbus_escape_object_path");
    stub_funcs.ptr_g_dbus_unescape_object_path = try_find_sym(glib2, "g_dbus_unescape_object_path");
    stub_funcs.ptr_g_debug_controller_get_type = try_find_sym(glib2, "g_debug_controller_get_type");
    stub_funcs.ptr_g_debug_controller_get_debug_enabled = try_find_sym(glib2, "g_debug_controller_get_debug_enabled");
    stub_funcs.ptr_g_debug_controller_set_debug_enabled = try_find_sym(glib2, "g_debug_controller_set_debug_enabled");
    stub_funcs.ptr_g_debug_controller_dbus_get_type = try_find_sym(glib2, "g_debug_controller_dbus_get_type");
    stub_funcs.ptr_g_debug_controller_dbus_new = try_find_sym(glib2, "g_debug_controller_dbus_new");
    stub_funcs.ptr_g_debug_controller_dbus_stop = try_find_sym(glib2, "g_debug_controller_dbus_stop");
    stub_funcs.ptr_g_drive_get_type = try_find_sym(glib2, "g_drive_get_type");
    stub_funcs.ptr_g_drive_get_name = try_find_sym(glib2, "g_drive_get_name");
    stub_funcs.ptr_g_drive_get_icon = try_find_sym(glib2, "g_drive_get_icon");
    stub_funcs.ptr_g_drive_get_symbolic_icon = try_find_sym(glib2, "g_drive_get_symbolic_icon");
    stub_funcs.ptr_g_drive_has_volumes = try_find_sym(glib2, "g_drive_has_volumes");
    stub_funcs.ptr_g_drive_get_volumes = try_find_sym(glib2, "g_drive_get_volumes");
    stub_funcs.ptr_g_drive_is_removable = try_find_sym(glib2, "g_drive_is_removable");
    stub_funcs.ptr_g_drive_is_media_removable = try_find_sym(glib2, "g_drive_is_media_removable");
    stub_funcs.ptr_g_drive_has_media = try_find_sym(glib2, "g_drive_has_media");
    stub_funcs.ptr_g_drive_is_media_check_automatic = try_find_sym(glib2, "g_drive_is_media_check_automatic");
    stub_funcs.ptr_g_drive_can_poll_for_media = try_find_sym(glib2, "g_drive_can_poll_for_media");
    stub_funcs.ptr_g_drive_can_eject = try_find_sym(glib2, "g_drive_can_eject");
    stub_funcs.ptr_g_drive_eject = try_find_sym(glib2, "g_drive_eject");
    stub_funcs.ptr_g_drive_eject_finish = try_find_sym(glib2, "g_drive_eject_finish");
    stub_funcs.ptr_g_drive_poll_for_media = try_find_sym(glib2, "g_drive_poll_for_media");
    stub_funcs.ptr_g_drive_poll_for_media_finish = try_find_sym(glib2, "g_drive_poll_for_media_finish");
    stub_funcs.ptr_g_drive_get_identifier = try_find_sym(glib2, "g_drive_get_identifier");
    stub_funcs.ptr_g_drive_enumerate_identifiers = try_find_sym(glib2, "g_drive_enumerate_identifiers");
    stub_funcs.ptr_g_drive_get_start_stop_type = try_find_sym(glib2, "g_drive_get_start_stop_type");
    stub_funcs.ptr_g_drive_can_start = try_find_sym(glib2, "g_drive_can_start");
    stub_funcs.ptr_g_drive_can_start_degraded = try_find_sym(glib2, "g_drive_can_start_degraded");
    stub_funcs.ptr_g_drive_start = try_find_sym(glib2, "g_drive_start");
    stub_funcs.ptr_g_drive_start_finish = try_find_sym(glib2, "g_drive_start_finish");
    stub_funcs.ptr_g_drive_can_stop = try_find_sym(glib2, "g_drive_can_stop");
    stub_funcs.ptr_g_drive_stop = try_find_sym(glib2, "g_drive_stop");
    stub_funcs.ptr_g_drive_stop_finish = try_find_sym(glib2, "g_drive_stop_finish");
    stub_funcs.ptr_g_drive_eject_with_operation = try_find_sym(glib2, "g_drive_eject_with_operation");
    stub_funcs.ptr_g_drive_eject_with_operation_finish = try_find_sym(glib2, "g_drive_eject_with_operation_finish");
    stub_funcs.ptr_g_drive_get_sort_key = try_find_sym(glib2, "g_drive_get_sort_key");
    stub_funcs.ptr_g_dtls_connection_get_type = try_find_sym(glib2, "g_dtls_connection_get_type");
    stub_funcs.ptr_g_dtls_connection_set_database = try_find_sym(glib2, "g_dtls_connection_set_database");
    stub_funcs.ptr_g_dtls_connection_get_database = try_find_sym(glib2, "g_dtls_connection_get_database");
    stub_funcs.ptr_g_dtls_connection_set_certificate = try_find_sym(glib2, "g_dtls_connection_set_certificate");
    stub_funcs.ptr_g_dtls_connection_get_certificate = try_find_sym(glib2, "g_dtls_connection_get_certificate");
    stub_funcs.ptr_g_dtls_connection_set_interaction = try_find_sym(glib2, "g_dtls_connection_set_interaction");
    stub_funcs.ptr_g_dtls_connection_get_interaction = try_find_sym(glib2, "g_dtls_connection_get_interaction");
    stub_funcs.ptr_g_dtls_connection_get_peer_certificate = try_find_sym(glib2, "g_dtls_connection_get_peer_certificate");
    stub_funcs.ptr_g_dtls_connection_get_peer_certificate_errors = try_find_sym(glib2, "g_dtls_connection_get_peer_certificate_errors");
    stub_funcs.ptr_g_dtls_connection_set_require_close_notify = try_find_sym(glib2, "g_dtls_connection_set_require_close_notify");
    stub_funcs.ptr_g_dtls_connection_get_require_close_notify = try_find_sym(glib2, "g_dtls_connection_get_require_close_notify");
    stub_funcs.ptr_g_dtls_connection_set_rehandshake_mode = try_find_sym(glib2, "g_dtls_connection_set_rehandshake_mode");
    stub_funcs.ptr_g_dtls_connection_get_rehandshake_mode = try_find_sym(glib2, "g_dtls_connection_get_rehandshake_mode");
    stub_funcs.ptr_g_dtls_connection_handshake = try_find_sym(glib2, "g_dtls_connection_handshake");
    stub_funcs.ptr_g_dtls_connection_handshake_async = try_find_sym(glib2, "g_dtls_connection_handshake_async");
    stub_funcs.ptr_g_dtls_connection_handshake_finish = try_find_sym(glib2, "g_dtls_connection_handshake_finish");
    stub_funcs.ptr_g_dtls_connection_shutdown = try_find_sym(glib2, "g_dtls_connection_shutdown");
    stub_funcs.ptr_g_dtls_connection_shutdown_async = try_find_sym(glib2, "g_dtls_connection_shutdown_async");
    stub_funcs.ptr_g_dtls_connection_shutdown_finish = try_find_sym(glib2, "g_dtls_connection_shutdown_finish");
    stub_funcs.ptr_g_dtls_connection_close = try_find_sym(glib2, "g_dtls_connection_close");
    stub_funcs.ptr_g_dtls_connection_close_async = try_find_sym(glib2, "g_dtls_connection_close_async");
    stub_funcs.ptr_g_dtls_connection_close_finish = try_find_sym(glib2, "g_dtls_connection_close_finish");
    stub_funcs.ptr_g_dtls_connection_emit_accept_certificate = try_find_sym(glib2, "g_dtls_connection_emit_accept_certificate");
    stub_funcs.ptr_g_dtls_connection_set_advertised_protocols = try_find_sym(glib2, "g_dtls_connection_set_advertised_protocols");
    stub_funcs.ptr_g_dtls_connection_get_negotiated_protocol = try_find_sym(glib2, "g_dtls_connection_get_negotiated_protocol");
    stub_funcs.ptr_g_dtls_connection_get_channel_binding_data = try_find_sym(glib2, "g_dtls_connection_get_channel_binding_data");
    stub_funcs.ptr_g_dtls_connection_get_protocol_version = try_find_sym(glib2, "g_dtls_connection_get_protocol_version");
    stub_funcs.ptr_g_dtls_connection_get_ciphersuite_name = try_find_sym(glib2, "g_dtls_connection_get_ciphersuite_name");
    stub_funcs.ptr_g_dtls_client_connection_get_type = try_find_sym(glib2, "g_dtls_client_connection_get_type");
    stub_funcs.ptr_g_dtls_client_connection_new = try_find_sym(glib2, "g_dtls_client_connection_new");
    stub_funcs.ptr_g_dtls_client_connection_get_validation_flags = try_find_sym(glib2, "g_dtls_client_connection_get_validation_flags");
    stub_funcs.ptr_g_dtls_client_connection_set_validation_flags = try_find_sym(glib2, "g_dtls_client_connection_set_validation_flags");
    stub_funcs.ptr_g_dtls_client_connection_get_server_identity = try_find_sym(glib2, "g_dtls_client_connection_get_server_identity");
    stub_funcs.ptr_g_dtls_client_connection_set_server_identity = try_find_sym(glib2, "g_dtls_client_connection_set_server_identity");
    stub_funcs.ptr_g_dtls_client_connection_get_accepted_cas = try_find_sym(glib2, "g_dtls_client_connection_get_accepted_cas");
    stub_funcs.ptr_g_dtls_server_connection_get_type = try_find_sym(glib2, "g_dtls_server_connection_get_type");
    stub_funcs.ptr_g_dtls_server_connection_new = try_find_sym(glib2, "g_dtls_server_connection_new");
    stub_funcs.ptr_g_icon_get_type = try_find_sym(glib2, "g_icon_get_type");
    stub_funcs.ptr_g_icon_hash = try_find_sym(glib2, "g_icon_hash");
    stub_funcs.ptr_g_icon_equal = try_find_sym(glib2, "g_icon_equal");
    stub_funcs.ptr_g_icon_to_string = try_find_sym(glib2, "g_icon_to_string");
    stub_funcs.ptr_g_icon_new_for_string = try_find_sym(glib2, "g_icon_new_for_string");
    stub_funcs.ptr_g_icon_serialize = try_find_sym(glib2, "g_icon_serialize");
    stub_funcs.ptr_g_icon_deserialize = try_find_sym(glib2, "g_icon_deserialize");
    stub_funcs.ptr_g_emblem_get_type = try_find_sym(glib2, "g_emblem_get_type");
    stub_funcs.ptr_g_emblem_new = try_find_sym(glib2, "g_emblem_new");
    stub_funcs.ptr_g_emblem_new_with_origin = try_find_sym(glib2, "g_emblem_new_with_origin");
    stub_funcs.ptr_g_emblem_get_icon = try_find_sym(glib2, "g_emblem_get_icon");
    stub_funcs.ptr_g_emblem_get_origin = try_find_sym(glib2, "g_emblem_get_origin");
    stub_funcs.ptr_g_emblemed_icon_get_type = try_find_sym(glib2, "g_emblemed_icon_get_type");
    stub_funcs.ptr_g_emblemed_icon_new = try_find_sym(glib2, "g_emblemed_icon_new");
    stub_funcs.ptr_g_emblemed_icon_get_icon = try_find_sym(glib2, "g_emblemed_icon_get_icon");
    stub_funcs.ptr_g_emblemed_icon_get_emblems = try_find_sym(glib2, "g_emblemed_icon_get_emblems");
    stub_funcs.ptr_g_emblemed_icon_add_emblem = try_find_sym(glib2, "g_emblemed_icon_add_emblem");
    stub_funcs.ptr_g_emblemed_icon_clear_emblems = try_find_sym(glib2, "g_emblemed_icon_clear_emblems");
    stub_funcs.ptr_g_file_get_type = try_find_sym(glib2, "g_file_get_type");
    stub_funcs.ptr_g_file_new_for_path = try_find_sym(glib2, "g_file_new_for_path");
    stub_funcs.ptr_g_file_new_for_uri = try_find_sym(glib2, "g_file_new_for_uri");
    stub_funcs.ptr_g_file_new_for_commandline_arg = try_find_sym(glib2, "g_file_new_for_commandline_arg");
    stub_funcs.ptr_g_file_new_for_commandline_arg_and_cwd = try_find_sym(glib2, "g_file_new_for_commandline_arg_and_cwd");
    stub_funcs.ptr_g_file_new_tmp = try_find_sym(glib2, "g_file_new_tmp");
    stub_funcs.ptr_g_file_new_tmp_async = try_find_sym(glib2, "g_file_new_tmp_async");
    stub_funcs.ptr_g_file_new_tmp_finish = try_find_sym(glib2, "g_file_new_tmp_finish");
    stub_funcs.ptr_g_file_new_tmp_dir_async = try_find_sym(glib2, "g_file_new_tmp_dir_async");
    stub_funcs.ptr_g_file_new_tmp_dir_finish = try_find_sym(glib2, "g_file_new_tmp_dir_finish");
    stub_funcs.ptr_g_file_parse_name = try_find_sym(glib2, "g_file_parse_name");
    stub_funcs.ptr_g_file_new_build_filenamev = try_find_sym(glib2, "g_file_new_build_filenamev");
    stub_funcs.ptr_g_file_dup = try_find_sym(glib2, "g_file_dup");
    stub_funcs.ptr_g_file_hash = try_find_sym(glib2, "g_file_hash");
    stub_funcs.ptr_g_file_equal = try_find_sym(glib2, "g_file_equal");
    stub_funcs.ptr_g_file_get_basename = try_find_sym(glib2, "g_file_get_basename");
    stub_funcs.ptr_g_file_get_path = try_find_sym(glib2, "g_file_get_path");
    stub_funcs.ptr_g_file_peek_path = try_find_sym(glib2, "g_file_peek_path");
    stub_funcs.ptr_g_file_get_uri = try_find_sym(glib2, "g_file_get_uri");
    stub_funcs.ptr_g_file_get_parse_name = try_find_sym(glib2, "g_file_get_parse_name");
    stub_funcs.ptr_g_file_get_parent = try_find_sym(glib2, "g_file_get_parent");
    stub_funcs.ptr_g_file_has_parent = try_find_sym(glib2, "g_file_has_parent");
    stub_funcs.ptr_g_file_get_child = try_find_sym(glib2, "g_file_get_child");
    stub_funcs.ptr_g_file_get_child_for_display_name = try_find_sym(glib2, "g_file_get_child_for_display_name");
    stub_funcs.ptr_g_file_has_prefix = try_find_sym(glib2, "g_file_has_prefix");
    stub_funcs.ptr_g_file_get_relative_path = try_find_sym(glib2, "g_file_get_relative_path");
    stub_funcs.ptr_g_file_resolve_relative_path = try_find_sym(glib2, "g_file_resolve_relative_path");
    stub_funcs.ptr_g_file_is_native = try_find_sym(glib2, "g_file_is_native");
    stub_funcs.ptr_g_file_has_uri_scheme = try_find_sym(glib2, "g_file_has_uri_scheme");
    stub_funcs.ptr_g_file_get_uri_scheme = try_find_sym(glib2, "g_file_get_uri_scheme");
    stub_funcs.ptr_g_file_read = try_find_sym(glib2, "g_file_read");
    stub_funcs.ptr_g_file_read_async = try_find_sym(glib2, "g_file_read_async");
    stub_funcs.ptr_g_file_read_finish = try_find_sym(glib2, "g_file_read_finish");
    stub_funcs.ptr_g_file_append_to = try_find_sym(glib2, "g_file_append_to");
    stub_funcs.ptr_g_file_create = try_find_sym(glib2, "g_file_create");
    stub_funcs.ptr_g_file_replace = try_find_sym(glib2, "g_file_replace");
    stub_funcs.ptr_g_file_append_to_async = try_find_sym(glib2, "g_file_append_to_async");
    stub_funcs.ptr_g_file_append_to_finish = try_find_sym(glib2, "g_file_append_to_finish");
    stub_funcs.ptr_g_file_create_async = try_find_sym(glib2, "g_file_create_async");
    stub_funcs.ptr_g_file_create_finish = try_find_sym(glib2, "g_file_create_finish");
    stub_funcs.ptr_g_file_replace_async = try_find_sym(glib2, "g_file_replace_async");
    stub_funcs.ptr_g_file_replace_finish = try_find_sym(glib2, "g_file_replace_finish");
    stub_funcs.ptr_g_file_open_readwrite = try_find_sym(glib2, "g_file_open_readwrite");
    stub_funcs.ptr_g_file_open_readwrite_async = try_find_sym(glib2, "g_file_open_readwrite_async");
    stub_funcs.ptr_g_file_open_readwrite_finish = try_find_sym(glib2, "g_file_open_readwrite_finish");
    stub_funcs.ptr_g_file_create_readwrite = try_find_sym(glib2, "g_file_create_readwrite");
    stub_funcs.ptr_g_file_create_readwrite_async = try_find_sym(glib2, "g_file_create_readwrite_async");
    stub_funcs.ptr_g_file_create_readwrite_finish = try_find_sym(glib2, "g_file_create_readwrite_finish");
    stub_funcs.ptr_g_file_replace_readwrite = try_find_sym(glib2, "g_file_replace_readwrite");
    stub_funcs.ptr_g_file_replace_readwrite_async = try_find_sym(glib2, "g_file_replace_readwrite_async");
    stub_funcs.ptr_g_file_replace_readwrite_finish = try_find_sym(glib2, "g_file_replace_readwrite_finish");
    stub_funcs.ptr_g_file_query_exists = try_find_sym(glib2, "g_file_query_exists");
    stub_funcs.ptr_g_file_query_file_type = try_find_sym(glib2, "g_file_query_file_type");
    stub_funcs.ptr_g_file_query_info = try_find_sym(glib2, "g_file_query_info");
    stub_funcs.ptr_g_file_query_info_async = try_find_sym(glib2, "g_file_query_info_async");
    stub_funcs.ptr_g_file_query_info_finish = try_find_sym(glib2, "g_file_query_info_finish");
    stub_funcs.ptr_g_file_query_filesystem_info = try_find_sym(glib2, "g_file_query_filesystem_info");
    stub_funcs.ptr_g_file_query_filesystem_info_async = try_find_sym(glib2, "g_file_query_filesystem_info_async");
    stub_funcs.ptr_g_file_query_filesystem_info_finish = try_find_sym(glib2, "g_file_query_filesystem_info_finish");
    stub_funcs.ptr_g_file_find_enclosing_mount = try_find_sym(glib2, "g_file_find_enclosing_mount");
    stub_funcs.ptr_g_file_find_enclosing_mount_async = try_find_sym(glib2, "g_file_find_enclosing_mount_async");
    stub_funcs.ptr_g_file_find_enclosing_mount_finish = try_find_sym(glib2, "g_file_find_enclosing_mount_finish");
    stub_funcs.ptr_g_file_enumerate_children = try_find_sym(glib2, "g_file_enumerate_children");
    stub_funcs.ptr_g_file_enumerate_children_async = try_find_sym(glib2, "g_file_enumerate_children_async");
    stub_funcs.ptr_g_file_enumerate_children_finish = try_find_sym(glib2, "g_file_enumerate_children_finish");
    stub_funcs.ptr_g_file_set_display_name = try_find_sym(glib2, "g_file_set_display_name");
    stub_funcs.ptr_g_file_set_display_name_async = try_find_sym(glib2, "g_file_set_display_name_async");
    stub_funcs.ptr_g_file_set_display_name_finish = try_find_sym(glib2, "g_file_set_display_name_finish");
    stub_funcs.ptr_g_file_delete = try_find_sym(glib2, "g_file_delete");
    stub_funcs.ptr_g_file_delete_async = try_find_sym(glib2, "g_file_delete_async");
    stub_funcs.ptr_g_file_delete_finish = try_find_sym(glib2, "g_file_delete_finish");
    stub_funcs.ptr_g_file_trash = try_find_sym(glib2, "g_file_trash");
    stub_funcs.ptr_g_file_trash_async = try_find_sym(glib2, "g_file_trash_async");
    stub_funcs.ptr_g_file_trash_finish = try_find_sym(glib2, "g_file_trash_finish");
    stub_funcs.ptr_g_file_copy = try_find_sym(glib2, "g_file_copy");
    stub_funcs.ptr_g_file_copy_async = try_find_sym(glib2, "g_file_copy_async");
    stub_funcs.ptr_g_file_copy_async_with_closures = try_find_sym(glib2, "g_file_copy_async_with_closures");
    stub_funcs.ptr_g_file_copy_finish = try_find_sym(glib2, "g_file_copy_finish");
    stub_funcs.ptr_g_file_move = try_find_sym(glib2, "g_file_move");
    stub_funcs.ptr_g_file_move_async = try_find_sym(glib2, "g_file_move_async");
    stub_funcs.ptr_g_file_move_async_with_closures = try_find_sym(glib2, "g_file_move_async_with_closures");
    stub_funcs.ptr_g_file_move_finish = try_find_sym(glib2, "g_file_move_finish");
    stub_funcs.ptr_g_file_make_directory = try_find_sym(glib2, "g_file_make_directory");
    stub_funcs.ptr_g_file_make_directory_async = try_find_sym(glib2, "g_file_make_directory_async");
    stub_funcs.ptr_g_file_make_directory_finish = try_find_sym(glib2, "g_file_make_directory_finish");
    stub_funcs.ptr_g_file_make_directory_with_parents = try_find_sym(glib2, "g_file_make_directory_with_parents");
    stub_funcs.ptr_g_file_make_symbolic_link = try_find_sym(glib2, "g_file_make_symbolic_link");
    stub_funcs.ptr_g_file_make_symbolic_link_async = try_find_sym(glib2, "g_file_make_symbolic_link_async");
    stub_funcs.ptr_g_file_make_symbolic_link_finish = try_find_sym(glib2, "g_file_make_symbolic_link_finish");
    stub_funcs.ptr_g_file_query_settable_attributes = try_find_sym(glib2, "g_file_query_settable_attributes");
    stub_funcs.ptr_g_file_query_writable_namespaces = try_find_sym(glib2, "g_file_query_writable_namespaces");
    stub_funcs.ptr_g_file_set_attribute = try_find_sym(glib2, "g_file_set_attribute");
    stub_funcs.ptr_g_file_set_attributes_from_info = try_find_sym(glib2, "g_file_set_attributes_from_info");
    stub_funcs.ptr_g_file_set_attributes_async = try_find_sym(glib2, "g_file_set_attributes_async");
    stub_funcs.ptr_g_file_set_attributes_finish = try_find_sym(glib2, "g_file_set_attributes_finish");
    stub_funcs.ptr_g_file_set_attribute_string = try_find_sym(glib2, "g_file_set_attribute_string");
    stub_funcs.ptr_g_file_set_attribute_byte_string = try_find_sym(glib2, "g_file_set_attribute_byte_string");
    stub_funcs.ptr_g_file_set_attribute_uint32 = try_find_sym(glib2, "g_file_set_attribute_uint32");
    stub_funcs.ptr_g_file_set_attribute_int32 = try_find_sym(glib2, "g_file_set_attribute_int32");
    stub_funcs.ptr_g_file_set_attribute_uint64 = try_find_sym(glib2, "g_file_set_attribute_uint64");
    stub_funcs.ptr_g_file_set_attribute_int64 = try_find_sym(glib2, "g_file_set_attribute_int64");
    stub_funcs.ptr_g_file_mount_enclosing_volume = try_find_sym(glib2, "g_file_mount_enclosing_volume");
    stub_funcs.ptr_g_file_mount_enclosing_volume_finish = try_find_sym(glib2, "g_file_mount_enclosing_volume_finish");
    stub_funcs.ptr_g_file_mount_mountable = try_find_sym(glib2, "g_file_mount_mountable");
    stub_funcs.ptr_g_file_mount_mountable_finish = try_find_sym(glib2, "g_file_mount_mountable_finish");
    stub_funcs.ptr_g_file_unmount_mountable = try_find_sym(glib2, "g_file_unmount_mountable");
    stub_funcs.ptr_g_file_unmount_mountable_finish = try_find_sym(glib2, "g_file_unmount_mountable_finish");
    stub_funcs.ptr_g_file_unmount_mountable_with_operation = try_find_sym(glib2, "g_file_unmount_mountable_with_operation");
    stub_funcs.ptr_g_file_unmount_mountable_with_operation_finish = try_find_sym(glib2, "g_file_unmount_mountable_with_operation_finish");
    stub_funcs.ptr_g_file_eject_mountable = try_find_sym(glib2, "g_file_eject_mountable");
    stub_funcs.ptr_g_file_eject_mountable_finish = try_find_sym(glib2, "g_file_eject_mountable_finish");
    stub_funcs.ptr_g_file_eject_mountable_with_operation = try_find_sym(glib2, "g_file_eject_mountable_with_operation");
    stub_funcs.ptr_g_file_eject_mountable_with_operation_finish = try_find_sym(glib2, "g_file_eject_mountable_with_operation_finish");
    stub_funcs.ptr_g_file_build_attribute_list_for_copy = try_find_sym(glib2, "g_file_build_attribute_list_for_copy");
    stub_funcs.ptr_g_file_copy_attributes = try_find_sym(glib2, "g_file_copy_attributes");
    stub_funcs.ptr_g_file_monitor_directory = try_find_sym(glib2, "g_file_monitor_directory");
    stub_funcs.ptr_g_file_monitor_file = try_find_sym(glib2, "g_file_monitor_file");
    stub_funcs.ptr_g_file_monitor = try_find_sym(glib2, "g_file_monitor");
    stub_funcs.ptr_g_file_measure_disk_usage = try_find_sym(glib2, "g_file_measure_disk_usage");
    stub_funcs.ptr_g_file_measure_disk_usage_async = try_find_sym(glib2, "g_file_measure_disk_usage_async");
    stub_funcs.ptr_g_file_measure_disk_usage_finish = try_find_sym(glib2, "g_file_measure_disk_usage_finish");
    stub_funcs.ptr_g_file_start_mountable = try_find_sym(glib2, "g_file_start_mountable");
    stub_funcs.ptr_g_file_start_mountable_finish = try_find_sym(glib2, "g_file_start_mountable_finish");
    stub_funcs.ptr_g_file_stop_mountable = try_find_sym(glib2, "g_file_stop_mountable");
    stub_funcs.ptr_g_file_stop_mountable_finish = try_find_sym(glib2, "g_file_stop_mountable_finish");
    stub_funcs.ptr_g_file_poll_mountable = try_find_sym(glib2, "g_file_poll_mountable");
    stub_funcs.ptr_g_file_poll_mountable_finish = try_find_sym(glib2, "g_file_poll_mountable_finish");
    stub_funcs.ptr_g_file_query_default_handler = try_find_sym(glib2, "g_file_query_default_handler");
    stub_funcs.ptr_g_file_query_default_handler_async = try_find_sym(glib2, "g_file_query_default_handler_async");
    stub_funcs.ptr_g_file_query_default_handler_finish = try_find_sym(glib2, "g_file_query_default_handler_finish");
    stub_funcs.ptr_g_file_load_contents = try_find_sym(glib2, "g_file_load_contents");
    stub_funcs.ptr_g_file_load_contents_async = try_find_sym(glib2, "g_file_load_contents_async");
    stub_funcs.ptr_g_file_load_contents_finish = try_find_sym(glib2, "g_file_load_contents_finish");
    stub_funcs.ptr_g_file_load_partial_contents_async = try_find_sym(glib2, "g_file_load_partial_contents_async");
    stub_funcs.ptr_g_file_load_partial_contents_finish = try_find_sym(glib2, "g_file_load_partial_contents_finish");
    stub_funcs.ptr_g_file_replace_contents = try_find_sym(glib2, "g_file_replace_contents");
    stub_funcs.ptr_g_file_replace_contents_async = try_find_sym(glib2, "g_file_replace_contents_async");
    stub_funcs.ptr_g_file_replace_contents_bytes_async = try_find_sym(glib2, "g_file_replace_contents_bytes_async");
    stub_funcs.ptr_g_file_replace_contents_finish = try_find_sym(glib2, "g_file_replace_contents_finish");
    stub_funcs.ptr_g_file_supports_thread_contexts = try_find_sym(glib2, "g_file_supports_thread_contexts");
    stub_funcs.ptr_g_file_load_bytes = try_find_sym(glib2, "g_file_load_bytes");
    stub_funcs.ptr_g_file_load_bytes_async = try_find_sym(glib2, "g_file_load_bytes_async");
    stub_funcs.ptr_g_file_load_bytes_finish = try_find_sym(glib2, "g_file_load_bytes_finish");
    stub_funcs.ptr_g_file_attribute_info_list_get_type = try_find_sym(glib2, "g_file_attribute_info_list_get_type");
    stub_funcs.ptr_g_file_attribute_info_list_new = try_find_sym(glib2, "g_file_attribute_info_list_new");
    stub_funcs.ptr_g_file_attribute_info_list_ref = try_find_sym(glib2, "g_file_attribute_info_list_ref");
    stub_funcs.ptr_g_file_attribute_info_list_unref = try_find_sym(glib2, "g_file_attribute_info_list_unref");
    stub_funcs.ptr_g_file_attribute_info_list_dup = try_find_sym(glib2, "g_file_attribute_info_list_dup");
    stub_funcs.ptr_g_file_attribute_info_list_lookup = try_find_sym(glib2, "g_file_attribute_info_list_lookup");
    stub_funcs.ptr_g_file_attribute_info_list_add = try_find_sym(glib2, "g_file_attribute_info_list_add");
    stub_funcs.ptr_g_file_enumerator_get_type = try_find_sym(glib2, "g_file_enumerator_get_type");
    stub_funcs.ptr_g_file_enumerator_next_file = try_find_sym(glib2, "g_file_enumerator_next_file");
    stub_funcs.ptr_g_file_enumerator_close = try_find_sym(glib2, "g_file_enumerator_close");
    stub_funcs.ptr_g_file_enumerator_next_files_async = try_find_sym(glib2, "g_file_enumerator_next_files_async");
    stub_funcs.ptr_g_file_enumerator_next_files_finish = try_find_sym(glib2, "g_file_enumerator_next_files_finish");
    stub_funcs.ptr_g_file_enumerator_close_async = try_find_sym(glib2, "g_file_enumerator_close_async");
    stub_funcs.ptr_g_file_enumerator_close_finish = try_find_sym(glib2, "g_file_enumerator_close_finish");
    stub_funcs.ptr_g_file_enumerator_is_closed = try_find_sym(glib2, "g_file_enumerator_is_closed");
    stub_funcs.ptr_g_file_enumerator_has_pending = try_find_sym(glib2, "g_file_enumerator_has_pending");
    stub_funcs.ptr_g_file_enumerator_set_pending = try_find_sym(glib2, "g_file_enumerator_set_pending");
    stub_funcs.ptr_g_file_enumerator_get_container = try_find_sym(glib2, "g_file_enumerator_get_container");
    stub_funcs.ptr_g_file_enumerator_get_child = try_find_sym(glib2, "g_file_enumerator_get_child");
    stub_funcs.ptr_g_file_enumerator_iterate = try_find_sym(glib2, "g_file_enumerator_iterate");
    stub_funcs.ptr_g_file_icon_get_type = try_find_sym(glib2, "g_file_icon_get_type");
    stub_funcs.ptr_g_file_icon_new = try_find_sym(glib2, "g_file_icon_new");
    stub_funcs.ptr_g_file_icon_get_file = try_find_sym(glib2, "g_file_icon_get_file");
    stub_funcs.ptr_g_file_info_get_type = try_find_sym(glib2, "g_file_info_get_type");
    stub_funcs.ptr_g_file_info_new = try_find_sym(glib2, "g_file_info_new");
    stub_funcs.ptr_g_file_info_dup = try_find_sym(glib2, "g_file_info_dup");
    stub_funcs.ptr_g_file_info_copy_into = try_find_sym(glib2, "g_file_info_copy_into");
    stub_funcs.ptr_g_file_info_has_attribute = try_find_sym(glib2, "g_file_info_has_attribute");
    stub_funcs.ptr_g_file_info_has_namespace = try_find_sym(glib2, "g_file_info_has_namespace");
    stub_funcs.ptr_g_file_info_list_attributes = try_find_sym(glib2, "g_file_info_list_attributes");
    stub_funcs.ptr_g_file_info_get_attribute_data = try_find_sym(glib2, "g_file_info_get_attribute_data");
    stub_funcs.ptr_g_file_info_get_attribute_type = try_find_sym(glib2, "g_file_info_get_attribute_type");
    stub_funcs.ptr_g_file_info_remove_attribute = try_find_sym(glib2, "g_file_info_remove_attribute");
    stub_funcs.ptr_g_file_info_get_attribute_status = try_find_sym(glib2, "g_file_info_get_attribute_status");
    stub_funcs.ptr_g_file_info_set_attribute_status = try_find_sym(glib2, "g_file_info_set_attribute_status");
    stub_funcs.ptr_g_file_info_get_attribute_as_string = try_find_sym(glib2, "g_file_info_get_attribute_as_string");
    stub_funcs.ptr_g_file_info_get_attribute_string = try_find_sym(glib2, "g_file_info_get_attribute_string");
    stub_funcs.ptr_g_file_info_get_attribute_byte_string = try_find_sym(glib2, "g_file_info_get_attribute_byte_string");
    stub_funcs.ptr_g_file_info_get_attribute_boolean = try_find_sym(glib2, "g_file_info_get_attribute_boolean");
    stub_funcs.ptr_g_file_info_get_attribute_uint32 = try_find_sym(glib2, "g_file_info_get_attribute_uint32");
    stub_funcs.ptr_g_file_info_get_attribute_int32 = try_find_sym(glib2, "g_file_info_get_attribute_int32");
    stub_funcs.ptr_g_file_info_get_attribute_uint64 = try_find_sym(glib2, "g_file_info_get_attribute_uint64");
    stub_funcs.ptr_g_file_info_get_attribute_int64 = try_find_sym(glib2, "g_file_info_get_attribute_int64");
    stub_funcs.ptr_g_file_info_get_attribute_object = try_find_sym(glib2, "g_file_info_get_attribute_object");
    stub_funcs.ptr_g_file_info_get_attribute_stringv = try_find_sym(glib2, "g_file_info_get_attribute_stringv");
    stub_funcs.ptr_g_file_info_get_attribute_file_path = try_find_sym(glib2, "g_file_info_get_attribute_file_path");
    stub_funcs.ptr_g_file_info_set_attribute = try_find_sym(glib2, "g_file_info_set_attribute");
    stub_funcs.ptr_g_file_info_set_attribute_string = try_find_sym(glib2, "g_file_info_set_attribute_string");
    stub_funcs.ptr_g_file_info_set_attribute_byte_string = try_find_sym(glib2, "g_file_info_set_attribute_byte_string");
    stub_funcs.ptr_g_file_info_set_attribute_boolean = try_find_sym(glib2, "g_file_info_set_attribute_boolean");
    stub_funcs.ptr_g_file_info_set_attribute_uint32 = try_find_sym(glib2, "g_file_info_set_attribute_uint32");
    stub_funcs.ptr_g_file_info_set_attribute_int32 = try_find_sym(glib2, "g_file_info_set_attribute_int32");
    stub_funcs.ptr_g_file_info_set_attribute_uint64 = try_find_sym(glib2, "g_file_info_set_attribute_uint64");
    stub_funcs.ptr_g_file_info_set_attribute_int64 = try_find_sym(glib2, "g_file_info_set_attribute_int64");
    stub_funcs.ptr_g_file_info_set_attribute_object = try_find_sym(glib2, "g_file_info_set_attribute_object");
    stub_funcs.ptr_g_file_info_set_attribute_stringv = try_find_sym(glib2, "g_file_info_set_attribute_stringv");
    stub_funcs.ptr_g_file_info_set_attribute_file_path = try_find_sym(glib2, "g_file_info_set_attribute_file_path");
    stub_funcs.ptr_g_file_info_clear_status = try_find_sym(glib2, "g_file_info_clear_status");
    stub_funcs.ptr_g_file_info_get_deletion_date = try_find_sym(glib2, "g_file_info_get_deletion_date");
    stub_funcs.ptr_g_file_info_get_file_type = try_find_sym(glib2, "g_file_info_get_file_type");
    stub_funcs.ptr_g_file_info_get_is_hidden = try_find_sym(glib2, "g_file_info_get_is_hidden");
    stub_funcs.ptr_g_file_info_get_is_backup = try_find_sym(glib2, "g_file_info_get_is_backup");
    stub_funcs.ptr_g_file_info_get_is_symlink = try_find_sym(glib2, "g_file_info_get_is_symlink");
    stub_funcs.ptr_g_file_info_get_name = try_find_sym(glib2, "g_file_info_get_name");
    stub_funcs.ptr_g_file_info_get_display_name = try_find_sym(glib2, "g_file_info_get_display_name");
    stub_funcs.ptr_g_file_info_get_edit_name = try_find_sym(glib2, "g_file_info_get_edit_name");
    stub_funcs.ptr_g_file_info_get_icon = try_find_sym(glib2, "g_file_info_get_icon");
    stub_funcs.ptr_g_file_info_get_symbolic_icon = try_find_sym(glib2, "g_file_info_get_symbolic_icon");
    stub_funcs.ptr_g_file_info_get_content_type = try_find_sym(glib2, "g_file_info_get_content_type");
    stub_funcs.ptr_g_file_info_get_size = try_find_sym(glib2, "g_file_info_get_size");
    stub_funcs.ptr_g_file_info_get_modification_time = try_find_sym(glib2, "g_file_info_get_modification_time");
    stub_funcs.ptr_g_file_info_get_modification_date_time = try_find_sym(glib2, "g_file_info_get_modification_date_time");
    stub_funcs.ptr_g_file_info_get_access_date_time = try_find_sym(glib2, "g_file_info_get_access_date_time");
    stub_funcs.ptr_g_file_info_get_creation_date_time = try_find_sym(glib2, "g_file_info_get_creation_date_time");
    stub_funcs.ptr_g_file_info_get_symlink_target = try_find_sym(glib2, "g_file_info_get_symlink_target");
    stub_funcs.ptr_g_file_info_get_etag = try_find_sym(glib2, "g_file_info_get_etag");
    stub_funcs.ptr_g_file_info_get_sort_order = try_find_sym(glib2, "g_file_info_get_sort_order");
    stub_funcs.ptr_g_file_info_set_attribute_mask = try_find_sym(glib2, "g_file_info_set_attribute_mask");
    stub_funcs.ptr_g_file_info_unset_attribute_mask = try_find_sym(glib2, "g_file_info_unset_attribute_mask");
    stub_funcs.ptr_g_file_info_set_file_type = try_find_sym(glib2, "g_file_info_set_file_type");
    stub_funcs.ptr_g_file_info_set_is_hidden = try_find_sym(glib2, "g_file_info_set_is_hidden");
    stub_funcs.ptr_g_file_info_set_is_symlink = try_find_sym(glib2, "g_file_info_set_is_symlink");
    stub_funcs.ptr_g_file_info_set_name = try_find_sym(glib2, "g_file_info_set_name");
    stub_funcs.ptr_g_file_info_set_display_name = try_find_sym(glib2, "g_file_info_set_display_name");
    stub_funcs.ptr_g_file_info_set_edit_name = try_find_sym(glib2, "g_file_info_set_edit_name");
    stub_funcs.ptr_g_file_info_set_icon = try_find_sym(glib2, "g_file_info_set_icon");
    stub_funcs.ptr_g_file_info_set_symbolic_icon = try_find_sym(glib2, "g_file_info_set_symbolic_icon");
    stub_funcs.ptr_g_file_info_set_content_type = try_find_sym(glib2, "g_file_info_set_content_type");
    stub_funcs.ptr_g_file_info_set_size = try_find_sym(glib2, "g_file_info_set_size");
    stub_funcs.ptr_g_file_info_set_modification_time = try_find_sym(glib2, "g_file_info_set_modification_time");
    stub_funcs.ptr_g_file_info_set_modification_date_time = try_find_sym(glib2, "g_file_info_set_modification_date_time");
    stub_funcs.ptr_g_file_info_set_access_date_time = try_find_sym(glib2, "g_file_info_set_access_date_time");
    stub_funcs.ptr_g_file_info_set_creation_date_time = try_find_sym(glib2, "g_file_info_set_creation_date_time");
    stub_funcs.ptr_g_file_info_set_symlink_target = try_find_sym(glib2, "g_file_info_set_symlink_target");
    stub_funcs.ptr_g_file_info_set_sort_order = try_find_sym(glib2, "g_file_info_set_sort_order");
    stub_funcs.ptr_g_file_attribute_matcher_get_type = try_find_sym(glib2, "g_file_attribute_matcher_get_type");
    stub_funcs.ptr_g_file_attribute_matcher_new = try_find_sym(glib2, "g_file_attribute_matcher_new");
    stub_funcs.ptr_g_file_attribute_matcher_ref = try_find_sym(glib2, "g_file_attribute_matcher_ref");
    stub_funcs.ptr_g_file_attribute_matcher_unref = try_find_sym(glib2, "g_file_attribute_matcher_unref");
    stub_funcs.ptr_g_file_attribute_matcher_subtract = try_find_sym(glib2, "g_file_attribute_matcher_subtract");
    stub_funcs.ptr_g_file_attribute_matcher_matches = try_find_sym(glib2, "g_file_attribute_matcher_matches");
    stub_funcs.ptr_g_file_attribute_matcher_matches_only = try_find_sym(glib2, "g_file_attribute_matcher_matches_only");
    stub_funcs.ptr_g_file_attribute_matcher_enumerate_namespace = try_find_sym(glib2, "g_file_attribute_matcher_enumerate_namespace");
    stub_funcs.ptr_g_file_attribute_matcher_enumerate_next = try_find_sym(glib2, "g_file_attribute_matcher_enumerate_next");
    stub_funcs.ptr_g_file_attribute_matcher_to_string = try_find_sym(glib2, "g_file_attribute_matcher_to_string");
    stub_funcs.ptr_g_file_input_stream_get_type = try_find_sym(glib2, "g_file_input_stream_get_type");
    stub_funcs.ptr_g_file_input_stream_query_info = try_find_sym(glib2, "g_file_input_stream_query_info");
    stub_funcs.ptr_g_file_input_stream_query_info_async = try_find_sym(glib2, "g_file_input_stream_query_info_async");
    stub_funcs.ptr_g_file_input_stream_query_info_finish = try_find_sym(glib2, "g_file_input_stream_query_info_finish");
    stub_funcs.ptr_g_io_error_quark = try_find_sym(glib2, "g_io_error_quark");
    stub_funcs.ptr_g_io_error_from_errno = try_find_sym(glib2, "g_io_error_from_errno");
    stub_funcs.ptr_g_io_error_from_file_error = try_find_sym(glib2, "g_io_error_from_file_error");
    stub_funcs.ptr_g_io_stream_get_type = try_find_sym(glib2, "g_io_stream_get_type");
    stub_funcs.ptr_g_io_stream_get_input_stream = try_find_sym(glib2, "g_io_stream_get_input_stream");
    stub_funcs.ptr_g_io_stream_get_output_stream = try_find_sym(glib2, "g_io_stream_get_output_stream");
    stub_funcs.ptr_g_io_stream_splice_async = try_find_sym(glib2, "g_io_stream_splice_async");
    stub_funcs.ptr_g_io_stream_splice_finish = try_find_sym(glib2, "g_io_stream_splice_finish");
    stub_funcs.ptr_g_io_stream_close = try_find_sym(glib2, "g_io_stream_close");
    stub_funcs.ptr_g_io_stream_close_async = try_find_sym(glib2, "g_io_stream_close_async");
    stub_funcs.ptr_g_io_stream_close_finish = try_find_sym(glib2, "g_io_stream_close_finish");
    stub_funcs.ptr_g_io_stream_is_closed = try_find_sym(glib2, "g_io_stream_is_closed");
    stub_funcs.ptr_g_io_stream_has_pending = try_find_sym(glib2, "g_io_stream_has_pending");
    stub_funcs.ptr_g_io_stream_set_pending = try_find_sym(glib2, "g_io_stream_set_pending");
    stub_funcs.ptr_g_io_stream_clear_pending = try_find_sym(glib2, "g_io_stream_clear_pending");
    stub_funcs.ptr_g_file_io_stream_get_type = try_find_sym(glib2, "g_file_io_stream_get_type");
    stub_funcs.ptr_g_file_io_stream_query_info = try_find_sym(glib2, "g_file_io_stream_query_info");
    stub_funcs.ptr_g_file_io_stream_query_info_async = try_find_sym(glib2, "g_file_io_stream_query_info_async");
    stub_funcs.ptr_g_file_io_stream_query_info_finish = try_find_sym(glib2, "g_file_io_stream_query_info_finish");
    stub_funcs.ptr_g_file_io_stream_get_etag = try_find_sym(glib2, "g_file_io_stream_get_etag");
    stub_funcs.ptr_g_file_monitor_get_type = try_find_sym(glib2, "g_file_monitor_get_type");
    stub_funcs.ptr_g_file_monitor_cancel = try_find_sym(glib2, "g_file_monitor_cancel");
    stub_funcs.ptr_g_file_monitor_is_cancelled = try_find_sym(glib2, "g_file_monitor_is_cancelled");
    stub_funcs.ptr_g_file_monitor_set_rate_limit = try_find_sym(glib2, "g_file_monitor_set_rate_limit");
    stub_funcs.ptr_g_file_monitor_emit_event = try_find_sym(glib2, "g_file_monitor_emit_event");
    stub_funcs.ptr_g_filename_completer_get_type = try_find_sym(glib2, "g_filename_completer_get_type");
    stub_funcs.ptr_g_filename_completer_new = try_find_sym(glib2, "g_filename_completer_new");
    stub_funcs.ptr_g_filename_completer_get_completion_suffix = try_find_sym(glib2, "g_filename_completer_get_completion_suffix");
    stub_funcs.ptr_g_filename_completer_get_completions = try_find_sym(glib2, "g_filename_completer_get_completions");
    stub_funcs.ptr_g_filename_completer_set_dirs_only = try_find_sym(glib2, "g_filename_completer_set_dirs_only");
    stub_funcs.ptr_g_file_output_stream_get_type = try_find_sym(glib2, "g_file_output_stream_get_type");
    stub_funcs.ptr_g_file_output_stream_query_info = try_find_sym(glib2, "g_file_output_stream_query_info");
    stub_funcs.ptr_g_file_output_stream_query_info_async = try_find_sym(glib2, "g_file_output_stream_query_info_async");
    stub_funcs.ptr_g_file_output_stream_query_info_finish = try_find_sym(glib2, "g_file_output_stream_query_info_finish");
    stub_funcs.ptr_g_file_output_stream_get_etag = try_find_sym(glib2, "g_file_output_stream_get_etag");
    stub_funcs.ptr_g_inet_address_get_type = try_find_sym(glib2, "g_inet_address_get_type");
    stub_funcs.ptr_g_inet_address_new_from_string = try_find_sym(glib2, "g_inet_address_new_from_string");
    stub_funcs.ptr_g_inet_address_new_from_bytes = try_find_sym(glib2, "g_inet_address_new_from_bytes");
    stub_funcs.ptr_g_inet_address_new_loopback = try_find_sym(glib2, "g_inet_address_new_loopback");
    stub_funcs.ptr_g_inet_address_new_any = try_find_sym(glib2, "g_inet_address_new_any");
    stub_funcs.ptr_g_inet_address_equal = try_find_sym(glib2, "g_inet_address_equal");
    stub_funcs.ptr_g_inet_address_to_string = try_find_sym(glib2, "g_inet_address_to_string");
    stub_funcs.ptr_g_inet_address_to_bytes = try_find_sym(glib2, "g_inet_address_to_bytes");
    stub_funcs.ptr_g_inet_address_get_native_size = try_find_sym(glib2, "g_inet_address_get_native_size");
    stub_funcs.ptr_g_inet_address_get_family = try_find_sym(glib2, "g_inet_address_get_family");
    stub_funcs.ptr_g_inet_address_get_is_any = try_find_sym(glib2, "g_inet_address_get_is_any");
    stub_funcs.ptr_g_inet_address_get_is_loopback = try_find_sym(glib2, "g_inet_address_get_is_loopback");
    stub_funcs.ptr_g_inet_address_get_is_link_local = try_find_sym(glib2, "g_inet_address_get_is_link_local");
    stub_funcs.ptr_g_inet_address_get_is_site_local = try_find_sym(glib2, "g_inet_address_get_is_site_local");
    stub_funcs.ptr_g_inet_address_get_is_multicast = try_find_sym(glib2, "g_inet_address_get_is_multicast");
    stub_funcs.ptr_g_inet_address_get_is_mc_global = try_find_sym(glib2, "g_inet_address_get_is_mc_global");
    stub_funcs.ptr_g_inet_address_get_is_mc_link_local = try_find_sym(glib2, "g_inet_address_get_is_mc_link_local");
    stub_funcs.ptr_g_inet_address_get_is_mc_node_local = try_find_sym(glib2, "g_inet_address_get_is_mc_node_local");
    stub_funcs.ptr_g_inet_address_get_is_mc_org_local = try_find_sym(glib2, "g_inet_address_get_is_mc_org_local");
    stub_funcs.ptr_g_inet_address_get_is_mc_site_local = try_find_sym(glib2, "g_inet_address_get_is_mc_site_local");
    stub_funcs.ptr_g_inet_address_mask_get_type = try_find_sym(glib2, "g_inet_address_mask_get_type");
    stub_funcs.ptr_g_inet_address_mask_new = try_find_sym(glib2, "g_inet_address_mask_new");
    stub_funcs.ptr_g_inet_address_mask_new_from_string = try_find_sym(glib2, "g_inet_address_mask_new_from_string");
    stub_funcs.ptr_g_inet_address_mask_to_string = try_find_sym(glib2, "g_inet_address_mask_to_string");
    stub_funcs.ptr_g_inet_address_mask_get_family = try_find_sym(glib2, "g_inet_address_mask_get_family");
    stub_funcs.ptr_g_inet_address_mask_get_address = try_find_sym(glib2, "g_inet_address_mask_get_address");
    stub_funcs.ptr_g_inet_address_mask_get_length = try_find_sym(glib2, "g_inet_address_mask_get_length");
    stub_funcs.ptr_g_inet_address_mask_matches = try_find_sym(glib2, "g_inet_address_mask_matches");
    stub_funcs.ptr_g_inet_address_mask_equal = try_find_sym(glib2, "g_inet_address_mask_equal");
    stub_funcs.ptr_g_socket_address_get_type = try_find_sym(glib2, "g_socket_address_get_type");
    stub_funcs.ptr_g_socket_address_get_family = try_find_sym(glib2, "g_socket_address_get_family");
    stub_funcs.ptr_g_socket_address_new_from_native = try_find_sym(glib2, "g_socket_address_new_from_native");
    stub_funcs.ptr_g_socket_address_to_native = try_find_sym(glib2, "g_socket_address_to_native");
    stub_funcs.ptr_g_socket_address_get_native_size = try_find_sym(glib2, "g_socket_address_get_native_size");
    stub_funcs.ptr_g_inet_socket_address_get_type = try_find_sym(glib2, "g_inet_socket_address_get_type");
    stub_funcs.ptr_g_inet_socket_address_new = try_find_sym(glib2, "g_inet_socket_address_new");
    stub_funcs.ptr_g_inet_socket_address_new_from_string = try_find_sym(glib2, "g_inet_socket_address_new_from_string");
    stub_funcs.ptr_g_inet_socket_address_get_address = try_find_sym(glib2, "g_inet_socket_address_get_address");
    stub_funcs.ptr_g_inet_socket_address_get_port = try_find_sym(glib2, "g_inet_socket_address_get_port");
    stub_funcs.ptr_g_inet_socket_address_get_flowinfo = try_find_sym(glib2, "g_inet_socket_address_get_flowinfo");
    stub_funcs.ptr_g_inet_socket_address_get_scope_id = try_find_sym(glib2, "g_inet_socket_address_get_scope_id");
    stub_funcs.ptr_g_app_info_create_flags_get_type = try_find_sym(glib2, "g_app_info_create_flags_get_type");
    stub_funcs.ptr_g_converter_flags_get_type = try_find_sym(glib2, "g_converter_flags_get_type");
    stub_funcs.ptr_g_converter_result_get_type = try_find_sym(glib2, "g_converter_result_get_type");
    stub_funcs.ptr_g_data_stream_byte_order_get_type = try_find_sym(glib2, "g_data_stream_byte_order_get_type");
    stub_funcs.ptr_g_data_stream_newline_type_get_type = try_find_sym(glib2, "g_data_stream_newline_type_get_type");
    stub_funcs.ptr_g_file_attribute_type_get_type = try_find_sym(glib2, "g_file_attribute_type_get_type");
    stub_funcs.ptr_g_file_attribute_info_flags_get_type = try_find_sym(glib2, "g_file_attribute_info_flags_get_type");
    stub_funcs.ptr_g_file_attribute_status_get_type = try_find_sym(glib2, "g_file_attribute_status_get_type");
    stub_funcs.ptr_g_file_query_info_flags_get_type = try_find_sym(glib2, "g_file_query_info_flags_get_type");
    stub_funcs.ptr_g_file_create_flags_get_type = try_find_sym(glib2, "g_file_create_flags_get_type");
    stub_funcs.ptr_g_file_measure_flags_get_type = try_find_sym(glib2, "g_file_measure_flags_get_type");
    stub_funcs.ptr_g_mount_mount_flags_get_type = try_find_sym(glib2, "g_mount_mount_flags_get_type");
    stub_funcs.ptr_g_mount_unmount_flags_get_type = try_find_sym(glib2, "g_mount_unmount_flags_get_type");
    stub_funcs.ptr_g_drive_start_flags_get_type = try_find_sym(glib2, "g_drive_start_flags_get_type");
    stub_funcs.ptr_g_drive_start_stop_type_get_type = try_find_sym(glib2, "g_drive_start_stop_type_get_type");
    stub_funcs.ptr_g_file_copy_flags_get_type = try_find_sym(glib2, "g_file_copy_flags_get_type");
    stub_funcs.ptr_g_file_monitor_flags_get_type = try_find_sym(glib2, "g_file_monitor_flags_get_type");
    stub_funcs.ptr_g_file_type_get_type = try_find_sym(glib2, "g_file_type_get_type");
    stub_funcs.ptr_g_filesystem_preview_type_get_type = try_find_sym(glib2, "g_filesystem_preview_type_get_type");
    stub_funcs.ptr_g_file_monitor_event_get_type = try_find_sym(glib2, "g_file_monitor_event_get_type");
    stub_funcs.ptr_g_io_error_enum_get_type = try_find_sym(glib2, "g_io_error_enum_get_type");
    stub_funcs.ptr_g_ask_password_flags_get_type = try_find_sym(glib2, "g_ask_password_flags_get_type");
    stub_funcs.ptr_g_password_save_get_type = try_find_sym(glib2, "g_password_save_get_type");
    stub_funcs.ptr_g_mount_operation_result_get_type = try_find_sym(glib2, "g_mount_operation_result_get_type");
    stub_funcs.ptr_g_output_stream_splice_flags_get_type = try_find_sym(glib2, "g_output_stream_splice_flags_get_type");
    stub_funcs.ptr_g_io_stream_splice_flags_get_type = try_find_sym(glib2, "g_io_stream_splice_flags_get_type");
    stub_funcs.ptr_g_emblem_origin_get_type = try_find_sym(glib2, "g_emblem_origin_get_type");
    stub_funcs.ptr_g_resolver_error_get_type = try_find_sym(glib2, "g_resolver_error_get_type");
    stub_funcs.ptr_g_resolver_record_type_get_type = try_find_sym(glib2, "g_resolver_record_type_get_type");
    stub_funcs.ptr_g_resource_error_get_type = try_find_sym(glib2, "g_resource_error_get_type");
    stub_funcs.ptr_g_resource_flags_get_type = try_find_sym(glib2, "g_resource_flags_get_type");
    stub_funcs.ptr_g_resource_lookup_flags_get_type = try_find_sym(glib2, "g_resource_lookup_flags_get_type");
    stub_funcs.ptr_g_socket_family_get_type = try_find_sym(glib2, "g_socket_family_get_type");
    stub_funcs.ptr_g_socket_type_get_type = try_find_sym(glib2, "g_socket_type_get_type");
    stub_funcs.ptr_g_socket_msg_flags_get_type = try_find_sym(glib2, "g_socket_msg_flags_get_type");
    stub_funcs.ptr_g_socket_protocol_get_type = try_find_sym(glib2, "g_socket_protocol_get_type");
    stub_funcs.ptr_g_zlib_compressor_format_get_type = try_find_sym(glib2, "g_zlib_compressor_format_get_type");
    stub_funcs.ptr_g_unix_socket_address_type_get_type = try_find_sym(glib2, "g_unix_socket_address_type_get_type");
    stub_funcs.ptr_g_bus_type_get_type = try_find_sym(glib2, "g_bus_type_get_type");
    stub_funcs.ptr_g_bus_name_owner_flags_get_type = try_find_sym(glib2, "g_bus_name_owner_flags_get_type");
    stub_funcs.ptr_g_bus_name_watcher_flags_get_type = try_find_sym(glib2, "g_bus_name_watcher_flags_get_type");
    stub_funcs.ptr_g_dbus_proxy_flags_get_type = try_find_sym(glib2, "g_dbus_proxy_flags_get_type");
    stub_funcs.ptr_g_dbus_error_get_type = try_find_sym(glib2, "g_dbus_error_get_type");
    stub_funcs.ptr_g_dbus_connection_flags_get_type = try_find_sym(glib2, "g_dbus_connection_flags_get_type");
    stub_funcs.ptr_g_dbus_capability_flags_get_type = try_find_sym(glib2, "g_dbus_capability_flags_get_type");
    stub_funcs.ptr_g_dbus_call_flags_get_type = try_find_sym(glib2, "g_dbus_call_flags_get_type");
    stub_funcs.ptr_g_dbus_message_type_get_type = try_find_sym(glib2, "g_dbus_message_type_get_type");
    stub_funcs.ptr_g_dbus_message_flags_get_type = try_find_sym(glib2, "g_dbus_message_flags_get_type");
    stub_funcs.ptr_g_dbus_message_header_field_get_type = try_find_sym(glib2, "g_dbus_message_header_field_get_type");
    stub_funcs.ptr_g_dbus_property_info_flags_get_type = try_find_sym(glib2, "g_dbus_property_info_flags_get_type");
    stub_funcs.ptr_g_dbus_subtree_flags_get_type = try_find_sym(glib2, "g_dbus_subtree_flags_get_type");
    stub_funcs.ptr_g_dbus_server_flags_get_type = try_find_sym(glib2, "g_dbus_server_flags_get_type");
    stub_funcs.ptr_g_dbus_signal_flags_get_type = try_find_sym(glib2, "g_dbus_signal_flags_get_type");
    stub_funcs.ptr_g_dbus_send_message_flags_get_type = try_find_sym(glib2, "g_dbus_send_message_flags_get_type");
    stub_funcs.ptr_g_credentials_type_get_type = try_find_sym(glib2, "g_credentials_type_get_type");
    stub_funcs.ptr_g_dbus_message_byte_order_get_type = try_find_sym(glib2, "g_dbus_message_byte_order_get_type");
    stub_funcs.ptr_g_application_flags_get_type = try_find_sym(glib2, "g_application_flags_get_type");
    stub_funcs.ptr_g_tls_error_get_type = try_find_sym(glib2, "g_tls_error_get_type");
    stub_funcs.ptr_g_tls_certificate_flags_get_type = try_find_sym(glib2, "g_tls_certificate_flags_get_type");
    stub_funcs.ptr_g_tls_authentication_mode_get_type = try_find_sym(glib2, "g_tls_authentication_mode_get_type");
    stub_funcs.ptr_g_tls_channel_binding_type_get_type = try_find_sym(glib2, "g_tls_channel_binding_type_get_type");
    stub_funcs.ptr_g_tls_channel_binding_error_get_type = try_find_sym(glib2, "g_tls_channel_binding_error_get_type");
    stub_funcs.ptr_g_tls_rehandshake_mode_get_type = try_find_sym(glib2, "g_tls_rehandshake_mode_get_type");
    stub_funcs.ptr_g_tls_password_flags_get_type = try_find_sym(glib2, "g_tls_password_flags_get_type");
    stub_funcs.ptr_g_tls_interaction_result_get_type = try_find_sym(glib2, "g_tls_interaction_result_get_type");
    stub_funcs.ptr_g_dbus_interface_skeleton_flags_get_type = try_find_sym(glib2, "g_dbus_interface_skeleton_flags_get_type");
    stub_funcs.ptr_g_dbus_object_manager_client_flags_get_type = try_find_sym(glib2, "g_dbus_object_manager_client_flags_get_type");
    stub_funcs.ptr_g_tls_database_verify_flags_get_type = try_find_sym(glib2, "g_tls_database_verify_flags_get_type");
    stub_funcs.ptr_g_tls_database_lookup_flags_get_type = try_find_sym(glib2, "g_tls_database_lookup_flags_get_type");
    stub_funcs.ptr_g_tls_certificate_request_flags_get_type = try_find_sym(glib2, "g_tls_certificate_request_flags_get_type");
    stub_funcs.ptr_g_tls_protocol_version_get_type = try_find_sym(glib2, "g_tls_protocol_version_get_type");
    stub_funcs.ptr_g_io_module_scope_flags_get_type = try_find_sym(glib2, "g_io_module_scope_flags_get_type");
    stub_funcs.ptr_g_socket_client_event_get_type = try_find_sym(glib2, "g_socket_client_event_get_type");
    stub_funcs.ptr_g_socket_listener_event_get_type = try_find_sym(glib2, "g_socket_listener_event_get_type");
    stub_funcs.ptr_g_test_dbus_flags_get_type = try_find_sym(glib2, "g_test_dbus_flags_get_type");
    stub_funcs.ptr_g_subprocess_flags_get_type = try_find_sym(glib2, "g_subprocess_flags_get_type");
    stub_funcs.ptr_g_notification_priority_get_type = try_find_sym(glib2, "g_notification_priority_get_type");
    stub_funcs.ptr_g_network_connectivity_get_type = try_find_sym(glib2, "g_network_connectivity_get_type");
    stub_funcs.ptr_g_pollable_return_get_type = try_find_sym(glib2, "g_pollable_return_get_type");
    stub_funcs.ptr_g_memory_monitor_warning_level_get_type = try_find_sym(glib2, "g_memory_monitor_warning_level_get_type");
    stub_funcs.ptr_g_resolver_name_lookup_flags_get_type = try_find_sym(glib2, "g_resolver_name_lookup_flags_get_type");
    stub_funcs.ptr_g_settings_bind_flags_get_type = try_find_sym(glib2, "g_settings_bind_flags_get_type");
    stub_funcs.ptr_g_io_module_scope_new = try_find_sym(glib2, "g_io_module_scope_new");
    stub_funcs.ptr_g_io_module_scope_free = try_find_sym(glib2, "g_io_module_scope_free");
    stub_funcs.ptr_g_io_module_scope_block = try_find_sym(glib2, "g_io_module_scope_block");
    stub_funcs.ptr_g_io_module_get_type = try_find_sym(glib2, "g_io_module_get_type");
    stub_funcs.ptr_g_io_module_new = try_find_sym(glib2, "g_io_module_new");
    stub_funcs.ptr_g_io_modules_scan_all_in_directory = try_find_sym(glib2, "g_io_modules_scan_all_in_directory");
    stub_funcs.ptr_g_io_modules_load_all_in_directory = try_find_sym(glib2, "g_io_modules_load_all_in_directory");
    stub_funcs.ptr_g_io_modules_scan_all_in_directory_with_scope = try_find_sym(glib2, "g_io_modules_scan_all_in_directory_with_scope");
    stub_funcs.ptr_g_io_modules_load_all_in_directory_with_scope = try_find_sym(glib2, "g_io_modules_load_all_in_directory_with_scope");
    stub_funcs.ptr_g_io_extension_point_register = try_find_sym(glib2, "g_io_extension_point_register");
    stub_funcs.ptr_g_io_extension_point_lookup = try_find_sym(glib2, "g_io_extension_point_lookup");
    stub_funcs.ptr_g_io_extension_point_set_required_type = try_find_sym(glib2, "g_io_extension_point_set_required_type");
    stub_funcs.ptr_g_io_extension_point_get_required_type = try_find_sym(glib2, "g_io_extension_point_get_required_type");
    stub_funcs.ptr_g_io_extension_point_get_extensions = try_find_sym(glib2, "g_io_extension_point_get_extensions");
    stub_funcs.ptr_g_io_extension_point_get_extension_by_name = try_find_sym(glib2, "g_io_extension_point_get_extension_by_name");
    stub_funcs.ptr_g_io_extension_point_implement = try_find_sym(glib2, "g_io_extension_point_implement");
    stub_funcs.ptr_g_io_extension_get_type = try_find_sym(glib2, "g_io_extension_get_type");
    stub_funcs.ptr_g_io_extension_get_name = try_find_sym(glib2, "g_io_extension_get_name");
    stub_funcs.ptr_g_io_extension_get_priority = try_find_sym(glib2, "g_io_extension_get_priority");
    stub_funcs.ptr_g_io_extension_ref_class = try_find_sym(glib2, "g_io_extension_ref_class");
    stub_funcs.ptr_g_io_module_load = try_find_sym(glib2, "g_io_module_load");
    stub_funcs.ptr_g_io_module_unload = try_find_sym(glib2, "g_io_module_unload");
    stub_funcs.ptr_g_io_module_query = try_find_sym(glib2, "g_io_module_query");
    stub_funcs.ptr_g_io_scheduler_push_job = try_find_sym(glib2, "g_io_scheduler_push_job");
    stub_funcs.ptr_g_io_scheduler_cancel_all_jobs = try_find_sym(glib2, "g_io_scheduler_cancel_all_jobs");
    stub_funcs.ptr_g_io_scheduler_job_send_to_mainloop = try_find_sym(glib2, "g_io_scheduler_job_send_to_mainloop");
    stub_funcs.ptr_g_io_scheduler_job_send_to_mainloop_async = try_find_sym(glib2, "g_io_scheduler_job_send_to_mainloop_async");
    stub_funcs.ptr_g_list_model_get_type = try_find_sym(glib2, "g_list_model_get_type");
    stub_funcs.ptr_g_list_model_get_item_type = try_find_sym(glib2, "g_list_model_get_item_type");
    stub_funcs.ptr_g_list_model_get_n_items = try_find_sym(glib2, "g_list_model_get_n_items");
    stub_funcs.ptr_g_list_model_get_item = try_find_sym(glib2, "g_list_model_get_item");
    stub_funcs.ptr_g_list_model_get_object = try_find_sym(glib2, "g_list_model_get_object");
    stub_funcs.ptr_g_list_model_items_changed = try_find_sym(glib2, "g_list_model_items_changed");
    stub_funcs.ptr_g_list_store_get_type = try_find_sym(glib2, "g_list_store_get_type");
    stub_funcs.ptr_g_list_store_new = try_find_sym(glib2, "g_list_store_new");
    stub_funcs.ptr_g_list_store_insert = try_find_sym(glib2, "g_list_store_insert");
    stub_funcs.ptr_g_list_store_insert_sorted = try_find_sym(glib2, "g_list_store_insert_sorted");
    stub_funcs.ptr_g_list_store_sort = try_find_sym(glib2, "g_list_store_sort");
    stub_funcs.ptr_g_list_store_append = try_find_sym(glib2, "g_list_store_append");
    stub_funcs.ptr_g_list_store_remove = try_find_sym(glib2, "g_list_store_remove");
    stub_funcs.ptr_g_list_store_remove_all = try_find_sym(glib2, "g_list_store_remove_all");
    stub_funcs.ptr_g_list_store_splice = try_find_sym(glib2, "g_list_store_splice");
    stub_funcs.ptr_g_list_store_find = try_find_sym(glib2, "g_list_store_find");
    stub_funcs.ptr_g_list_store_find_with_equal_func = try_find_sym(glib2, "g_list_store_find_with_equal_func");
    stub_funcs.ptr_g_list_store_find_with_equal_func_full = try_find_sym(glib2, "g_list_store_find_with_equal_func_full");
    stub_funcs.ptr_g_loadable_icon_get_type = try_find_sym(glib2, "g_loadable_icon_get_type");
    stub_funcs.ptr_g_loadable_icon_load = try_find_sym(glib2, "g_loadable_icon_load");
    stub_funcs.ptr_g_loadable_icon_load_async = try_find_sym(glib2, "g_loadable_icon_load_async");
    stub_funcs.ptr_g_loadable_icon_load_finish = try_find_sym(glib2, "g_loadable_icon_load_finish");
    stub_funcs.ptr_g_memory_input_stream_get_type = try_find_sym(glib2, "g_memory_input_stream_get_type");
    stub_funcs.ptr_g_memory_input_stream_new = try_find_sym(glib2, "g_memory_input_stream_new");
    stub_funcs.ptr_g_memory_input_stream_new_from_data = try_find_sym(glib2, "g_memory_input_stream_new_from_data");
    stub_funcs.ptr_g_memory_input_stream_new_from_bytes = try_find_sym(glib2, "g_memory_input_stream_new_from_bytes");
    stub_funcs.ptr_g_memory_input_stream_add_data = try_find_sym(glib2, "g_memory_input_stream_add_data");
    stub_funcs.ptr_g_memory_input_stream_add_bytes = try_find_sym(glib2, "g_memory_input_stream_add_bytes");
    stub_funcs.ptr_g_memory_monitor_get_type = try_find_sym(glib2, "g_memory_monitor_get_type");
    stub_funcs.ptr_g_memory_monitor_dup_default = try_find_sym(glib2, "g_memory_monitor_dup_default");
    stub_funcs.ptr_g_memory_output_stream_get_type = try_find_sym(glib2, "g_memory_output_stream_get_type");
    stub_funcs.ptr_g_memory_output_stream_new = try_find_sym(glib2, "g_memory_output_stream_new");
    stub_funcs.ptr_g_memory_output_stream_new_resizable = try_find_sym(glib2, "g_memory_output_stream_new_resizable");
    stub_funcs.ptr_g_memory_output_stream_get_data = try_find_sym(glib2, "g_memory_output_stream_get_data");
    stub_funcs.ptr_g_memory_output_stream_get_size = try_find_sym(glib2, "g_memory_output_stream_get_size");
    stub_funcs.ptr_g_memory_output_stream_get_data_size = try_find_sym(glib2, "g_memory_output_stream_get_data_size");
    stub_funcs.ptr_g_memory_output_stream_steal_data = try_find_sym(glib2, "g_memory_output_stream_steal_data");
    stub_funcs.ptr_g_memory_output_stream_steal_as_bytes = try_find_sym(glib2, "g_memory_output_stream_steal_as_bytes");
    stub_funcs.ptr_g_menu_model_get_type = try_find_sym(glib2, "g_menu_model_get_type");
    stub_funcs.ptr_g_menu_model_is_mutable = try_find_sym(glib2, "g_menu_model_is_mutable");
    stub_funcs.ptr_g_menu_model_get_n_items = try_find_sym(glib2, "g_menu_model_get_n_items");
    stub_funcs.ptr_g_menu_model_iterate_item_attributes = try_find_sym(glib2, "g_menu_model_iterate_item_attributes");
    stub_funcs.ptr_g_menu_model_get_item_attribute_value = try_find_sym(glib2, "g_menu_model_get_item_attribute_value");
    stub_funcs.ptr_g_menu_model_iterate_item_links = try_find_sym(glib2, "g_menu_model_iterate_item_links");
    stub_funcs.ptr_g_menu_model_get_item_link = try_find_sym(glib2, "g_menu_model_get_item_link");
    stub_funcs.ptr_g_menu_model_items_changed = try_find_sym(glib2, "g_menu_model_items_changed");
    stub_funcs.ptr_g_menu_attribute_iter_get_type = try_find_sym(glib2, "g_menu_attribute_iter_get_type");
    stub_funcs.ptr_g_menu_attribute_iter_get_next = try_find_sym(glib2, "g_menu_attribute_iter_get_next");
    stub_funcs.ptr_g_menu_attribute_iter_next = try_find_sym(glib2, "g_menu_attribute_iter_next");
    stub_funcs.ptr_g_menu_attribute_iter_get_name = try_find_sym(glib2, "g_menu_attribute_iter_get_name");
    stub_funcs.ptr_g_menu_attribute_iter_get_value = try_find_sym(glib2, "g_menu_attribute_iter_get_value");
    stub_funcs.ptr_g_menu_link_iter_get_type = try_find_sym(glib2, "g_menu_link_iter_get_type");
    stub_funcs.ptr_g_menu_link_iter_get_next = try_find_sym(glib2, "g_menu_link_iter_get_next");
    stub_funcs.ptr_g_menu_link_iter_next = try_find_sym(glib2, "g_menu_link_iter_next");
    stub_funcs.ptr_g_menu_link_iter_get_name = try_find_sym(glib2, "g_menu_link_iter_get_name");
    stub_funcs.ptr_g_menu_link_iter_get_value = try_find_sym(glib2, "g_menu_link_iter_get_value");
    stub_funcs.ptr_g_menu_get_type = try_find_sym(glib2, "g_menu_get_type");
    stub_funcs.ptr_g_menu_new = try_find_sym(glib2, "g_menu_new");
    stub_funcs.ptr_g_menu_freeze = try_find_sym(glib2, "g_menu_freeze");
    stub_funcs.ptr_g_menu_insert_item = try_find_sym(glib2, "g_menu_insert_item");
    stub_funcs.ptr_g_menu_prepend_item = try_find_sym(glib2, "g_menu_prepend_item");
    stub_funcs.ptr_g_menu_append_item = try_find_sym(glib2, "g_menu_append_item");
    stub_funcs.ptr_g_menu_remove = try_find_sym(glib2, "g_menu_remove");
    stub_funcs.ptr_g_menu_remove_all = try_find_sym(glib2, "g_menu_remove_all");
    stub_funcs.ptr_g_menu_insert = try_find_sym(glib2, "g_menu_insert");
    stub_funcs.ptr_g_menu_prepend = try_find_sym(glib2, "g_menu_prepend");
    stub_funcs.ptr_g_menu_append = try_find_sym(glib2, "g_menu_append");
    stub_funcs.ptr_g_menu_insert_section = try_find_sym(glib2, "g_menu_insert_section");
    stub_funcs.ptr_g_menu_prepend_section = try_find_sym(glib2, "g_menu_prepend_section");
    stub_funcs.ptr_g_menu_append_section = try_find_sym(glib2, "g_menu_append_section");
    stub_funcs.ptr_g_menu_insert_submenu = try_find_sym(glib2, "g_menu_insert_submenu");
    stub_funcs.ptr_g_menu_prepend_submenu = try_find_sym(glib2, "g_menu_prepend_submenu");
    stub_funcs.ptr_g_menu_append_submenu = try_find_sym(glib2, "g_menu_append_submenu");
    stub_funcs.ptr_g_menu_item_get_type = try_find_sym(glib2, "g_menu_item_get_type");
    stub_funcs.ptr_g_menu_item_new = try_find_sym(glib2, "g_menu_item_new");
    stub_funcs.ptr_g_menu_item_new_from_model = try_find_sym(glib2, "g_menu_item_new_from_model");
    stub_funcs.ptr_g_menu_item_new_submenu = try_find_sym(glib2, "g_menu_item_new_submenu");
    stub_funcs.ptr_g_menu_item_new_section = try_find_sym(glib2, "g_menu_item_new_section");
    stub_funcs.ptr_g_menu_item_get_attribute_value = try_find_sym(glib2, "g_menu_item_get_attribute_value");
    stub_funcs.ptr_g_menu_item_get_link = try_find_sym(glib2, "g_menu_item_get_link");
    stub_funcs.ptr_g_menu_item_set_attribute_value = try_find_sym(glib2, "g_menu_item_set_attribute_value");
    stub_funcs.ptr_g_menu_item_set_link = try_find_sym(glib2, "g_menu_item_set_link");
    stub_funcs.ptr_g_menu_item_set_label = try_find_sym(glib2, "g_menu_item_set_label");
    stub_funcs.ptr_g_menu_item_set_submenu = try_find_sym(glib2, "g_menu_item_set_submenu");
    stub_funcs.ptr_g_menu_item_set_section = try_find_sym(glib2, "g_menu_item_set_section");
    stub_funcs.ptr_g_menu_item_set_action_and_target_value = try_find_sym(glib2, "g_menu_item_set_action_and_target_value");
    stub_funcs.ptr_g_menu_item_set_detailed_action = try_find_sym(glib2, "g_menu_item_set_detailed_action");
    stub_funcs.ptr_g_menu_item_set_icon = try_find_sym(glib2, "g_menu_item_set_icon");
    stub_funcs.ptr_g_dbus_connection_export_menu_model = try_find_sym(glib2, "g_dbus_connection_export_menu_model");
    stub_funcs.ptr_g_dbus_connection_unexport_menu_model = try_find_sym(glib2, "g_dbus_connection_unexport_menu_model");
    stub_funcs.ptr_g_mount_get_type = try_find_sym(glib2, "g_mount_get_type");
    stub_funcs.ptr_g_mount_get_root = try_find_sym(glib2, "g_mount_get_root");
    stub_funcs.ptr_g_mount_get_default_location = try_find_sym(glib2, "g_mount_get_default_location");
    stub_funcs.ptr_g_mount_get_name = try_find_sym(glib2, "g_mount_get_name");
    stub_funcs.ptr_g_mount_get_icon = try_find_sym(glib2, "g_mount_get_icon");
    stub_funcs.ptr_g_mount_get_symbolic_icon = try_find_sym(glib2, "g_mount_get_symbolic_icon");
    stub_funcs.ptr_g_mount_get_uuid = try_find_sym(glib2, "g_mount_get_uuid");
    stub_funcs.ptr_g_mount_get_volume = try_find_sym(glib2, "g_mount_get_volume");
    stub_funcs.ptr_g_mount_get_drive = try_find_sym(glib2, "g_mount_get_drive");
    stub_funcs.ptr_g_mount_can_unmount = try_find_sym(glib2, "g_mount_can_unmount");
    stub_funcs.ptr_g_mount_can_eject = try_find_sym(glib2, "g_mount_can_eject");
    stub_funcs.ptr_g_mount_unmount = try_find_sym(glib2, "g_mount_unmount");
    stub_funcs.ptr_g_mount_unmount_finish = try_find_sym(glib2, "g_mount_unmount_finish");
    stub_funcs.ptr_g_mount_eject = try_find_sym(glib2, "g_mount_eject");
    stub_funcs.ptr_g_mount_eject_finish = try_find_sym(glib2, "g_mount_eject_finish");
    stub_funcs.ptr_g_mount_remount = try_find_sym(glib2, "g_mount_remount");
    stub_funcs.ptr_g_mount_remount_finish = try_find_sym(glib2, "g_mount_remount_finish");
    stub_funcs.ptr_g_mount_guess_content_type = try_find_sym(glib2, "g_mount_guess_content_type");
    stub_funcs.ptr_g_mount_guess_content_type_finish = try_find_sym(glib2, "g_mount_guess_content_type_finish");
    stub_funcs.ptr_g_mount_guess_content_type_sync = try_find_sym(glib2, "g_mount_guess_content_type_sync");
    stub_funcs.ptr_g_mount_is_shadowed = try_find_sym(glib2, "g_mount_is_shadowed");
    stub_funcs.ptr_g_mount_shadow = try_find_sym(glib2, "g_mount_shadow");
    stub_funcs.ptr_g_mount_unshadow = try_find_sym(glib2, "g_mount_unshadow");
    stub_funcs.ptr_g_mount_unmount_with_operation = try_find_sym(glib2, "g_mount_unmount_with_operation");
    stub_funcs.ptr_g_mount_unmount_with_operation_finish = try_find_sym(glib2, "g_mount_unmount_with_operation_finish");
    stub_funcs.ptr_g_mount_eject_with_operation = try_find_sym(glib2, "g_mount_eject_with_operation");
    stub_funcs.ptr_g_mount_eject_with_operation_finish = try_find_sym(glib2, "g_mount_eject_with_operation_finish");
    stub_funcs.ptr_g_mount_get_sort_key = try_find_sym(glib2, "g_mount_get_sort_key");
    stub_funcs.ptr_g_mount_operation_get_type = try_find_sym(glib2, "g_mount_operation_get_type");
    stub_funcs.ptr_g_mount_operation_new = try_find_sym(glib2, "g_mount_operation_new");
    stub_funcs.ptr_g_mount_operation_get_username = try_find_sym(glib2, "g_mount_operation_get_username");
    stub_funcs.ptr_g_mount_operation_set_username = try_find_sym(glib2, "g_mount_operation_set_username");
    stub_funcs.ptr_g_mount_operation_get_password = try_find_sym(glib2, "g_mount_operation_get_password");
    stub_funcs.ptr_g_mount_operation_set_password = try_find_sym(glib2, "g_mount_operation_set_password");
    stub_funcs.ptr_g_mount_operation_get_anonymous = try_find_sym(glib2, "g_mount_operation_get_anonymous");
    stub_funcs.ptr_g_mount_operation_set_anonymous = try_find_sym(glib2, "g_mount_operation_set_anonymous");
    stub_funcs.ptr_g_mount_operation_get_domain = try_find_sym(glib2, "g_mount_operation_get_domain");
    stub_funcs.ptr_g_mount_operation_set_domain = try_find_sym(glib2, "g_mount_operation_set_domain");
    stub_funcs.ptr_g_mount_operation_get_password_save = try_find_sym(glib2, "g_mount_operation_get_password_save");
    stub_funcs.ptr_g_mount_operation_set_password_save = try_find_sym(glib2, "g_mount_operation_set_password_save");
    stub_funcs.ptr_g_mount_operation_get_choice = try_find_sym(glib2, "g_mount_operation_get_choice");
    stub_funcs.ptr_g_mount_operation_set_choice = try_find_sym(glib2, "g_mount_operation_set_choice");
    stub_funcs.ptr_g_mount_operation_reply = try_find_sym(glib2, "g_mount_operation_reply");
    stub_funcs.ptr_g_mount_operation_get_is_tcrypt_hidden_volume = try_find_sym(glib2, "g_mount_operation_get_is_tcrypt_hidden_volume");
    stub_funcs.ptr_g_mount_operation_set_is_tcrypt_hidden_volume = try_find_sym(glib2, "g_mount_operation_set_is_tcrypt_hidden_volume");
    stub_funcs.ptr_g_mount_operation_get_is_tcrypt_system_volume = try_find_sym(glib2, "g_mount_operation_get_is_tcrypt_system_volume");
    stub_funcs.ptr_g_mount_operation_set_is_tcrypt_system_volume = try_find_sym(glib2, "g_mount_operation_set_is_tcrypt_system_volume");
    stub_funcs.ptr_g_mount_operation_get_pim = try_find_sym(glib2, "g_mount_operation_get_pim");
    stub_funcs.ptr_g_mount_operation_set_pim = try_find_sym(glib2, "g_mount_operation_set_pim");
    stub_funcs.ptr_g_native_socket_address_get_type = try_find_sym(glib2, "g_native_socket_address_get_type");
    stub_funcs.ptr_g_native_socket_address_new = try_find_sym(glib2, "g_native_socket_address_new");
    stub_funcs.ptr_g_volume_monitor_get_type = try_find_sym(glib2, "g_volume_monitor_get_type");
    stub_funcs.ptr_g_volume_monitor_get = try_find_sym(glib2, "g_volume_monitor_get");
    stub_funcs.ptr_g_volume_monitor_get_connected_drives = try_find_sym(glib2, "g_volume_monitor_get_connected_drives");
    stub_funcs.ptr_g_volume_monitor_get_volumes = try_find_sym(glib2, "g_volume_monitor_get_volumes");
    stub_funcs.ptr_g_volume_monitor_get_mounts = try_find_sym(glib2, "g_volume_monitor_get_mounts");
    stub_funcs.ptr_g_volume_monitor_get_volume_for_uuid = try_find_sym(glib2, "g_volume_monitor_get_volume_for_uuid");
    stub_funcs.ptr_g_volume_monitor_get_mount_for_uuid = try_find_sym(glib2, "g_volume_monitor_get_mount_for_uuid");
    stub_funcs.ptr_g_volume_monitor_adopt_orphan_mount = try_find_sym(glib2, "g_volume_monitor_adopt_orphan_mount");
    stub_funcs.ptr_g_native_volume_monitor_get_type = try_find_sym(glib2, "g_native_volume_monitor_get_type");
    stub_funcs.ptr_g_network_address_get_type = try_find_sym(glib2, "g_network_address_get_type");
    stub_funcs.ptr_g_network_address_new = try_find_sym(glib2, "g_network_address_new");
    stub_funcs.ptr_g_network_address_new_loopback = try_find_sym(glib2, "g_network_address_new_loopback");
    stub_funcs.ptr_g_network_address_parse = try_find_sym(glib2, "g_network_address_parse");
    stub_funcs.ptr_g_network_address_parse_uri = try_find_sym(glib2, "g_network_address_parse_uri");
    stub_funcs.ptr_g_network_address_get_hostname = try_find_sym(glib2, "g_network_address_get_hostname");
    stub_funcs.ptr_g_network_address_get_port = try_find_sym(glib2, "g_network_address_get_port");
    stub_funcs.ptr_g_network_address_get_scheme = try_find_sym(glib2, "g_network_address_get_scheme");
    stub_funcs.ptr_g_network_monitor_get_type = try_find_sym(glib2, "g_network_monitor_get_type");
    stub_funcs.ptr_g_network_monitor_get_default = try_find_sym(glib2, "g_network_monitor_get_default");
    stub_funcs.ptr_g_network_monitor_get_network_available = try_find_sym(glib2, "g_network_monitor_get_network_available");
    stub_funcs.ptr_g_network_monitor_get_network_metered = try_find_sym(glib2, "g_network_monitor_get_network_metered");
    stub_funcs.ptr_g_network_monitor_get_connectivity = try_find_sym(glib2, "g_network_monitor_get_connectivity");
    stub_funcs.ptr_g_network_monitor_can_reach = try_find_sym(glib2, "g_network_monitor_can_reach");
    stub_funcs.ptr_g_network_monitor_can_reach_async = try_find_sym(glib2, "g_network_monitor_can_reach_async");
    stub_funcs.ptr_g_network_monitor_can_reach_finish = try_find_sym(glib2, "g_network_monitor_can_reach_finish");
    stub_funcs.ptr_g_network_service_get_type = try_find_sym(glib2, "g_network_service_get_type");
    stub_funcs.ptr_g_network_service_new = try_find_sym(glib2, "g_network_service_new");
    stub_funcs.ptr_g_network_service_get_service = try_find_sym(glib2, "g_network_service_get_service");
    stub_funcs.ptr_g_network_service_get_protocol = try_find_sym(glib2, "g_network_service_get_protocol");
    stub_funcs.ptr_g_network_service_get_domain = try_find_sym(glib2, "g_network_service_get_domain");
    stub_funcs.ptr_g_network_service_get_scheme = try_find_sym(glib2, "g_network_service_get_scheme");
    stub_funcs.ptr_g_network_service_set_scheme = try_find_sym(glib2, "g_network_service_set_scheme");
    stub_funcs.ptr_g_notification_get_type = try_find_sym(glib2, "g_notification_get_type");
    stub_funcs.ptr_g_notification_new = try_find_sym(glib2, "g_notification_new");
    stub_funcs.ptr_g_notification_set_title = try_find_sym(glib2, "g_notification_set_title");
    stub_funcs.ptr_g_notification_set_body = try_find_sym(glib2, "g_notification_set_body");
    stub_funcs.ptr_g_notification_set_icon = try_find_sym(glib2, "g_notification_set_icon");
    stub_funcs.ptr_g_notification_set_urgent = try_find_sym(glib2, "g_notification_set_urgent");
    stub_funcs.ptr_g_notification_set_priority = try_find_sym(glib2, "g_notification_set_priority");
    stub_funcs.ptr_g_notification_set_category = try_find_sym(glib2, "g_notification_set_category");
    stub_funcs.ptr_g_notification_add_button = try_find_sym(glib2, "g_notification_add_button");
    stub_funcs.ptr_g_notification_add_button_with_target_value = try_find_sym(glib2, "g_notification_add_button_with_target_value");
    stub_funcs.ptr_g_notification_set_default_action = try_find_sym(glib2, "g_notification_set_default_action");
    stub_funcs.ptr_g_notification_set_default_action_and_target_value = try_find_sym(glib2, "g_notification_set_default_action_and_target_value");
    stub_funcs.ptr_g_permission_get_type = try_find_sym(glib2, "g_permission_get_type");
    stub_funcs.ptr_g_permission_acquire = try_find_sym(glib2, "g_permission_acquire");
    stub_funcs.ptr_g_permission_acquire_async = try_find_sym(glib2, "g_permission_acquire_async");
    stub_funcs.ptr_g_permission_acquire_finish = try_find_sym(glib2, "g_permission_acquire_finish");
    stub_funcs.ptr_g_permission_release = try_find_sym(glib2, "g_permission_release");
    stub_funcs.ptr_g_permission_release_async = try_find_sym(glib2, "g_permission_release_async");
    stub_funcs.ptr_g_permission_release_finish = try_find_sym(glib2, "g_permission_release_finish");
    stub_funcs.ptr_g_permission_get_allowed = try_find_sym(glib2, "g_permission_get_allowed");
    stub_funcs.ptr_g_permission_get_can_acquire = try_find_sym(glib2, "g_permission_get_can_acquire");
    stub_funcs.ptr_g_permission_get_can_release = try_find_sym(glib2, "g_permission_get_can_release");
    stub_funcs.ptr_g_permission_impl_update = try_find_sym(glib2, "g_permission_impl_update");
    stub_funcs.ptr_g_pollable_input_stream_get_type = try_find_sym(glib2, "g_pollable_input_stream_get_type");
    stub_funcs.ptr_g_pollable_input_stream_can_poll = try_find_sym(glib2, "g_pollable_input_stream_can_poll");
    stub_funcs.ptr_g_pollable_input_stream_is_readable = try_find_sym(glib2, "g_pollable_input_stream_is_readable");
    stub_funcs.ptr_g_pollable_input_stream_create_source = try_find_sym(glib2, "g_pollable_input_stream_create_source");
    stub_funcs.ptr_g_pollable_input_stream_read_nonblocking = try_find_sym(glib2, "g_pollable_input_stream_read_nonblocking");
    stub_funcs.ptr_g_pollable_output_stream_get_type = try_find_sym(glib2, "g_pollable_output_stream_get_type");
    stub_funcs.ptr_g_pollable_output_stream_can_poll = try_find_sym(glib2, "g_pollable_output_stream_can_poll");
    stub_funcs.ptr_g_pollable_output_stream_is_writable = try_find_sym(glib2, "g_pollable_output_stream_is_writable");
    stub_funcs.ptr_g_pollable_output_stream_create_source = try_find_sym(glib2, "g_pollable_output_stream_create_source");
    stub_funcs.ptr_g_pollable_output_stream_write_nonblocking = try_find_sym(glib2, "g_pollable_output_stream_write_nonblocking");
    stub_funcs.ptr_g_pollable_output_stream_writev_nonblocking = try_find_sym(glib2, "g_pollable_output_stream_writev_nonblocking");
    stub_funcs.ptr_g_pollable_source_new = try_find_sym(glib2, "g_pollable_source_new");
    stub_funcs.ptr_g_pollable_source_new_full = try_find_sym(glib2, "g_pollable_source_new_full");
    stub_funcs.ptr_g_pollable_stream_read = try_find_sym(glib2, "g_pollable_stream_read");
    stub_funcs.ptr_g_pollable_stream_write = try_find_sym(glib2, "g_pollable_stream_write");
    stub_funcs.ptr_g_pollable_stream_write_all = try_find_sym(glib2, "g_pollable_stream_write_all");
    stub_funcs.ptr_g_power_profile_monitor_get_type = try_find_sym(glib2, "g_power_profile_monitor_get_type");
    stub_funcs.ptr_g_power_profile_monitor_dup_default = try_find_sym(glib2, "g_power_profile_monitor_dup_default");
    stub_funcs.ptr_g_power_profile_monitor_get_power_saver_enabled = try_find_sym(glib2, "g_power_profile_monitor_get_power_saver_enabled");
    stub_funcs.ptr_g_property_action_get_type = try_find_sym(glib2, "g_property_action_get_type");
    stub_funcs.ptr_g_property_action_new = try_find_sym(glib2, "g_property_action_new");
    stub_funcs.ptr_g_proxy_get_type = try_find_sym(glib2, "g_proxy_get_type");
    stub_funcs.ptr_g_proxy_get_default_for_protocol = try_find_sym(glib2, "g_proxy_get_default_for_protocol");
    stub_funcs.ptr_g_proxy_connect = try_find_sym(glib2, "g_proxy_connect");
    stub_funcs.ptr_g_proxy_connect_async = try_find_sym(glib2, "g_proxy_connect_async");
    stub_funcs.ptr_g_proxy_connect_finish = try_find_sym(glib2, "g_proxy_connect_finish");
    stub_funcs.ptr_g_proxy_supports_hostname = try_find_sym(glib2, "g_proxy_supports_hostname");
    stub_funcs.ptr_g_proxy_address_get_type = try_find_sym(glib2, "g_proxy_address_get_type");
    stub_funcs.ptr_g_proxy_address_new = try_find_sym(glib2, "g_proxy_address_new");
    stub_funcs.ptr_g_proxy_address_get_protocol = try_find_sym(glib2, "g_proxy_address_get_protocol");
    stub_funcs.ptr_g_proxy_address_get_destination_protocol = try_find_sym(glib2, "g_proxy_address_get_destination_protocol");
    stub_funcs.ptr_g_proxy_address_get_destination_hostname = try_find_sym(glib2, "g_proxy_address_get_destination_hostname");
    stub_funcs.ptr_g_proxy_address_get_destination_port = try_find_sym(glib2, "g_proxy_address_get_destination_port");
    stub_funcs.ptr_g_proxy_address_get_username = try_find_sym(glib2, "g_proxy_address_get_username");
    stub_funcs.ptr_g_proxy_address_get_password = try_find_sym(glib2, "g_proxy_address_get_password");
    stub_funcs.ptr_g_proxy_address_get_uri = try_find_sym(glib2, "g_proxy_address_get_uri");
    stub_funcs.ptr_g_socket_address_enumerator_get_type = try_find_sym(glib2, "g_socket_address_enumerator_get_type");
    stub_funcs.ptr_g_socket_address_enumerator_next = try_find_sym(glib2, "g_socket_address_enumerator_next");
    stub_funcs.ptr_g_socket_address_enumerator_next_async = try_find_sym(glib2, "g_socket_address_enumerator_next_async");
    stub_funcs.ptr_g_socket_address_enumerator_next_finish = try_find_sym(glib2, "g_socket_address_enumerator_next_finish");
    stub_funcs.ptr_g_proxy_address_enumerator_get_type = try_find_sym(glib2, "g_proxy_address_enumerator_get_type");
    stub_funcs.ptr_g_proxy_resolver_get_type = try_find_sym(glib2, "g_proxy_resolver_get_type");
    stub_funcs.ptr_g_proxy_resolver_get_default = try_find_sym(glib2, "g_proxy_resolver_get_default");
    stub_funcs.ptr_g_proxy_resolver_is_supported = try_find_sym(glib2, "g_proxy_resolver_is_supported");
    stub_funcs.ptr_g_proxy_resolver_lookup = try_find_sym(glib2, "g_proxy_resolver_lookup");
    stub_funcs.ptr_g_proxy_resolver_lookup_async = try_find_sym(glib2, "g_proxy_resolver_lookup_async");
    stub_funcs.ptr_g_proxy_resolver_lookup_finish = try_find_sym(glib2, "g_proxy_resolver_lookup_finish");
    stub_funcs.ptr_g_remote_action_group_get_type = try_find_sym(glib2, "g_remote_action_group_get_type");
    stub_funcs.ptr_g_remote_action_group_activate_action_full = try_find_sym(glib2, "g_remote_action_group_activate_action_full");
    stub_funcs.ptr_g_remote_action_group_change_action_state_full = try_find_sym(glib2, "g_remote_action_group_change_action_state_full");
    stub_funcs.ptr_g_resolver_get_type = try_find_sym(glib2, "g_resolver_get_type");
    stub_funcs.ptr_g_resolver_get_default = try_find_sym(glib2, "g_resolver_get_default");
    stub_funcs.ptr_g_resolver_set_default = try_find_sym(glib2, "g_resolver_set_default");
    stub_funcs.ptr_g_resolver_lookup_by_name = try_find_sym(glib2, "g_resolver_lookup_by_name");
    stub_funcs.ptr_g_resolver_lookup_by_name_async = try_find_sym(glib2, "g_resolver_lookup_by_name_async");
    stub_funcs.ptr_g_resolver_lookup_by_name_finish = try_find_sym(glib2, "g_resolver_lookup_by_name_finish");
    stub_funcs.ptr_g_resolver_lookup_by_name_with_flags_async = try_find_sym(glib2, "g_resolver_lookup_by_name_with_flags_async");
    stub_funcs.ptr_g_resolver_lookup_by_name_with_flags_finish = try_find_sym(glib2, "g_resolver_lookup_by_name_with_flags_finish");
    stub_funcs.ptr_g_resolver_lookup_by_name_with_flags = try_find_sym(glib2, "g_resolver_lookup_by_name_with_flags");
    stub_funcs.ptr_g_resolver_free_addresses = try_find_sym(glib2, "g_resolver_free_addresses");
    stub_funcs.ptr_g_resolver_lookup_by_address = try_find_sym(glib2, "g_resolver_lookup_by_address");
    stub_funcs.ptr_g_resolver_lookup_by_address_async = try_find_sym(glib2, "g_resolver_lookup_by_address_async");
    stub_funcs.ptr_g_resolver_lookup_by_address_finish = try_find_sym(glib2, "g_resolver_lookup_by_address_finish");
    stub_funcs.ptr_g_resolver_lookup_service = try_find_sym(glib2, "g_resolver_lookup_service");
    stub_funcs.ptr_g_resolver_lookup_service_async = try_find_sym(glib2, "g_resolver_lookup_service_async");
    stub_funcs.ptr_g_resolver_lookup_service_finish = try_find_sym(glib2, "g_resolver_lookup_service_finish");
    stub_funcs.ptr_g_resolver_lookup_records = try_find_sym(glib2, "g_resolver_lookup_records");
    stub_funcs.ptr_g_resolver_lookup_records_async = try_find_sym(glib2, "g_resolver_lookup_records_async");
    stub_funcs.ptr_g_resolver_lookup_records_finish = try_find_sym(glib2, "g_resolver_lookup_records_finish");
    stub_funcs.ptr_g_resolver_free_targets = try_find_sym(glib2, "g_resolver_free_targets");
    stub_funcs.ptr_g_resolver_get_timeout = try_find_sym(glib2, "g_resolver_get_timeout");
    stub_funcs.ptr_g_resolver_set_timeout = try_find_sym(glib2, "g_resolver_set_timeout");
    stub_funcs.ptr_g_resolver_error_quark = try_find_sym(glib2, "g_resolver_error_quark");
    stub_funcs.ptr_g_resource_error_quark = try_find_sym(glib2, "g_resource_error_quark");
    stub_funcs.ptr_g_resource_get_type = try_find_sym(glib2, "g_resource_get_type");
    stub_funcs.ptr_g_resource_new_from_data = try_find_sym(glib2, "g_resource_new_from_data");
    stub_funcs.ptr_g_resource_ref = try_find_sym(glib2, "g_resource_ref");
    stub_funcs.ptr_g_resource_unref = try_find_sym(glib2, "g_resource_unref");
    stub_funcs.ptr_g_resource_load = try_find_sym(glib2, "g_resource_load");
    stub_funcs.ptr_g_resource_open_stream = try_find_sym(glib2, "g_resource_open_stream");
    stub_funcs.ptr_g_resource_lookup_data = try_find_sym(glib2, "g_resource_lookup_data");
    stub_funcs.ptr_g_resource_enumerate_children = try_find_sym(glib2, "g_resource_enumerate_children");
    stub_funcs.ptr_g_resource_get_info = try_find_sym(glib2, "g_resource_get_info");
    stub_funcs.ptr_g_resources_register = try_find_sym(glib2, "g_resources_register");
    stub_funcs.ptr_g_resources_unregister = try_find_sym(glib2, "g_resources_unregister");
    stub_funcs.ptr_g_resources_open_stream = try_find_sym(glib2, "g_resources_open_stream");
    stub_funcs.ptr_g_resources_lookup_data = try_find_sym(glib2, "g_resources_lookup_data");
    stub_funcs.ptr_g_resources_enumerate_children = try_find_sym(glib2, "g_resources_enumerate_children");
    stub_funcs.ptr_g_resources_get_info = try_find_sym(glib2, "g_resources_get_info");
    stub_funcs.ptr_g_static_resource_init = try_find_sym(glib2, "g_static_resource_init");
    stub_funcs.ptr_g_static_resource_fini = try_find_sym(glib2, "g_static_resource_fini");
    stub_funcs.ptr_g_static_resource_get_resource = try_find_sym(glib2, "g_static_resource_get_resource");
    stub_funcs.ptr_g_seekable_get_type = try_find_sym(glib2, "g_seekable_get_type");
    stub_funcs.ptr_g_seekable_tell = try_find_sym(glib2, "g_seekable_tell");
    stub_funcs.ptr_g_seekable_can_seek = try_find_sym(glib2, "g_seekable_can_seek");
    stub_funcs.ptr_g_seekable_seek = try_find_sym(glib2, "g_seekable_seek");
    stub_funcs.ptr_g_seekable_can_truncate = try_find_sym(glib2, "g_seekable_can_truncate");
    stub_funcs.ptr_g_seekable_truncate = try_find_sym(glib2, "g_seekable_truncate");
    stub_funcs.ptr_g_settings_schema_source_get_type = try_find_sym(glib2, "g_settings_schema_source_get_type");
    stub_funcs.ptr_g_settings_schema_source_get_default = try_find_sym(glib2, "g_settings_schema_source_get_default");
    stub_funcs.ptr_g_settings_schema_source_ref = try_find_sym(glib2, "g_settings_schema_source_ref");
    stub_funcs.ptr_g_settings_schema_source_unref = try_find_sym(glib2, "g_settings_schema_source_unref");
    stub_funcs.ptr_g_settings_schema_source_new_from_directory = try_find_sym(glib2, "g_settings_schema_source_new_from_directory");
    stub_funcs.ptr_g_settings_schema_source_lookup = try_find_sym(glib2, "g_settings_schema_source_lookup");
    stub_funcs.ptr_g_settings_schema_source_list_schemas = try_find_sym(glib2, "g_settings_schema_source_list_schemas");
    stub_funcs.ptr_g_settings_schema_get_type = try_find_sym(glib2, "g_settings_schema_get_type");
    stub_funcs.ptr_g_settings_schema_ref = try_find_sym(glib2, "g_settings_schema_ref");
    stub_funcs.ptr_g_settings_schema_unref = try_find_sym(glib2, "g_settings_schema_unref");
    stub_funcs.ptr_g_settings_schema_get_id = try_find_sym(glib2, "g_settings_schema_get_id");
    stub_funcs.ptr_g_settings_schema_get_path = try_find_sym(glib2, "g_settings_schema_get_path");
    stub_funcs.ptr_g_settings_schema_get_key = try_find_sym(glib2, "g_settings_schema_get_key");
    stub_funcs.ptr_g_settings_schema_has_key = try_find_sym(glib2, "g_settings_schema_has_key");
    stub_funcs.ptr_g_settings_schema_list_keys = try_find_sym(glib2, "g_settings_schema_list_keys");
    stub_funcs.ptr_g_settings_schema_list_children = try_find_sym(glib2, "g_settings_schema_list_children");
    stub_funcs.ptr_g_settings_schema_key_get_type = try_find_sym(glib2, "g_settings_schema_key_get_type");
    stub_funcs.ptr_g_settings_schema_key_ref = try_find_sym(glib2, "g_settings_schema_key_ref");
    stub_funcs.ptr_g_settings_schema_key_unref = try_find_sym(glib2, "g_settings_schema_key_unref");
    stub_funcs.ptr_g_settings_schema_key_get_value_type = try_find_sym(glib2, "g_settings_schema_key_get_value_type");
    stub_funcs.ptr_g_settings_schema_key_get_default_value = try_find_sym(glib2, "g_settings_schema_key_get_default_value");
    stub_funcs.ptr_g_settings_schema_key_get_range = try_find_sym(glib2, "g_settings_schema_key_get_range");
    stub_funcs.ptr_g_settings_schema_key_range_check = try_find_sym(glib2, "g_settings_schema_key_range_check");
    stub_funcs.ptr_g_settings_schema_key_get_name = try_find_sym(glib2, "g_settings_schema_key_get_name");
    stub_funcs.ptr_g_settings_schema_key_get_summary = try_find_sym(glib2, "g_settings_schema_key_get_summary");
    stub_funcs.ptr_g_settings_schema_key_get_description = try_find_sym(glib2, "g_settings_schema_key_get_description");
    stub_funcs.ptr_g_settings_get_type = try_find_sym(glib2, "g_settings_get_type");
    stub_funcs.ptr_g_settings_list_schemas = try_find_sym(glib2, "g_settings_list_schemas");
    stub_funcs.ptr_g_settings_list_relocatable_schemas = try_find_sym(glib2, "g_settings_list_relocatable_schemas");
    stub_funcs.ptr_g_settings_new = try_find_sym(glib2, "g_settings_new");
    stub_funcs.ptr_g_settings_new_with_path = try_find_sym(glib2, "g_settings_new_with_path");
    stub_funcs.ptr_g_settings_new_with_backend = try_find_sym(glib2, "g_settings_new_with_backend");
    stub_funcs.ptr_g_settings_new_with_backend_and_path = try_find_sym(glib2, "g_settings_new_with_backend_and_path");
    stub_funcs.ptr_g_settings_new_full = try_find_sym(glib2, "g_settings_new_full");
    stub_funcs.ptr_g_settings_list_children = try_find_sym(glib2, "g_settings_list_children");
    stub_funcs.ptr_g_settings_list_keys = try_find_sym(glib2, "g_settings_list_keys");
    stub_funcs.ptr_g_settings_get_range = try_find_sym(glib2, "g_settings_get_range");
    stub_funcs.ptr_g_settings_range_check = try_find_sym(glib2, "g_settings_range_check");
    stub_funcs.ptr_g_settings_set_value = try_find_sym(glib2, "g_settings_set_value");
    stub_funcs.ptr_g_settings_get_value = try_find_sym(glib2, "g_settings_get_value");
    stub_funcs.ptr_g_settings_get_user_value = try_find_sym(glib2, "g_settings_get_user_value");
    stub_funcs.ptr_g_settings_get_default_value = try_find_sym(glib2, "g_settings_get_default_value");
    stub_funcs.ptr_g_settings_reset = try_find_sym(glib2, "g_settings_reset");
    stub_funcs.ptr_g_settings_get_int = try_find_sym(glib2, "g_settings_get_int");
    stub_funcs.ptr_g_settings_set_int = try_find_sym(glib2, "g_settings_set_int");
    stub_funcs.ptr_g_settings_get_int64 = try_find_sym(glib2, "g_settings_get_int64");
    stub_funcs.ptr_g_settings_set_int64 = try_find_sym(glib2, "g_settings_set_int64");
    stub_funcs.ptr_g_settings_get_uint = try_find_sym(glib2, "g_settings_get_uint");
    stub_funcs.ptr_g_settings_set_uint = try_find_sym(glib2, "g_settings_set_uint");
    stub_funcs.ptr_g_settings_get_uint64 = try_find_sym(glib2, "g_settings_get_uint64");
    stub_funcs.ptr_g_settings_set_uint64 = try_find_sym(glib2, "g_settings_set_uint64");
    stub_funcs.ptr_g_settings_get_string = try_find_sym(glib2, "g_settings_get_string");
    stub_funcs.ptr_g_settings_set_string = try_find_sym(glib2, "g_settings_set_string");
    stub_funcs.ptr_g_settings_get_boolean = try_find_sym(glib2, "g_settings_get_boolean");
    stub_funcs.ptr_g_settings_set_boolean = try_find_sym(glib2, "g_settings_set_boolean");
    stub_funcs.ptr_g_settings_get_double = try_find_sym(glib2, "g_settings_get_double");
    stub_funcs.ptr_g_settings_set_double = try_find_sym(glib2, "g_settings_set_double");
    stub_funcs.ptr_g_settings_get_strv = try_find_sym(glib2, "g_settings_get_strv");
    stub_funcs.ptr_g_settings_set_strv = try_find_sym(glib2, "g_settings_set_strv");
    stub_funcs.ptr_g_settings_get_enum = try_find_sym(glib2, "g_settings_get_enum");
    stub_funcs.ptr_g_settings_set_enum = try_find_sym(glib2, "g_settings_set_enum");
    stub_funcs.ptr_g_settings_get_flags = try_find_sym(glib2, "g_settings_get_flags");
    stub_funcs.ptr_g_settings_set_flags = try_find_sym(glib2, "g_settings_set_flags");
    stub_funcs.ptr_g_settings_get_child = try_find_sym(glib2, "g_settings_get_child");
    stub_funcs.ptr_g_settings_is_writable = try_find_sym(glib2, "g_settings_is_writable");
    stub_funcs.ptr_g_settings_delay = try_find_sym(glib2, "g_settings_delay");
    stub_funcs.ptr_g_settings_apply = try_find_sym(glib2, "g_settings_apply");
    stub_funcs.ptr_g_settings_revert = try_find_sym(glib2, "g_settings_revert");
    stub_funcs.ptr_g_settings_get_has_unapplied = try_find_sym(glib2, "g_settings_get_has_unapplied");
    stub_funcs.ptr_g_settings_sync = try_find_sym(glib2, "g_settings_sync");
    stub_funcs.ptr_g_settings_bind = try_find_sym(glib2, "g_settings_bind");
    stub_funcs.ptr_g_settings_bind_with_mapping = try_find_sym(glib2, "g_settings_bind_with_mapping");
    stub_funcs.ptr_g_settings_bind_with_mapping_closures = try_find_sym(glib2, "g_settings_bind_with_mapping_closures");
    stub_funcs.ptr_g_settings_bind_writable = try_find_sym(glib2, "g_settings_bind_writable");
    stub_funcs.ptr_g_settings_unbind = try_find_sym(glib2, "g_settings_unbind");
    stub_funcs.ptr_g_settings_create_action = try_find_sym(glib2, "g_settings_create_action");
    stub_funcs.ptr_g_settings_get_mapped = try_find_sym(glib2, "g_settings_get_mapped");
    stub_funcs.ptr_g_simple_action_get_type = try_find_sym(glib2, "g_simple_action_get_type");
    stub_funcs.ptr_g_simple_action_new = try_find_sym(glib2, "g_simple_action_new");
    stub_funcs.ptr_g_simple_action_new_stateful = try_find_sym(glib2, "g_simple_action_new_stateful");
    stub_funcs.ptr_g_simple_action_set_enabled = try_find_sym(glib2, "g_simple_action_set_enabled");
    stub_funcs.ptr_g_simple_action_set_state = try_find_sym(glib2, "g_simple_action_set_state");
    stub_funcs.ptr_g_simple_action_set_state_hint = try_find_sym(glib2, "g_simple_action_set_state_hint");
    stub_funcs.ptr_g_simple_action_group_get_type = try_find_sym(glib2, "g_simple_action_group_get_type");
    stub_funcs.ptr_g_simple_action_group_new = try_find_sym(glib2, "g_simple_action_group_new");
    stub_funcs.ptr_g_simple_action_group_lookup = try_find_sym(glib2, "g_simple_action_group_lookup");
    stub_funcs.ptr_g_simple_action_group_insert = try_find_sym(glib2, "g_simple_action_group_insert");
    stub_funcs.ptr_g_simple_action_group_remove = try_find_sym(glib2, "g_simple_action_group_remove");
    stub_funcs.ptr_g_simple_action_group_add_entries = try_find_sym(glib2, "g_simple_action_group_add_entries");
    stub_funcs.ptr_g_simple_async_result_get_type = try_find_sym(glib2, "g_simple_async_result_get_type");
    stub_funcs.ptr_g_simple_async_result_new = try_find_sym(glib2, "g_simple_async_result_new");
    stub_funcs.ptr_g_simple_async_result_new_from_error = try_find_sym(glib2, "g_simple_async_result_new_from_error");
    stub_funcs.ptr_g_simple_async_result_new_take_error = try_find_sym(glib2, "g_simple_async_result_new_take_error");
    stub_funcs.ptr_g_simple_async_result_set_op_res_gpointer = try_find_sym(glib2, "g_simple_async_result_set_op_res_gpointer");
    stub_funcs.ptr_g_simple_async_result_get_op_res_gpointer = try_find_sym(glib2, "g_simple_async_result_get_op_res_gpointer");
    stub_funcs.ptr_g_simple_async_result_set_op_res_gssize = try_find_sym(glib2, "g_simple_async_result_set_op_res_gssize");
    stub_funcs.ptr_g_simple_async_result_get_op_res_gssize = try_find_sym(glib2, "g_simple_async_result_get_op_res_gssize");
    stub_funcs.ptr_g_simple_async_result_set_op_res_gboolean = try_find_sym(glib2, "g_simple_async_result_set_op_res_gboolean");
    stub_funcs.ptr_g_simple_async_result_get_op_res_gboolean = try_find_sym(glib2, "g_simple_async_result_get_op_res_gboolean");
    stub_funcs.ptr_g_simple_async_result_set_check_cancellable = try_find_sym(glib2, "g_simple_async_result_set_check_cancellable");
    stub_funcs.ptr_g_simple_async_result_get_source_tag = try_find_sym(glib2, "g_simple_async_result_get_source_tag");
    stub_funcs.ptr_g_simple_async_result_set_handle_cancellation = try_find_sym(glib2, "g_simple_async_result_set_handle_cancellation");
    stub_funcs.ptr_g_simple_async_result_complete = try_find_sym(glib2, "g_simple_async_result_complete");
    stub_funcs.ptr_g_simple_async_result_complete_in_idle = try_find_sym(glib2, "g_simple_async_result_complete_in_idle");
    stub_funcs.ptr_g_simple_async_result_run_in_thread = try_find_sym(glib2, "g_simple_async_result_run_in_thread");
    stub_funcs.ptr_g_simple_async_result_set_from_error = try_find_sym(glib2, "g_simple_async_result_set_from_error");
    stub_funcs.ptr_g_simple_async_result_take_error = try_find_sym(glib2, "g_simple_async_result_take_error");
    stub_funcs.ptr_g_simple_async_result_propagate_error = try_find_sym(glib2, "g_simple_async_result_propagate_error");
    stub_funcs.ptr_g_simple_async_result_set_error = try_find_sym(glib2, "g_simple_async_result_set_error");
    stub_funcs.ptr_g_simple_async_result_set_error_va = try_find_sym(glib2, "g_simple_async_result_set_error_va");
    stub_funcs.ptr_g_simple_async_result_is_valid = try_find_sym(glib2, "g_simple_async_result_is_valid");
    stub_funcs.ptr_g_simple_async_report_gerror_in_idle = try_find_sym(glib2, "g_simple_async_report_gerror_in_idle");
    stub_funcs.ptr_g_simple_async_report_take_gerror_in_idle = try_find_sym(glib2, "g_simple_async_report_take_gerror_in_idle");
    stub_funcs.ptr_g_simple_io_stream_get_type = try_find_sym(glib2, "g_simple_io_stream_get_type");
    stub_funcs.ptr_g_simple_io_stream_new = try_find_sym(glib2, "g_simple_io_stream_new");
    stub_funcs.ptr_g_simple_permission_get_type = try_find_sym(glib2, "g_simple_permission_get_type");
    stub_funcs.ptr_g_simple_permission_new = try_find_sym(glib2, "g_simple_permission_new");
    stub_funcs.ptr_g_simple_proxy_resolver_get_type = try_find_sym(glib2, "g_simple_proxy_resolver_get_type");
    stub_funcs.ptr_g_simple_proxy_resolver_new = try_find_sym(glib2, "g_simple_proxy_resolver_new");
    stub_funcs.ptr_g_simple_proxy_resolver_set_default_proxy = try_find_sym(glib2, "g_simple_proxy_resolver_set_default_proxy");
    stub_funcs.ptr_g_simple_proxy_resolver_set_ignore_hosts = try_find_sym(glib2, "g_simple_proxy_resolver_set_ignore_hosts");
    stub_funcs.ptr_g_simple_proxy_resolver_set_uri_proxy = try_find_sym(glib2, "g_simple_proxy_resolver_set_uri_proxy");
    stub_funcs.ptr_g_socket_get_type = try_find_sym(glib2, "g_socket_get_type");
    stub_funcs.ptr_g_socket_new = try_find_sym(glib2, "g_socket_new");
    stub_funcs.ptr_g_socket_new_from_fd = try_find_sym(glib2, "g_socket_new_from_fd");
    stub_funcs.ptr_g_socket_get_fd = try_find_sym(glib2, "g_socket_get_fd");
    stub_funcs.ptr_g_socket_get_family = try_find_sym(glib2, "g_socket_get_family");
    stub_funcs.ptr_g_socket_get_socket_type = try_find_sym(glib2, "g_socket_get_socket_type");
    stub_funcs.ptr_g_socket_get_protocol = try_find_sym(glib2, "g_socket_get_protocol");
    stub_funcs.ptr_g_socket_get_local_address = try_find_sym(glib2, "g_socket_get_local_address");
    stub_funcs.ptr_g_socket_get_remote_address = try_find_sym(glib2, "g_socket_get_remote_address");
    stub_funcs.ptr_g_socket_set_blocking = try_find_sym(glib2, "g_socket_set_blocking");
    stub_funcs.ptr_g_socket_get_blocking = try_find_sym(glib2, "g_socket_get_blocking");
    stub_funcs.ptr_g_socket_set_keepalive = try_find_sym(glib2, "g_socket_set_keepalive");
    stub_funcs.ptr_g_socket_get_keepalive = try_find_sym(glib2, "g_socket_get_keepalive");
    stub_funcs.ptr_g_socket_get_listen_backlog = try_find_sym(glib2, "g_socket_get_listen_backlog");
    stub_funcs.ptr_g_socket_set_listen_backlog = try_find_sym(glib2, "g_socket_set_listen_backlog");
    stub_funcs.ptr_g_socket_get_timeout = try_find_sym(glib2, "g_socket_get_timeout");
    stub_funcs.ptr_g_socket_set_timeout = try_find_sym(glib2, "g_socket_set_timeout");
    stub_funcs.ptr_g_socket_get_ttl = try_find_sym(glib2, "g_socket_get_ttl");
    stub_funcs.ptr_g_socket_set_ttl = try_find_sym(glib2, "g_socket_set_ttl");
    stub_funcs.ptr_g_socket_get_broadcast = try_find_sym(glib2, "g_socket_get_broadcast");
    stub_funcs.ptr_g_socket_set_broadcast = try_find_sym(glib2, "g_socket_set_broadcast");
    stub_funcs.ptr_g_socket_get_multicast_loopback = try_find_sym(glib2, "g_socket_get_multicast_loopback");
    stub_funcs.ptr_g_socket_set_multicast_loopback = try_find_sym(glib2, "g_socket_set_multicast_loopback");
    stub_funcs.ptr_g_socket_get_multicast_ttl = try_find_sym(glib2, "g_socket_get_multicast_ttl");
    stub_funcs.ptr_g_socket_set_multicast_ttl = try_find_sym(glib2, "g_socket_set_multicast_ttl");
    stub_funcs.ptr_g_socket_is_connected = try_find_sym(glib2, "g_socket_is_connected");
    stub_funcs.ptr_g_socket_bind = try_find_sym(glib2, "g_socket_bind");
    stub_funcs.ptr_g_socket_join_multicast_group = try_find_sym(glib2, "g_socket_join_multicast_group");
    stub_funcs.ptr_g_socket_leave_multicast_group = try_find_sym(glib2, "g_socket_leave_multicast_group");
    stub_funcs.ptr_g_socket_join_multicast_group_ssm = try_find_sym(glib2, "g_socket_join_multicast_group_ssm");
    stub_funcs.ptr_g_socket_leave_multicast_group_ssm = try_find_sym(glib2, "g_socket_leave_multicast_group_ssm");
    stub_funcs.ptr_g_socket_connect = try_find_sym(glib2, "g_socket_connect");
    stub_funcs.ptr_g_socket_check_connect_result = try_find_sym(glib2, "g_socket_check_connect_result");
    stub_funcs.ptr_g_socket_get_available_bytes = try_find_sym(glib2, "g_socket_get_available_bytes");
    stub_funcs.ptr_g_socket_condition_check = try_find_sym(glib2, "g_socket_condition_check");
    stub_funcs.ptr_g_socket_condition_wait = try_find_sym(glib2, "g_socket_condition_wait");
    stub_funcs.ptr_g_socket_condition_timed_wait = try_find_sym(glib2, "g_socket_condition_timed_wait");
    stub_funcs.ptr_g_socket_accept = try_find_sym(glib2, "g_socket_accept");
    stub_funcs.ptr_g_socket_listen = try_find_sym(glib2, "g_socket_listen");
    stub_funcs.ptr_g_socket_receive = try_find_sym(glib2, "g_socket_receive");
    stub_funcs.ptr_g_socket_receive_bytes = try_find_sym(glib2, "g_socket_receive_bytes");
    stub_funcs.ptr_g_socket_receive_from = try_find_sym(glib2, "g_socket_receive_from");
    stub_funcs.ptr_g_socket_receive_bytes_from = try_find_sym(glib2, "g_socket_receive_bytes_from");
    stub_funcs.ptr_g_socket_send = try_find_sym(glib2, "g_socket_send");
    stub_funcs.ptr_g_socket_send_to = try_find_sym(glib2, "g_socket_send_to");
    stub_funcs.ptr_g_socket_receive_message = try_find_sym(glib2, "g_socket_receive_message");
    stub_funcs.ptr_g_socket_send_message = try_find_sym(glib2, "g_socket_send_message");
    stub_funcs.ptr_g_socket_receive_messages = try_find_sym(glib2, "g_socket_receive_messages");
    stub_funcs.ptr_g_socket_send_messages = try_find_sym(glib2, "g_socket_send_messages");
    stub_funcs.ptr_g_socket_close = try_find_sym(glib2, "g_socket_close");
    stub_funcs.ptr_g_socket_shutdown = try_find_sym(glib2, "g_socket_shutdown");
    stub_funcs.ptr_g_socket_is_closed = try_find_sym(glib2, "g_socket_is_closed");
    stub_funcs.ptr_g_socket_create_source = try_find_sym(glib2, "g_socket_create_source");
    stub_funcs.ptr_g_socket_speaks_ipv4 = try_find_sym(glib2, "g_socket_speaks_ipv4");
    stub_funcs.ptr_g_socket_get_credentials = try_find_sym(glib2, "g_socket_get_credentials");
    stub_funcs.ptr_g_socket_receive_with_blocking = try_find_sym(glib2, "g_socket_receive_with_blocking");
    stub_funcs.ptr_g_socket_send_with_blocking = try_find_sym(glib2, "g_socket_send_with_blocking");
    stub_funcs.ptr_g_socket_send_message_with_timeout = try_find_sym(glib2, "g_socket_send_message_with_timeout");
    stub_funcs.ptr_g_socket_get_option = try_find_sym(glib2, "g_socket_get_option");
    stub_funcs.ptr_g_socket_set_option = try_find_sym(glib2, "g_socket_set_option");
    stub_funcs.ptr_g_socket_client_get_type = try_find_sym(glib2, "g_socket_client_get_type");
    stub_funcs.ptr_g_socket_client_new = try_find_sym(glib2, "g_socket_client_new");
    stub_funcs.ptr_g_socket_client_get_family = try_find_sym(glib2, "g_socket_client_get_family");
    stub_funcs.ptr_g_socket_client_set_family = try_find_sym(glib2, "g_socket_client_set_family");
    stub_funcs.ptr_g_socket_client_get_socket_type = try_find_sym(glib2, "g_socket_client_get_socket_type");
    stub_funcs.ptr_g_socket_client_set_socket_type = try_find_sym(glib2, "g_socket_client_set_socket_type");
    stub_funcs.ptr_g_socket_client_get_protocol = try_find_sym(glib2, "g_socket_client_get_protocol");
    stub_funcs.ptr_g_socket_client_set_protocol = try_find_sym(glib2, "g_socket_client_set_protocol");
    stub_funcs.ptr_g_socket_client_get_local_address = try_find_sym(glib2, "g_socket_client_get_local_address");
    stub_funcs.ptr_g_socket_client_set_local_address = try_find_sym(glib2, "g_socket_client_set_local_address");
    stub_funcs.ptr_g_socket_client_get_timeout = try_find_sym(glib2, "g_socket_client_get_timeout");
    stub_funcs.ptr_g_socket_client_set_timeout = try_find_sym(glib2, "g_socket_client_set_timeout");
    stub_funcs.ptr_g_socket_client_get_enable_proxy = try_find_sym(glib2, "g_socket_client_get_enable_proxy");
    stub_funcs.ptr_g_socket_client_set_enable_proxy = try_find_sym(glib2, "g_socket_client_set_enable_proxy");
    stub_funcs.ptr_g_socket_client_get_tls = try_find_sym(glib2, "g_socket_client_get_tls");
    stub_funcs.ptr_g_socket_client_set_tls = try_find_sym(glib2, "g_socket_client_set_tls");
    stub_funcs.ptr_g_socket_client_get_tls_validation_flags = try_find_sym(glib2, "g_socket_client_get_tls_validation_flags");
    stub_funcs.ptr_g_socket_client_set_tls_validation_flags = try_find_sym(glib2, "g_socket_client_set_tls_validation_flags");
    stub_funcs.ptr_g_socket_client_get_proxy_resolver = try_find_sym(glib2, "g_socket_client_get_proxy_resolver");
    stub_funcs.ptr_g_socket_client_set_proxy_resolver = try_find_sym(glib2, "g_socket_client_set_proxy_resolver");
    stub_funcs.ptr_g_socket_client_connect = try_find_sym(glib2, "g_socket_client_connect");
    stub_funcs.ptr_g_socket_client_connect_to_host = try_find_sym(glib2, "g_socket_client_connect_to_host");
    stub_funcs.ptr_g_socket_client_connect_to_service = try_find_sym(glib2, "g_socket_client_connect_to_service");
    stub_funcs.ptr_g_socket_client_connect_to_uri = try_find_sym(glib2, "g_socket_client_connect_to_uri");
    stub_funcs.ptr_g_socket_client_connect_async = try_find_sym(glib2, "g_socket_client_connect_async");
    stub_funcs.ptr_g_socket_client_connect_finish = try_find_sym(glib2, "g_socket_client_connect_finish");
    stub_funcs.ptr_g_socket_client_connect_to_host_async = try_find_sym(glib2, "g_socket_client_connect_to_host_async");
    stub_funcs.ptr_g_socket_client_connect_to_host_finish = try_find_sym(glib2, "g_socket_client_connect_to_host_finish");
    stub_funcs.ptr_g_socket_client_connect_to_service_async = try_find_sym(glib2, "g_socket_client_connect_to_service_async");
    stub_funcs.ptr_g_socket_client_connect_to_service_finish = try_find_sym(glib2, "g_socket_client_connect_to_service_finish");
    stub_funcs.ptr_g_socket_client_connect_to_uri_async = try_find_sym(glib2, "g_socket_client_connect_to_uri_async");
    stub_funcs.ptr_g_socket_client_connect_to_uri_finish = try_find_sym(glib2, "g_socket_client_connect_to_uri_finish");
    stub_funcs.ptr_g_socket_client_add_application_proxy = try_find_sym(glib2, "g_socket_client_add_application_proxy");
    stub_funcs.ptr_g_socket_connectable_get_type = try_find_sym(glib2, "g_socket_connectable_get_type");
    stub_funcs.ptr_g_socket_connectable_enumerate = try_find_sym(glib2, "g_socket_connectable_enumerate");
    stub_funcs.ptr_g_socket_connectable_proxy_enumerate = try_find_sym(glib2, "g_socket_connectable_proxy_enumerate");
    stub_funcs.ptr_g_socket_connectable_to_string = try_find_sym(glib2, "g_socket_connectable_to_string");
    stub_funcs.ptr_g_socket_connection_get_type = try_find_sym(glib2, "g_socket_connection_get_type");
    stub_funcs.ptr_g_socket_connection_is_connected = try_find_sym(glib2, "g_socket_connection_is_connected");
    stub_funcs.ptr_g_socket_connection_connect = try_find_sym(glib2, "g_socket_connection_connect");
    stub_funcs.ptr_g_socket_connection_connect_async = try_find_sym(glib2, "g_socket_connection_connect_async");
    stub_funcs.ptr_g_socket_connection_connect_finish = try_find_sym(glib2, "g_socket_connection_connect_finish");
    stub_funcs.ptr_g_socket_connection_get_socket = try_find_sym(glib2, "g_socket_connection_get_socket");
    stub_funcs.ptr_g_socket_connection_get_local_address = try_find_sym(glib2, "g_socket_connection_get_local_address");
    stub_funcs.ptr_g_socket_connection_get_remote_address = try_find_sym(glib2, "g_socket_connection_get_remote_address");
    stub_funcs.ptr_g_socket_connection_factory_register_type = try_find_sym(glib2, "g_socket_connection_factory_register_type");
    stub_funcs.ptr_g_socket_connection_factory_lookup_type = try_find_sym(glib2, "g_socket_connection_factory_lookup_type");
    stub_funcs.ptr_g_socket_connection_factory_create_connection = try_find_sym(glib2, "g_socket_connection_factory_create_connection");
    stub_funcs.ptr_g_socket_control_message_get_type = try_find_sym(glib2, "g_socket_control_message_get_type");
    stub_funcs.ptr_g_socket_control_message_get_size = try_find_sym(glib2, "g_socket_control_message_get_size");
    stub_funcs.ptr_g_socket_control_message_get_level = try_find_sym(glib2, "g_socket_control_message_get_level");
    stub_funcs.ptr_g_socket_control_message_get_msg_type = try_find_sym(glib2, "g_socket_control_message_get_msg_type");
    stub_funcs.ptr_g_socket_control_message_serialize = try_find_sym(glib2, "g_socket_control_message_serialize");
    stub_funcs.ptr_g_socket_control_message_deserialize = try_find_sym(glib2, "g_socket_control_message_deserialize");
    stub_funcs.ptr_g_socket_listener_get_type = try_find_sym(glib2, "g_socket_listener_get_type");
    stub_funcs.ptr_g_socket_listener_new = try_find_sym(glib2, "g_socket_listener_new");
    stub_funcs.ptr_g_socket_listener_set_backlog = try_find_sym(glib2, "g_socket_listener_set_backlog");
    stub_funcs.ptr_g_socket_listener_add_socket = try_find_sym(glib2, "g_socket_listener_add_socket");
    stub_funcs.ptr_g_socket_listener_add_address = try_find_sym(glib2, "g_socket_listener_add_address");
    stub_funcs.ptr_g_socket_listener_add_inet_port = try_find_sym(glib2, "g_socket_listener_add_inet_port");
    stub_funcs.ptr_g_socket_listener_add_any_inet_port = try_find_sym(glib2, "g_socket_listener_add_any_inet_port");
    stub_funcs.ptr_g_socket_listener_accept_socket = try_find_sym(glib2, "g_socket_listener_accept_socket");
    stub_funcs.ptr_g_socket_listener_accept_socket_async = try_find_sym(glib2, "g_socket_listener_accept_socket_async");
    stub_funcs.ptr_g_socket_listener_accept_socket_finish = try_find_sym(glib2, "g_socket_listener_accept_socket_finish");
    stub_funcs.ptr_g_socket_listener_accept = try_find_sym(glib2, "g_socket_listener_accept");
    stub_funcs.ptr_g_socket_listener_accept_async = try_find_sym(glib2, "g_socket_listener_accept_async");
    stub_funcs.ptr_g_socket_listener_accept_finish = try_find_sym(glib2, "g_socket_listener_accept_finish");
    stub_funcs.ptr_g_socket_listener_close = try_find_sym(glib2, "g_socket_listener_close");
    stub_funcs.ptr_g_socket_service_get_type = try_find_sym(glib2, "g_socket_service_get_type");
    stub_funcs.ptr_g_socket_service_new = try_find_sym(glib2, "g_socket_service_new");
    stub_funcs.ptr_g_socket_service_start = try_find_sym(glib2, "g_socket_service_start");
    stub_funcs.ptr_g_socket_service_stop = try_find_sym(glib2, "g_socket_service_stop");
    stub_funcs.ptr_g_socket_service_is_active = try_find_sym(glib2, "g_socket_service_is_active");
    stub_funcs.ptr_g_srv_target_get_type = try_find_sym(glib2, "g_srv_target_get_type");
    stub_funcs.ptr_g_srv_target_new = try_find_sym(glib2, "g_srv_target_new");
    stub_funcs.ptr_g_srv_target_copy = try_find_sym(glib2, "g_srv_target_copy");
    stub_funcs.ptr_g_srv_target_free = try_find_sym(glib2, "g_srv_target_free");
    stub_funcs.ptr_g_srv_target_get_hostname = try_find_sym(glib2, "g_srv_target_get_hostname");
    stub_funcs.ptr_g_srv_target_get_port = try_find_sym(glib2, "g_srv_target_get_port");
    stub_funcs.ptr_g_srv_target_get_priority = try_find_sym(glib2, "g_srv_target_get_priority");
    stub_funcs.ptr_g_srv_target_get_weight = try_find_sym(glib2, "g_srv_target_get_weight");
    stub_funcs.ptr_g_srv_target_list_sort = try_find_sym(glib2, "g_srv_target_list_sort");
    stub_funcs.ptr_g_subprocess_get_type = try_find_sym(glib2, "g_subprocess_get_type");
    stub_funcs.ptr_g_subprocess_newv = try_find_sym(glib2, "g_subprocess_newv");
    stub_funcs.ptr_g_subprocess_get_stdin_pipe = try_find_sym(glib2, "g_subprocess_get_stdin_pipe");
    stub_funcs.ptr_g_subprocess_get_stdout_pipe = try_find_sym(glib2, "g_subprocess_get_stdout_pipe");
    stub_funcs.ptr_g_subprocess_get_stderr_pipe = try_find_sym(glib2, "g_subprocess_get_stderr_pipe");
    stub_funcs.ptr_g_subprocess_get_identifier = try_find_sym(glib2, "g_subprocess_get_identifier");
    stub_funcs.ptr_g_subprocess_send_signal = try_find_sym(glib2, "g_subprocess_send_signal");
    stub_funcs.ptr_g_subprocess_force_exit = try_find_sym(glib2, "g_subprocess_force_exit");
    stub_funcs.ptr_g_subprocess_wait = try_find_sym(glib2, "g_subprocess_wait");
    stub_funcs.ptr_g_subprocess_wait_async = try_find_sym(glib2, "g_subprocess_wait_async");
    stub_funcs.ptr_g_subprocess_wait_finish = try_find_sym(glib2, "g_subprocess_wait_finish");
    stub_funcs.ptr_g_subprocess_wait_check = try_find_sym(glib2, "g_subprocess_wait_check");
    stub_funcs.ptr_g_subprocess_wait_check_async = try_find_sym(glib2, "g_subprocess_wait_check_async");
    stub_funcs.ptr_g_subprocess_wait_check_finish = try_find_sym(glib2, "g_subprocess_wait_check_finish");
    stub_funcs.ptr_g_subprocess_get_status = try_find_sym(glib2, "g_subprocess_get_status");
    stub_funcs.ptr_g_subprocess_get_successful = try_find_sym(glib2, "g_subprocess_get_successful");
    stub_funcs.ptr_g_subprocess_get_if_exited = try_find_sym(glib2, "g_subprocess_get_if_exited");
    stub_funcs.ptr_g_subprocess_get_exit_status = try_find_sym(glib2, "g_subprocess_get_exit_status");
    stub_funcs.ptr_g_subprocess_get_if_signaled = try_find_sym(glib2, "g_subprocess_get_if_signaled");
    stub_funcs.ptr_g_subprocess_get_term_sig = try_find_sym(glib2, "g_subprocess_get_term_sig");
    stub_funcs.ptr_g_subprocess_communicate = try_find_sym(glib2, "g_subprocess_communicate");
    stub_funcs.ptr_g_subprocess_communicate_async = try_find_sym(glib2, "g_subprocess_communicate_async");
    stub_funcs.ptr_g_subprocess_communicate_finish = try_find_sym(glib2, "g_subprocess_communicate_finish");
    stub_funcs.ptr_g_subprocess_communicate_utf8 = try_find_sym(glib2, "g_subprocess_communicate_utf8");
    stub_funcs.ptr_g_subprocess_communicate_utf8_async = try_find_sym(glib2, "g_subprocess_communicate_utf8_async");
    stub_funcs.ptr_g_subprocess_communicate_utf8_finish = try_find_sym(glib2, "g_subprocess_communicate_utf8_finish");
    stub_funcs.ptr_g_subprocess_launcher_get_type = try_find_sym(glib2, "g_subprocess_launcher_get_type");
    stub_funcs.ptr_g_subprocess_launcher_new = try_find_sym(glib2, "g_subprocess_launcher_new");
    stub_funcs.ptr_g_subprocess_launcher_spawnv = try_find_sym(glib2, "g_subprocess_launcher_spawnv");
    stub_funcs.ptr_g_subprocess_launcher_set_environ = try_find_sym(glib2, "g_subprocess_launcher_set_environ");
    stub_funcs.ptr_g_subprocess_launcher_setenv = try_find_sym(glib2, "g_subprocess_launcher_setenv");
    stub_funcs.ptr_g_subprocess_launcher_unsetenv = try_find_sym(glib2, "g_subprocess_launcher_unsetenv");
    stub_funcs.ptr_g_subprocess_launcher_getenv = try_find_sym(glib2, "g_subprocess_launcher_getenv");
    stub_funcs.ptr_g_subprocess_launcher_set_cwd = try_find_sym(glib2, "g_subprocess_launcher_set_cwd");
    stub_funcs.ptr_g_subprocess_launcher_set_flags = try_find_sym(glib2, "g_subprocess_launcher_set_flags");
    stub_funcs.ptr_g_subprocess_launcher_set_stdin_file_path = try_find_sym(glib2, "g_subprocess_launcher_set_stdin_file_path");
    stub_funcs.ptr_g_subprocess_launcher_take_stdin_fd = try_find_sym(glib2, "g_subprocess_launcher_take_stdin_fd");
    stub_funcs.ptr_g_subprocess_launcher_set_stdout_file_path = try_find_sym(glib2, "g_subprocess_launcher_set_stdout_file_path");
    stub_funcs.ptr_g_subprocess_launcher_take_stdout_fd = try_find_sym(glib2, "g_subprocess_launcher_take_stdout_fd");
    stub_funcs.ptr_g_subprocess_launcher_set_stderr_file_path = try_find_sym(glib2, "g_subprocess_launcher_set_stderr_file_path");
    stub_funcs.ptr_g_subprocess_launcher_take_stderr_fd = try_find_sym(glib2, "g_subprocess_launcher_take_stderr_fd");
    stub_funcs.ptr_g_subprocess_launcher_take_fd = try_find_sym(glib2, "g_subprocess_launcher_take_fd");
    stub_funcs.ptr_g_subprocess_launcher_close = try_find_sym(glib2, "g_subprocess_launcher_close");
    stub_funcs.ptr_g_subprocess_launcher_set_child_setup = try_find_sym(glib2, "g_subprocess_launcher_set_child_setup");
    stub_funcs.ptr_g_task_get_type = try_find_sym(glib2, "g_task_get_type");
    stub_funcs.ptr_g_task_new = try_find_sym(glib2, "g_task_new");
    stub_funcs.ptr_g_task_report_error = try_find_sym(glib2, "g_task_report_error");
    stub_funcs.ptr_g_task_set_task_data = try_find_sym(glib2, "g_task_set_task_data");
    stub_funcs.ptr_g_task_set_priority = try_find_sym(glib2, "g_task_set_priority");
    stub_funcs.ptr_g_task_set_check_cancellable = try_find_sym(glib2, "g_task_set_check_cancellable");
    stub_funcs.ptr_g_task_set_source_tag = try_find_sym(glib2, "g_task_set_source_tag");
    stub_funcs.ptr_g_task_set_name = try_find_sym(glib2, "g_task_set_name");
    stub_funcs.ptr_g_task_set_static_name = try_find_sym(glib2, "g_task_set_static_name");
    stub_funcs.ptr_g_task_get_source_object = try_find_sym(glib2, "g_task_get_source_object");
    stub_funcs.ptr_g_task_get_task_data = try_find_sym(glib2, "g_task_get_task_data");
    stub_funcs.ptr_g_task_get_priority = try_find_sym(glib2, "g_task_get_priority");
    stub_funcs.ptr_g_task_get_context = try_find_sym(glib2, "g_task_get_context");
    stub_funcs.ptr_g_task_get_cancellable = try_find_sym(glib2, "g_task_get_cancellable");
    stub_funcs.ptr_g_task_get_check_cancellable = try_find_sym(glib2, "g_task_get_check_cancellable");
    stub_funcs.ptr_g_task_get_source_tag = try_find_sym(glib2, "g_task_get_source_tag");
    stub_funcs.ptr_g_task_get_name = try_find_sym(glib2, "g_task_get_name");
    stub_funcs.ptr_g_task_is_valid = try_find_sym(glib2, "g_task_is_valid");
    stub_funcs.ptr_g_task_run_in_thread = try_find_sym(glib2, "g_task_run_in_thread");
    stub_funcs.ptr_g_task_run_in_thread_sync = try_find_sym(glib2, "g_task_run_in_thread_sync");
    stub_funcs.ptr_g_task_set_return_on_cancel = try_find_sym(glib2, "g_task_set_return_on_cancel");
    stub_funcs.ptr_g_task_get_return_on_cancel = try_find_sym(glib2, "g_task_get_return_on_cancel");
    stub_funcs.ptr_g_task_attach_source = try_find_sym(glib2, "g_task_attach_source");
    stub_funcs.ptr_g_task_return_pointer = try_find_sym(glib2, "g_task_return_pointer");
    stub_funcs.ptr_g_task_return_boolean = try_find_sym(glib2, "g_task_return_boolean");
    stub_funcs.ptr_g_task_return_int = try_find_sym(glib2, "g_task_return_int");
    stub_funcs.ptr_g_task_return_error = try_find_sym(glib2, "g_task_return_error");
    stub_funcs.ptr_g_task_return_new_error_literal = try_find_sym(glib2, "g_task_return_new_error_literal");
    stub_funcs.ptr_g_task_return_value = try_find_sym(glib2, "g_task_return_value");
    stub_funcs.ptr_g_task_return_error_if_cancelled = try_find_sym(glib2, "g_task_return_error_if_cancelled");
    stub_funcs.ptr_g_task_propagate_pointer = try_find_sym(glib2, "g_task_propagate_pointer");
    stub_funcs.ptr_g_task_propagate_boolean = try_find_sym(glib2, "g_task_propagate_boolean");
    stub_funcs.ptr_g_task_propagate_int = try_find_sym(glib2, "g_task_propagate_int");
    stub_funcs.ptr_g_task_propagate_value = try_find_sym(glib2, "g_task_propagate_value");
    stub_funcs.ptr_g_task_had_error = try_find_sym(glib2, "g_task_had_error");
    stub_funcs.ptr_g_task_get_completed = try_find_sym(glib2, "g_task_get_completed");
    stub_funcs.ptr_g_task_print_alive_tasks = try_find_sym(glib2, "g_task_print_alive_tasks");
    stub_funcs.ptr_g_tcp_connection_get_type = try_find_sym(glib2, "g_tcp_connection_get_type");
    stub_funcs.ptr_g_tcp_connection_set_graceful_disconnect = try_find_sym(glib2, "g_tcp_connection_set_graceful_disconnect");
    stub_funcs.ptr_g_tcp_connection_get_graceful_disconnect = try_find_sym(glib2, "g_tcp_connection_get_graceful_disconnect");
    stub_funcs.ptr_g_tcp_wrapper_connection_get_type = try_find_sym(glib2, "g_tcp_wrapper_connection_get_type");
    stub_funcs.ptr_g_tcp_wrapper_connection_new = try_find_sym(glib2, "g_tcp_wrapper_connection_new");
    stub_funcs.ptr_g_tcp_wrapper_connection_get_base_io_stream = try_find_sym(glib2, "g_tcp_wrapper_connection_get_base_io_stream");
    stub_funcs.ptr_g_test_dbus_get_type = try_find_sym(glib2, "g_test_dbus_get_type");
    stub_funcs.ptr_g_test_dbus_new = try_find_sym(glib2, "g_test_dbus_new");
    stub_funcs.ptr_g_test_dbus_get_flags = try_find_sym(glib2, "g_test_dbus_get_flags");
    stub_funcs.ptr_g_test_dbus_get_bus_address = try_find_sym(glib2, "g_test_dbus_get_bus_address");
    stub_funcs.ptr_g_test_dbus_add_service_dir = try_find_sym(glib2, "g_test_dbus_add_service_dir");
    stub_funcs.ptr_g_test_dbus_up = try_find_sym(glib2, "g_test_dbus_up");
    stub_funcs.ptr_g_test_dbus_stop = try_find_sym(glib2, "g_test_dbus_stop");
    stub_funcs.ptr_g_test_dbus_down = try_find_sym(glib2, "g_test_dbus_down");
    stub_funcs.ptr_g_test_dbus_unset = try_find_sym(glib2, "g_test_dbus_unset");
    stub_funcs.ptr_g_themed_icon_get_type = try_find_sym(glib2, "g_themed_icon_get_type");
    stub_funcs.ptr_g_themed_icon_new = try_find_sym(glib2, "g_themed_icon_new");
    stub_funcs.ptr_g_themed_icon_new_with_default_fallbacks = try_find_sym(glib2, "g_themed_icon_new_with_default_fallbacks");
    stub_funcs.ptr_g_themed_icon_new_from_names = try_find_sym(glib2, "g_themed_icon_new_from_names");
    stub_funcs.ptr_g_themed_icon_prepend_name = try_find_sym(glib2, "g_themed_icon_prepend_name");
    stub_funcs.ptr_g_themed_icon_append_name = try_find_sym(glib2, "g_themed_icon_append_name");
    stub_funcs.ptr_g_themed_icon_get_names = try_find_sym(glib2, "g_themed_icon_get_names");
    stub_funcs.ptr_g_threaded_socket_service_get_type = try_find_sym(glib2, "g_threaded_socket_service_get_type");
    stub_funcs.ptr_g_threaded_socket_service_new = try_find_sym(glib2, "g_threaded_socket_service_new");
    stub_funcs.ptr_g_tls_backend_get_type = try_find_sym(glib2, "g_tls_backend_get_type");
    stub_funcs.ptr_g_tls_backend_get_default = try_find_sym(glib2, "g_tls_backend_get_default");
    stub_funcs.ptr_g_tls_backend_get_default_database = try_find_sym(glib2, "g_tls_backend_get_default_database");
    stub_funcs.ptr_g_tls_backend_set_default_database = try_find_sym(glib2, "g_tls_backend_set_default_database");
    stub_funcs.ptr_g_tls_backend_supports_tls = try_find_sym(glib2, "g_tls_backend_supports_tls");
    stub_funcs.ptr_g_tls_backend_supports_dtls = try_find_sym(glib2, "g_tls_backend_supports_dtls");
    stub_funcs.ptr_g_tls_backend_get_certificate_type = try_find_sym(glib2, "g_tls_backend_get_certificate_type");
    stub_funcs.ptr_g_tls_backend_get_client_connection_type = try_find_sym(glib2, "g_tls_backend_get_client_connection_type");
    stub_funcs.ptr_g_tls_backend_get_server_connection_type = try_find_sym(glib2, "g_tls_backend_get_server_connection_type");
    stub_funcs.ptr_g_tls_backend_get_file_database_type = try_find_sym(glib2, "g_tls_backend_get_file_database_type");
    stub_funcs.ptr_g_tls_backend_get_dtls_client_connection_type = try_find_sym(glib2, "g_tls_backend_get_dtls_client_connection_type");
    stub_funcs.ptr_g_tls_backend_get_dtls_server_connection_type = try_find_sym(glib2, "g_tls_backend_get_dtls_server_connection_type");
    stub_funcs.ptr_g_tls_certificate_get_type = try_find_sym(glib2, "g_tls_certificate_get_type");
    stub_funcs.ptr_g_tls_certificate_new_from_pem = try_find_sym(glib2, "g_tls_certificate_new_from_pem");
    stub_funcs.ptr_g_tls_certificate_new_from_pkcs12 = try_find_sym(glib2, "g_tls_certificate_new_from_pkcs12");
    stub_funcs.ptr_g_tls_certificate_new_from_file_with_password = try_find_sym(glib2, "g_tls_certificate_new_from_file_with_password");
    stub_funcs.ptr_g_tls_certificate_new_from_file = try_find_sym(glib2, "g_tls_certificate_new_from_file");
    stub_funcs.ptr_g_tls_certificate_new_from_files = try_find_sym(glib2, "g_tls_certificate_new_from_files");
    stub_funcs.ptr_g_tls_certificate_new_from_pkcs11_uris = try_find_sym(glib2, "g_tls_certificate_new_from_pkcs11_uris");
    stub_funcs.ptr_g_tls_certificate_list_new_from_file = try_find_sym(glib2, "g_tls_certificate_list_new_from_file");
    stub_funcs.ptr_g_tls_certificate_get_issuer = try_find_sym(glib2, "g_tls_certificate_get_issuer");
    stub_funcs.ptr_g_tls_certificate_verify = try_find_sym(glib2, "g_tls_certificate_verify");
    stub_funcs.ptr_g_tls_certificate_is_same = try_find_sym(glib2, "g_tls_certificate_is_same");
    stub_funcs.ptr_g_tls_certificate_get_not_valid_before = try_find_sym(glib2, "g_tls_certificate_get_not_valid_before");
    stub_funcs.ptr_g_tls_certificate_get_not_valid_after = try_find_sym(glib2, "g_tls_certificate_get_not_valid_after");
    stub_funcs.ptr_g_tls_certificate_get_subject_name = try_find_sym(glib2, "g_tls_certificate_get_subject_name");
    stub_funcs.ptr_g_tls_certificate_get_issuer_name = try_find_sym(glib2, "g_tls_certificate_get_issuer_name");
    stub_funcs.ptr_g_tls_certificate_get_dns_names = try_find_sym(glib2, "g_tls_certificate_get_dns_names");
    stub_funcs.ptr_g_tls_certificate_get_ip_addresses = try_find_sym(glib2, "g_tls_certificate_get_ip_addresses");
    stub_funcs.ptr_g_tls_connection_get_type = try_find_sym(glib2, "g_tls_connection_get_type");
    stub_funcs.ptr_g_tls_connection_set_use_system_certdb = try_find_sym(glib2, "g_tls_connection_set_use_system_certdb");
    stub_funcs.ptr_g_tls_connection_get_use_system_certdb = try_find_sym(glib2, "g_tls_connection_get_use_system_certdb");
    stub_funcs.ptr_g_tls_connection_set_database = try_find_sym(glib2, "g_tls_connection_set_database");
    stub_funcs.ptr_g_tls_connection_get_database = try_find_sym(glib2, "g_tls_connection_get_database");
    stub_funcs.ptr_g_tls_connection_set_certificate = try_find_sym(glib2, "g_tls_connection_set_certificate");
    stub_funcs.ptr_g_tls_connection_get_certificate = try_find_sym(glib2, "g_tls_connection_get_certificate");
    stub_funcs.ptr_g_tls_connection_set_interaction = try_find_sym(glib2, "g_tls_connection_set_interaction");
    stub_funcs.ptr_g_tls_connection_get_interaction = try_find_sym(glib2, "g_tls_connection_get_interaction");
    stub_funcs.ptr_g_tls_connection_get_peer_certificate = try_find_sym(glib2, "g_tls_connection_get_peer_certificate");
    stub_funcs.ptr_g_tls_connection_get_peer_certificate_errors = try_find_sym(glib2, "g_tls_connection_get_peer_certificate_errors");
    stub_funcs.ptr_g_tls_connection_set_require_close_notify = try_find_sym(glib2, "g_tls_connection_set_require_close_notify");
    stub_funcs.ptr_g_tls_connection_get_require_close_notify = try_find_sym(glib2, "g_tls_connection_get_require_close_notify");
    stub_funcs.ptr_g_tls_connection_set_rehandshake_mode = try_find_sym(glib2, "g_tls_connection_set_rehandshake_mode");
    stub_funcs.ptr_g_tls_connection_get_rehandshake_mode = try_find_sym(glib2, "g_tls_connection_get_rehandshake_mode");
    stub_funcs.ptr_g_tls_connection_set_advertised_protocols = try_find_sym(glib2, "g_tls_connection_set_advertised_protocols");
    stub_funcs.ptr_g_tls_connection_get_negotiated_protocol = try_find_sym(glib2, "g_tls_connection_get_negotiated_protocol");
    stub_funcs.ptr_g_tls_connection_get_channel_binding_data = try_find_sym(glib2, "g_tls_connection_get_channel_binding_data");
    stub_funcs.ptr_g_tls_connection_handshake = try_find_sym(glib2, "g_tls_connection_handshake");
    stub_funcs.ptr_g_tls_connection_handshake_async = try_find_sym(glib2, "g_tls_connection_handshake_async");
    stub_funcs.ptr_g_tls_connection_handshake_finish = try_find_sym(glib2, "g_tls_connection_handshake_finish");
    stub_funcs.ptr_g_tls_connection_get_protocol_version = try_find_sym(glib2, "g_tls_connection_get_protocol_version");
    stub_funcs.ptr_g_tls_connection_get_ciphersuite_name = try_find_sym(glib2, "g_tls_connection_get_ciphersuite_name");
    stub_funcs.ptr_g_tls_error_quark = try_find_sym(glib2, "g_tls_error_quark");
    stub_funcs.ptr_g_tls_channel_binding_error_quark = try_find_sym(glib2, "g_tls_channel_binding_error_quark");
    stub_funcs.ptr_g_tls_connection_emit_accept_certificate = try_find_sym(glib2, "g_tls_connection_emit_accept_certificate");
    stub_funcs.ptr_g_tls_client_connection_get_type = try_find_sym(glib2, "g_tls_client_connection_get_type");
    stub_funcs.ptr_g_tls_client_connection_new = try_find_sym(glib2, "g_tls_client_connection_new");
    stub_funcs.ptr_g_tls_client_connection_get_validation_flags = try_find_sym(glib2, "g_tls_client_connection_get_validation_flags");
    stub_funcs.ptr_g_tls_client_connection_set_validation_flags = try_find_sym(glib2, "g_tls_client_connection_set_validation_flags");
    stub_funcs.ptr_g_tls_client_connection_get_server_identity = try_find_sym(glib2, "g_tls_client_connection_get_server_identity");
    stub_funcs.ptr_g_tls_client_connection_set_server_identity = try_find_sym(glib2, "g_tls_client_connection_set_server_identity");
    stub_funcs.ptr_g_tls_client_connection_get_use_ssl3 = try_find_sym(glib2, "g_tls_client_connection_get_use_ssl3");
    stub_funcs.ptr_g_tls_client_connection_set_use_ssl3 = try_find_sym(glib2, "g_tls_client_connection_set_use_ssl3");
    stub_funcs.ptr_g_tls_client_connection_get_accepted_cas = try_find_sym(glib2, "g_tls_client_connection_get_accepted_cas");
    stub_funcs.ptr_g_tls_client_connection_copy_session_state = try_find_sym(glib2, "g_tls_client_connection_copy_session_state");
    stub_funcs.ptr_g_tls_database_get_type = try_find_sym(glib2, "g_tls_database_get_type");
    stub_funcs.ptr_g_tls_database_verify_chain = try_find_sym(glib2, "g_tls_database_verify_chain");
    stub_funcs.ptr_g_tls_database_verify_chain_async = try_find_sym(glib2, "g_tls_database_verify_chain_async");
    stub_funcs.ptr_g_tls_database_verify_chain_finish = try_find_sym(glib2, "g_tls_database_verify_chain_finish");
    stub_funcs.ptr_g_tls_database_create_certificate_handle = try_find_sym(glib2, "g_tls_database_create_certificate_handle");
    stub_funcs.ptr_g_tls_database_lookup_certificate_for_handle = try_find_sym(glib2, "g_tls_database_lookup_certificate_for_handle");
    stub_funcs.ptr_g_tls_database_lookup_certificate_for_handle_async = try_find_sym(glib2, "g_tls_database_lookup_certificate_for_handle_async");
    stub_funcs.ptr_g_tls_database_lookup_certificate_for_handle_finish = try_find_sym(glib2, "g_tls_database_lookup_certificate_for_handle_finish");
    stub_funcs.ptr_g_tls_database_lookup_certificate_issuer = try_find_sym(glib2, "g_tls_database_lookup_certificate_issuer");
    stub_funcs.ptr_g_tls_database_lookup_certificate_issuer_async = try_find_sym(glib2, "g_tls_database_lookup_certificate_issuer_async");
    stub_funcs.ptr_g_tls_database_lookup_certificate_issuer_finish = try_find_sym(glib2, "g_tls_database_lookup_certificate_issuer_finish");
    stub_funcs.ptr_g_tls_database_lookup_certificates_issued_by = try_find_sym(glib2, "g_tls_database_lookup_certificates_issued_by");
    stub_funcs.ptr_g_tls_database_lookup_certificates_issued_by_async = try_find_sym(glib2, "g_tls_database_lookup_certificates_issued_by_async");
    stub_funcs.ptr_g_tls_database_lookup_certificates_issued_by_finish = try_find_sym(glib2, "g_tls_database_lookup_certificates_issued_by_finish");
    stub_funcs.ptr_g_tls_file_database_get_type = try_find_sym(glib2, "g_tls_file_database_get_type");
    stub_funcs.ptr_g_tls_file_database_new = try_find_sym(glib2, "g_tls_file_database_new");
    stub_funcs.ptr_g_tls_interaction_get_type = try_find_sym(glib2, "g_tls_interaction_get_type");
    stub_funcs.ptr_g_tls_interaction_invoke_ask_password = try_find_sym(glib2, "g_tls_interaction_invoke_ask_password");
    stub_funcs.ptr_g_tls_interaction_ask_password = try_find_sym(glib2, "g_tls_interaction_ask_password");
    stub_funcs.ptr_g_tls_interaction_ask_password_async = try_find_sym(glib2, "g_tls_interaction_ask_password_async");
    stub_funcs.ptr_g_tls_interaction_ask_password_finish = try_find_sym(glib2, "g_tls_interaction_ask_password_finish");
    stub_funcs.ptr_g_tls_interaction_invoke_request_certificate = try_find_sym(glib2, "g_tls_interaction_invoke_request_certificate");
    stub_funcs.ptr_g_tls_interaction_request_certificate = try_find_sym(glib2, "g_tls_interaction_request_certificate");
    stub_funcs.ptr_g_tls_interaction_request_certificate_async = try_find_sym(glib2, "g_tls_interaction_request_certificate_async");
    stub_funcs.ptr_g_tls_interaction_request_certificate_finish = try_find_sym(glib2, "g_tls_interaction_request_certificate_finish");
    stub_funcs.ptr_g_tls_password_get_type = try_find_sym(glib2, "g_tls_password_get_type");
    stub_funcs.ptr_g_tls_password_new = try_find_sym(glib2, "g_tls_password_new");
    stub_funcs.ptr_g_tls_password_get_value = try_find_sym(glib2, "g_tls_password_get_value");
    stub_funcs.ptr_g_tls_password_set_value = try_find_sym(glib2, "g_tls_password_set_value");
    stub_funcs.ptr_g_tls_password_set_value_full = try_find_sym(glib2, "g_tls_password_set_value_full");
    stub_funcs.ptr_g_tls_password_get_flags = try_find_sym(glib2, "g_tls_password_get_flags");
    stub_funcs.ptr_g_tls_password_set_flags = try_find_sym(glib2, "g_tls_password_set_flags");
    stub_funcs.ptr_g_tls_password_get_description = try_find_sym(glib2, "g_tls_password_get_description");
    stub_funcs.ptr_g_tls_password_set_description = try_find_sym(glib2, "g_tls_password_set_description");
    stub_funcs.ptr_g_tls_password_get_warning = try_find_sym(glib2, "g_tls_password_get_warning");
    stub_funcs.ptr_g_tls_password_set_warning = try_find_sym(glib2, "g_tls_password_set_warning");
    stub_funcs.ptr_g_tls_server_connection_get_type = try_find_sym(glib2, "g_tls_server_connection_get_type");
    stub_funcs.ptr_g_tls_server_connection_new = try_find_sym(glib2, "g_tls_server_connection_new");
    stub_funcs.ptr_g_unix_connection_get_type = try_find_sym(glib2, "g_unix_connection_get_type");
    stub_funcs.ptr_g_unix_connection_send_fd = try_find_sym(glib2, "g_unix_connection_send_fd");
    stub_funcs.ptr_g_unix_connection_receive_fd = try_find_sym(glib2, "g_unix_connection_receive_fd");
    stub_funcs.ptr_g_unix_connection_send_credentials = try_find_sym(glib2, "g_unix_connection_send_credentials");
    stub_funcs.ptr_g_unix_connection_send_credentials_async = try_find_sym(glib2, "g_unix_connection_send_credentials_async");
    stub_funcs.ptr_g_unix_connection_send_credentials_finish = try_find_sym(glib2, "g_unix_connection_send_credentials_finish");
    stub_funcs.ptr_g_unix_connection_receive_credentials = try_find_sym(glib2, "g_unix_connection_receive_credentials");
    stub_funcs.ptr_g_unix_connection_receive_credentials_async = try_find_sym(glib2, "g_unix_connection_receive_credentials_async");
    stub_funcs.ptr_g_unix_connection_receive_credentials_finish = try_find_sym(glib2, "g_unix_connection_receive_credentials_finish");
    stub_funcs.ptr_g_unix_credentials_message_get_type = try_find_sym(glib2, "g_unix_credentials_message_get_type");
    stub_funcs.ptr_g_unix_credentials_message_new = try_find_sym(glib2, "g_unix_credentials_message_new");
    stub_funcs.ptr_g_unix_credentials_message_new_with_credentials = try_find_sym(glib2, "g_unix_credentials_message_new_with_credentials");
    stub_funcs.ptr_g_unix_credentials_message_get_credentials = try_find_sym(glib2, "g_unix_credentials_message_get_credentials");
    stub_funcs.ptr_g_unix_credentials_message_is_supported = try_find_sym(glib2, "g_unix_credentials_message_is_supported");
    stub_funcs.ptr_g_unix_fd_list_get_type = try_find_sym(glib2, "g_unix_fd_list_get_type");
    stub_funcs.ptr_g_unix_fd_list_new = try_find_sym(glib2, "g_unix_fd_list_new");
    stub_funcs.ptr_g_unix_fd_list_new_from_array = try_find_sym(glib2, "g_unix_fd_list_new_from_array");
    stub_funcs.ptr_g_unix_fd_list_append = try_find_sym(glib2, "g_unix_fd_list_append");
    stub_funcs.ptr_g_unix_fd_list_get_length = try_find_sym(glib2, "g_unix_fd_list_get_length");
    stub_funcs.ptr_g_unix_fd_list_get = try_find_sym(glib2, "g_unix_fd_list_get");
    stub_funcs.ptr_g_unix_fd_list_peek_fds = try_find_sym(glib2, "g_unix_fd_list_peek_fds");
    stub_funcs.ptr_g_unix_fd_list_steal_fds = try_find_sym(glib2, "g_unix_fd_list_steal_fds");
    stub_funcs.ptr_g_unix_socket_address_get_type = try_find_sym(glib2, "g_unix_socket_address_get_type");
    stub_funcs.ptr_g_unix_socket_address_new = try_find_sym(glib2, "g_unix_socket_address_new");
    stub_funcs.ptr_g_unix_socket_address_new_abstract = try_find_sym(glib2, "g_unix_socket_address_new_abstract");
    stub_funcs.ptr_g_unix_socket_address_new_with_type = try_find_sym(glib2, "g_unix_socket_address_new_with_type");
    stub_funcs.ptr_g_unix_socket_address_get_path = try_find_sym(glib2, "g_unix_socket_address_get_path");
    stub_funcs.ptr_g_unix_socket_address_get_path_len = try_find_sym(glib2, "g_unix_socket_address_get_path_len");
    stub_funcs.ptr_g_unix_socket_address_get_address_type = try_find_sym(glib2, "g_unix_socket_address_get_address_type");
    stub_funcs.ptr_g_unix_socket_address_get_is_abstract = try_find_sym(glib2, "g_unix_socket_address_get_is_abstract");
    stub_funcs.ptr_g_unix_socket_address_abstract_names_supported = try_find_sym(glib2, "g_unix_socket_address_abstract_names_supported");
    stub_funcs.ptr_g_vfs_get_type = try_find_sym(glib2, "g_vfs_get_type");
    stub_funcs.ptr_g_vfs_is_active = try_find_sym(glib2, "g_vfs_is_active");
    stub_funcs.ptr_g_vfs_get_file_for_path = try_find_sym(glib2, "g_vfs_get_file_for_path");
    stub_funcs.ptr_g_vfs_get_file_for_uri = try_find_sym(glib2, "g_vfs_get_file_for_uri");
    stub_funcs.ptr_g_vfs_get_supported_uri_schemes = try_find_sym(glib2, "g_vfs_get_supported_uri_schemes");
    stub_funcs.ptr_g_vfs_parse_name = try_find_sym(glib2, "g_vfs_parse_name");
    stub_funcs.ptr_g_vfs_get_default = try_find_sym(glib2, "g_vfs_get_default");
    stub_funcs.ptr_g_vfs_get_local = try_find_sym(glib2, "g_vfs_get_local");
    stub_funcs.ptr_g_vfs_register_uri_scheme = try_find_sym(glib2, "g_vfs_register_uri_scheme");
    stub_funcs.ptr_g_vfs_unregister_uri_scheme = try_find_sym(glib2, "g_vfs_unregister_uri_scheme");
    stub_funcs.ptr_g_volume_get_type = try_find_sym(glib2, "g_volume_get_type");
    stub_funcs.ptr_g_volume_get_name = try_find_sym(glib2, "g_volume_get_name");
    stub_funcs.ptr_g_volume_get_icon = try_find_sym(glib2, "g_volume_get_icon");
    stub_funcs.ptr_g_volume_get_symbolic_icon = try_find_sym(glib2, "g_volume_get_symbolic_icon");
    stub_funcs.ptr_g_volume_get_uuid = try_find_sym(glib2, "g_volume_get_uuid");
    stub_funcs.ptr_g_volume_get_drive = try_find_sym(glib2, "g_volume_get_drive");
    stub_funcs.ptr_g_volume_get_mount = try_find_sym(glib2, "g_volume_get_mount");
    stub_funcs.ptr_g_volume_can_mount = try_find_sym(glib2, "g_volume_can_mount");
    stub_funcs.ptr_g_volume_can_eject = try_find_sym(glib2, "g_volume_can_eject");
    stub_funcs.ptr_g_volume_should_automount = try_find_sym(glib2, "g_volume_should_automount");
    stub_funcs.ptr_g_volume_mount = try_find_sym(glib2, "g_volume_mount");
    stub_funcs.ptr_g_volume_mount_finish = try_find_sym(glib2, "g_volume_mount_finish");
    stub_funcs.ptr_g_volume_eject = try_find_sym(glib2, "g_volume_eject");
    stub_funcs.ptr_g_volume_eject_finish = try_find_sym(glib2, "g_volume_eject_finish");
    stub_funcs.ptr_g_volume_get_identifier = try_find_sym(glib2, "g_volume_get_identifier");
    stub_funcs.ptr_g_volume_enumerate_identifiers = try_find_sym(glib2, "g_volume_enumerate_identifiers");
    stub_funcs.ptr_g_volume_get_activation_root = try_find_sym(glib2, "g_volume_get_activation_root");
    stub_funcs.ptr_g_volume_eject_with_operation = try_find_sym(glib2, "g_volume_eject_with_operation");
    stub_funcs.ptr_g_volume_eject_with_operation_finish = try_find_sym(glib2, "g_volume_eject_with_operation_finish");
    stub_funcs.ptr_g_volume_get_sort_key = try_find_sym(glib2, "g_volume_get_sort_key");
    stub_funcs.ptr_g_zlib_compressor_get_type = try_find_sym(glib2, "g_zlib_compressor_get_type");
    stub_funcs.ptr_g_zlib_compressor_new = try_find_sym(glib2, "g_zlib_compressor_new");
    stub_funcs.ptr_g_zlib_compressor_get_file_info = try_find_sym(glib2, "g_zlib_compressor_get_file_info");
    stub_funcs.ptr_g_zlib_compressor_set_file_info = try_find_sym(glib2, "g_zlib_compressor_set_file_info");
    stub_funcs.ptr_g_zlib_decompressor_get_type = try_find_sym(glib2, "g_zlib_decompressor_get_type");
    stub_funcs.ptr_g_zlib_decompressor_new = try_find_sym(glib2, "g_zlib_decompressor_new");
    stub_funcs.ptr_g_zlib_decompressor_get_file_info = try_find_sym(glib2, "g_zlib_decompressor_get_file_info");
}
